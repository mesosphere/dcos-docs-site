...
- DC/OS is installed with at least 1 master and [public agent](/mesosphere/dcos/1.11/overview/concepts/#public-agent-node) node
- DC/OS [CLI](/mesosphere/dcos/1.11/cli/) 0.4.6 or later
- [jq](https://github.com/stedolan/jq/wiki/Installation)
- [SSH](/mesosphere/dcos/1.11/administering-clusters/sshcluster/) configured
