...
*   [SSH installed and configured](/mesosphere/dcos/1.11/administering-clusters/sshcluster/). This is required when removing nodes by manually killing agents.
*   Access to the [Admin Router permissions](/mesosphere/dcos/1.11/overview/architecture/components/#admin-router).
...
1. Open a secure shell [SSH](/mesosphere/dcos/1.11/administering-clusters/sshcluster/) on the agent nodes.
