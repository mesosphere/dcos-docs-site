...
You can obtain a cluster URL by using the following methods:
...
To determine which agents are public agents, see [Finding a Public Agent IP](/1.11/administering-clusters/locate-public-agent/).
