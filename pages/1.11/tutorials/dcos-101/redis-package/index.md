...
# Deep Dive
  ...
  You can also add your own repo that includes your custom packages. See the [documentation](https://docs.mesosphere.com/1.11/administering-clusters/repo/) for details.
