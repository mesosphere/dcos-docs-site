...
Jenkins for DC/OS can be accessed through the Dashboard or Services navigation menu’s within the [DC/OS web interface](/mesosphere/dcos/1.11/gui/).

Click the “Jenkins” service and then "Open Service" to access the Jenkins web interface.

![dcos-velocity-jenkins-ui.png](/mesosphere/dcos/1.11/img/dcos-velocity-jenkins-ui.png)
...
![dcos-velocity-jenkins-creds-new.png](/mesosphere/dcos/1.11/img/dcos-velocity-jenkins-creds-new.png)
...
![dcos-jenkins-new-freestyle.png](/mesosphere/dcos/1.11/img/dcos-jenkins-new-freestyle.png)
...
![dcos-jenkins-repourl.png](/mesosphere/dcos/1.11/img/dcos-jenkins-repourl.png)
...
![dcos-velocity-jenkins-build-docker.png](/mesosphere/dcos/1.11/img/dcos-velocity-jenkins-build-docker.png)
...
![dcos-velocity-jenkins-build-docker-config.png](/mesosphere/dcos/1.11/img/dcos-velocity-jenkins-build-docker-config.png)
...
![dcos-jenkins-plugin-popup.png](/mesosphere/dcos/1.11/img/dcos-jenkins-plugin-popup.png)
...
![dcos-velocity-marathon-config.png](/mesosphere/dcos/1.11/img/dcos-velocity-marathon-config.png)
...
![dcos-jenkins-build-now.png](/mesosphere/dcos/1.11/img/dcos-jenkins-build-now.png)
...
![dcos-jekyll-site1.png](/mesosphere/dcos/1.11/img/dcos-jekyll-site1.png)
...
![dcos-jekyll-updated.png](/mesosphere/dcos/1.11/img/dcos-jekyll-updated.png)
