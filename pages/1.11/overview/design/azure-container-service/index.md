...
For a more comprehensive architectural description of DC/OS, see [The Architecture of DC/OS](/1.11/overview/architecture/); for a more complete discussion of components, see [An Introduction to DC/OS Components](/1.11/overview/architecture/components/).
