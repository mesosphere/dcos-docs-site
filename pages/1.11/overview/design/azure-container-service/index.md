...
For a more comprehensive architectural description of DC/OS, see [DC/OS Architecture](/1.11/overview/architecture/).

For a more complete discussion of components, see [DC/OS Components](/1.11/overview/architecture/components/).
