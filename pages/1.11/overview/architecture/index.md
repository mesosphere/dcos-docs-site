...
![DC/OS Architecture Layers](/mesosphere/dcos/1.11/img/dcos-architecture-layers.png)
...
For more information, see [Task Types](/mesosphere/dcos/1.11/overview/architecture/task-types/).
...
- [Node Types](/mesosphere/dcos/1.11/overview/architecture/node-types/)
- [Host Operating System](/mesosphere/dcos/1.11/overview/concepts/#host-operating-system).
...
For more information, see [Installing](/mesosphere/dcos/1.11/installing/).

## External components

In addition to the software that runs in the datacenter, DC/OS includes and integrates with several external components:

- [GUI](/mesosphere/dcos/1.11/gui/)
- [CLI](/mesosphere/dcos/1.11/cli/)
- [package repository](/mesosphere/dcos/1.11/administering-clusters/repo/)
- [container registry](/mesosphere/dcos/1.11/overview/concepts/#container-registry)
