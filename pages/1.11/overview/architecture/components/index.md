...
![Mesosphere Enterprise DC/OS Components](/1.11/img/dcos-enterprise-components-1.10-portrait.png)
...
<div data-role="collapsible">
<h2 id="dcos-backup">DC/OS Backup <span class="small badge enterprise-badge">Enterprise DC/OS</span></h2>
<div>
...
<div>
<p><strong>Description:</strong> The DC/OS Signal service reports cluster telemetry and analytics to help improve DC/OS. Administrators can <a href="/1.11/installing/oss/custom/opt-out/#telemetry">opt-out of telemetry</a> at install time.</p>
<p>
  <strong>System Service(s):</strong>
  <ul>
...
<div data-role="collapsible">
<h2 id="cockroachdb">CockroachDB <span class="small badge enterprise-badge">Enterprise DC/OS</span></h2>
<div>
<p><strong><em>NEW IN 1.10.0</em></strong></p>
...
<p><strong>Note:</strong> CockroachDB is currently only used by [DC/OS Identity and Access Manager (Bouncer)](#dcos-iam).</p>
<p>
  <strong>System Service(s):</strong>
  <ul>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/1.11/networking/tls-ssl/">Documentation</a></li>
    <li><a href="/1.11/networking/tls-ssl/ca-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
- [DC/OS Backup](#dcos-backup) - DC/OS Backup service and socket were added in DC/OS 1.10.0 for the [backup and restore](/1.11/administering-clusters/backup-and-restore/) feature.
