...
Permissions can be applied to users and groups using either the DC/OS GUI, the [IAM HTTP API](/1.11/security/iam-api/) or the [Enterprise DC/OS CLI](/1.11/cli/enterprise-cli/).
