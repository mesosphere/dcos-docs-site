...
enterprise: true
---
This tutorial demonstrates how to implement user permissions for DC/OS services in the permissive [security mode](/1.11/security/#security-modes). When you are done you will have multi-tenancy by using DC/OS permissions.

**Prerequisites:**

- Enterprise DC/OS is [installed](/1.11/installing/) in permissive [mode](/1.11/security/#security-modes).
...
1.  Log out of the current user and then back in as a user with [superuser](/1.11/security/perms-reference/#superuser) permission. You will see that both services are running in the prod-a and prod-b-groups.
