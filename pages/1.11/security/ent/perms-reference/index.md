...
| `dcos:service:marathon:marathon:services:/[<service-group>]` <br> Controls access to [DC/OS services](/1.11/deploying-services) launched by the native Marathon instance.                                                                                                              | x    | x | x | x | x |
