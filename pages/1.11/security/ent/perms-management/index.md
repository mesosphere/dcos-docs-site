...
Permissions can be applied to users and groups using either the DC/OS GUI, the [IAM HTTP API](/1.11/security/ent/iam-api/) or the [Enterprise DC/OS CLI](/1.11/cli/enterprise-cli/).
...
There are four commands used for managing permissions with the [Enterprise DC/OS CLI](/1.11/cli/enterprise-cli/).
