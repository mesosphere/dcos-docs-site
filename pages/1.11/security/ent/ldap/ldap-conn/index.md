...
1.  Click **Add Directory**.
   ...
   ![Add Directory dialog](/1.11/img/ldap-add-dir-conn.png)
...
1.  Specify your authentication method and parameters, as discussed in the [authentication section](/1.11/security/ent/ldap/ldap-auth/).
