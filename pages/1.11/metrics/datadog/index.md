...
1.  Go to the **Catalog** tab of the DC/OS GUI and find the **Datadog** package.
    ![datadog package](/1.11/img/datadog-package.png)
...
- [DC/OS Enterprise](/1.11/security/ent/service-auth/custom-service-auth/)
- [Open source DC/OS](/1.11/security/oss/managing-authentication/)
...
1.  [SSH to your master node](/1.11/administering-clusters/sshcluster/) and assign permissions to the plugin.
