...
You can connect the CLI to multiple DC/OS clusters using [dcos cluster](/1.11/cli/command-reference/dcos-cluster). `dcos cluster` has subcommands to set up connections to and attach to clusters and rename and remove clusters. 
