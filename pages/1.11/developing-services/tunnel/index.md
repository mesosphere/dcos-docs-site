...
* The [DC/OS CLI](/mesosphere/dcos/1.11/cli/install/).
* The DC/OS Tunnel package. Run `dcos package install tunnel-cli --cli`.
* [SSH access](/mesosphere/dcos/1.11/administering-clusters/sshcluster/) (key authentication only).
