...
**Important:** The functionality described in this document is only available in [strict security mode](/1.11/security/#security-modes).
...
Here is an overview of the [permissions](/1.11/security/perms-reference/) that are required:
...
**Prerequisite:**
You must [get the root cert](/1.11/networking/tls-ssl/get-cert/) before issuing the curl commands in this section.
