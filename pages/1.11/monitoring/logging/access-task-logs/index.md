...
Here is an overview of the [permissions](/mesosphere/dcos/1.11/security/ent/perms-reference/) that are required:
...
1.  Select **Organization** and choose **Groups**.
    ...
    ![New group](/mesosphere/dcos/1.11/img/new-user-group.png)

    Figure 1. New user group

1.  Create a new group.

    ![Prod group](/mesosphere/dcos/1.11/img/new-user-group-prod.png)

    Figure 2. Create new group screen

1.  Select the group name and from the **Permissions** tab, click **ADD PERMISSION**.

    ![Add permission to prod-group](/mesosphere/dcos/1.11/img/new-user-group-prod-permission.png)
...
1.  Click **INSERT PERMISSION STRING** to toggle the dialog, and then paste in the following permissions and click **ADD PERMISSIONS**.
    ...
    ![Add permission](/mesosphere/dcos/1.11/img/new-user-group-prod-permission-string.png)
...
1.  From the **Group Membership** tab, type in the search box and choose the group name. This will grant the group permissions to an individual user.
    ...
    ![Add alice to security group](/mesosphere/dcos/1.11/img/new-user-alice-add-group.png)
...
1.  Select **Single Container** and define your service as:
    ...
    ![Define nested service](/mesosphere/dcos/1.11/img/new-user-alice-service-group.png)
...
1.  Click **REVIEW & RUN** and **RUN SERVICE** to complete your installation. You should now see a service that is running in a group.
    ...
    ![Service running within group](/mesosphere/dcos/1.11/img/new-user-alice-service-done.png)
...
**Prerequisite:**
You must [get the root cert](/mesosphere/dcos/1.11/security/ent/tls-ssl/get-cert/) before issuing the curl commands in this section.
