...
- Docker `pullConfig` parameter.
 ...
 - Enterprise CLI permissions management commands.
   It is now possible to manage permissions to protect resources using the [Enterprise DC/OS CLI](/1.11/security/perms-management/).
