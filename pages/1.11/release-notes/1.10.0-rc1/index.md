...
<ul>
<li>You must upgrade Marathon-LB <em>before</em> upgrading to DC/OS 1.10.0. See the <a href="/1.11/installing/upgrading/">upgrade section</a> for more information.</li>
...
- Docker `pullConfig` parameter.
 ...
 - Enterprise CLI permissions management commands.
   It is now possible to manage permissions to protect resources using the [Enterprise DC/OS CLI](/1.11/security/ent/perms-management/).
...
- Beta HDFS. [Documentation](/service-docs/beta-hdfs/v1.3.3-2.6.0-cdh5.11.0-beta/). [Release Notes](https://github.com/mesosphere/dcos-commons/releases/tag/hdfs-1.3.3-2.6.0-cdh5.11.0-beta).
...
- Node and cluster health checks.
  Write your own custom health checks or use the predefined checks to access and use information about your cluster, including available ports, Mesos agent status, and IP detect script validation. [View the documentation](/1.11/installing/oss/custom/node-cluster-health-check/).
...
- DC/OS CLI 0.5.x adds [multi-cluster support](/1.11/cli/multi-cluster-cli/) with [`dcos cluster`](/1.11/cli/command-reference/dcos-cluster) commands. Multi-cluster support has a number of consequences:
