...
- Edge-LB load balancer.
  Edge-LB load balances Mesos tasks. Not supported in strict security mode. [View the documentation](/1.11/networking/edge-lb/).
