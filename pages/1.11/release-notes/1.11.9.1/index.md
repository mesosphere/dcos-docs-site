---
layout: layout.pug
navigationTitle: Release Notes for 1.11.9.1
title: Release Notes for 1.11.9.1
menuWeight: 5
excerpt: Release notes for DC/OS 1.11.9.1
---

DC/OS Version 1.11.9.1 was released on February 11, 2019.

[button color="purple" href="https://downloads.dcos.io/dcos/stable/1.11.9.1/dcos_generate_config.sh"]Download DC/OS Open Source[/button]

[button color="light" href="https://support.mesosphere.com/hc/en-us/articles/213198586"]Download DC/OS Enterprise[/button]

DC/OS 1.11.9.1 includes the following components:
...
# Issues Fixed in DC/OS 1.11.9.1
The issues that have been fixed in DC/OS 1.11.9.1 are grouped by feature, functional area, or component. Most change descriptions include one or more issue tracking identifiers for reference.
