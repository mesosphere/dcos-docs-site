...
excerpt: Hardware and software requirements for DC/OS 
...
Refer to [installation pre-requisite shell script](https://raw.githubusercontent.com/dcos/dcos/1.10/cloud_images/centos7/install_prereqs.sh) for an example of how to install the software requirements for DC/OS masters and agents on a CentOS 7 host. [enterprise type="inline" size="small" /]
...
Depending on your OS and configuration, you can check if NTP is enabled by running one of the following commands:
...
* If you specify `exhibitor_storage_backend: zookeeper`, the bootstrap node is a permanent part of your cluster. With `exhibitor_storage_backend: zookeeper` the leader state and leader election of your Mesos masters is maintained in Exhibitor ZooKeeper on the bootstrap node. 
  For more information, see the [configuration parameter documentation](/1.11/installing/production/configuration/configuration-parameters/).
...
[1]: /1.11/installing/production/system-requirements/install-docker-centos/
[2]: /1.11/installing/production/advanced-installer/
