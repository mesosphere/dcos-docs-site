...
Follow the Docker <a href="https://docs.docker.com/engine/installation/linux/centos/" target="_blank">CentOS-specific installation instructions</a> to install Docker on CentOS.
...
1.  Install the Docker engine, daemon, and service.
    ...
    When the process completes, you will see the below message.
