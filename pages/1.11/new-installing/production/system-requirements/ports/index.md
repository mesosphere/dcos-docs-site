...
|---|---|---|---|---|
| 53    | DC/OS Net | `dcos-net.service` | agent/master | agent/master | [open source type="inline" size="small" /]
...
| 61053 | Mesos DNS | `dcos-net.service` | agent/master | master | [open source type="inline" size="small" /]
...
|---|---|---|---|---|
| 53 | DNS Forwarder (Spartan) | `dcos-spartan.service` | agent/master | agent/master | [enterprise type="inline" size="small" /]
| 61053 | Mesos DNS | `dcos-mesos-dns.service` | agent/master | master | [open source type="inline" size="small" /]
