...
For a description of this parameter and examples, see the [configuration parameter documentation](/1.11/installing-upgrading/custom/configuration/configuration-parameters/#custom-checks).
