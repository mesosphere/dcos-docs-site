...
## [Basic templates](/1.11/installing-upgrading/cloud/aws/basic/)
...
## [Advanced templates](/1.11/installing-upgrading/cloud/aws/advanced/)
...
The recommended way to install production ready DC/OS that can be upgraded in-place is to use the [Advanced Installer](/1.11/installing-upgrading/cloud/aws/advanced/).
[/message]
