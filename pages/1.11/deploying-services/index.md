...
You can run DC/OS services you create or install a package from the [Universe package repository](/1.11/gui/#-a-name-universe-a-universe). Both services you create and those you install from Universe appear on the **Services** tab of the DC/OS web interface when they are running.
