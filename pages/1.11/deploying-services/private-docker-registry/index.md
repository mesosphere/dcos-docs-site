...
Follow these steps to add your Docker registry credentials to the [DC/OS Enterprise secrets store](https://docs.mesosphere.com/1.11/security/secrets/), and then reference that secret in your service definition.
