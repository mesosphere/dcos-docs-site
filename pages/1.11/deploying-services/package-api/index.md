...
For information about managing services, see [Managing Services](/1.11/deploying-services/).
...
To assign permissions to your account, see [Assigning permissions](/1.11/security/perms-reference/).
...
[api-explorer api='/1.11/api/package-manager.yaml']
