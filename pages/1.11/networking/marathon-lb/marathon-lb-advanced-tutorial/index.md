...
*   DC/OS installed by using the AWS [cloud templates](/1.11/installing/ent/cloud/aws/) with at least three [private](/1.11/overview/concepts/#private) agent and one [public](/1.11/overview/concepts/#public-agent-node) agent.
