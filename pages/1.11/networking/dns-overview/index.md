 ...
 * Port Name: `myport`
 * Load Balanced
* Running on a [Virtual Network](/1.11/networking/load-balancing-vips/virtual-networks/)
 ...
 * This is only available when the service is running on a [virtual network](/1.11/networking/load-balancing-vips/virtual-networks/).
1.  `myapp-subgroup-outergroup.marathon.agentip.dcos.thisdcos.directory`
 * This is always available and should be used when the service is not running on a [virtual network](/1.11/networking/load-balancing-vips/virtual-networks/).
1.  `myapp-subgroup-outergroup.marathon.autoip.dcos.thisdcos.directory`
 * This is always available and should be used to address an application that is transitioning on or off a [virtual network](/1.11/networking/load-balancing-vips/virtual-networks/).
