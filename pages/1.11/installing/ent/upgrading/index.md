...
- [`check_time`](/1.11/installing/ent/custom/configuration/configuration-parameters/#check-time)
- [`dns_search`](/1.11/installing/ent/custom/configuration/configuration-parameters/#dns-search)
- [`docker_remove_delay`](/1.11/installing/ent/custom/configuration/configuration-parameters/#docker-remove)
...
See the security [mode](/1.11/installing/ent/custom/configuration/configuration-parameters/#security-enterprise-dcos-only) for a description of the different security modes and what each means.
...
This procedure upgrades a DC/OS 1.9 cluster to DC/OS 1.10 without changing the cluster's [security mode](/1.11/installing/ent/custom/configuration/configuration-parameters/#security-enterprise-dcos-only).
...
This procedure upgrades to DC/OS 1.10 in [permissive security mode](/1.11/installing/ent/custom/configuration/configuration-parameters/#security-enterprise-dcos-only).
...
This procedure upgrades to DC/OS 1.10 in security strict [mode](/1.11/installing/ent/custom/configuration/configuration-parameters/#security-enterprise-dcos-only).
