...
- [Provision DC/OS manually on AWS](/1.11/installing/evaluation/community-supported-methods/aws/) (AWS): Install your DC/OS cluster on Amazon Web Services (AWS) by using the DC/OS templates on AWS CloudFormation. 
- [Provision DC/OS manually on Azure](/1.11/installing/evaluation/community-supported-methods/azure/): Install your DC/OS cluster on Azure by using the Azure Resource Manager templates.
...
You can use the [Mesosphere Universal Installer](/1.11/installing/evaluation/mesosphere-supported-methods) methods to install a fully functional cluster.
