...
- Adding and removing nodes:
  ...
  - - We recommend against reducing the node count in production, if you have stateful DC/OS apps and services. If nodes containing stateful services are removed from the cluster, stateful apps and services may suffer outages and failures depending on the behavior of the scheduler. Check the [stateful services dcoumentation](/1.11/tutorials/stateful-services/) to understand how they behave in case of node removal or failure.
