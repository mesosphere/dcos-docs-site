...
The Terraform-based Universal Installer is designed to be flexible with configuration. Below is an example of a custom `main.tf` that provisions a customized DC/OS 1.11.7 cluster on Azure.
...
| dcos_version | Specifies which DC/OS version instruction to use. Options: `1.11.8`, `1.12.2`, etc. See the [available version list](#supported-dcos-versions) for currently supported versions. | string | `1.11.7` | no |
