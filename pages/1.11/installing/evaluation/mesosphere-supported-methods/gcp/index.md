...
3) Next, initialize the modules. You must `cd` into `dcos-tf-gcp-demo` folder where you just created your `main.tf` file.
...
Cngratulations - you’re done!  In just 4 steps, you’ve successfully installed a DC/OS cluster on GCP!
