...
A DC/OS cluster requires robust time synchronization between nodes for optimal functionality. Please check that [NTP is enabled](/1.11/installing/production/system-requirements/#enable-ntp) on your DC/OS cluster to help ensure such robust synchronization.
