...
For more information, see the [multi-zone](/1.11/installing/high-availability/multi-zone/) and [multi-region](/1.11/installing/production/advanced-configuration/configuring-zones-and-regions/multi-region/) documentation.
