...
###  Prerequisites
- The AWS DC/OS advanced template [system requirements](/1.11/installing/evaluation/community-supported-methods/aws/advanced/).
...
2. Follow the instructions [here](/1.11/installing/evaluation/community-supported-methods/aws/advanced/) to create a cluster with advanced AWS templates, using the following GPU-specific configuration.
