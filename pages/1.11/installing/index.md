...
- [Provision DC/OS on Amazon Web Services(AWS)](/1.11/installing/evaluation/mesosphere-supported/aws/): Install your DC/OS cluster on Amazon Web Services (AWS) by using the Universal Installer.
- [Provision DC/OS on Azure](/1.11/installing/evaluation/mesosphere-supported/azure/): Install your DC/OS cluster on Azure by using the Universal Installer.
- [Provision DC/OS on Google Cloud Platform (GCP)](/1.11/installing/evaluation/mesosphere-supported/gcp/): Install your DC/OS cluster on GCP by using the Universal Installer. 
