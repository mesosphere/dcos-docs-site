...
| [fault_domain_enabled](#fault_domain_enabled)   | Set to `false` to opt out of fault domain awareness. |
...
Set this parameter to `false` to opt out of fault domain awareness for your service instances.
