...
- From the latest GA version of 1.10 to the latest GA version of 1.11. For example, if 1.10.2 is the latest and 1.11.0 is the latest, this upgrade would be supported.
- From any 1.11 release to the next. For example, an upgrade from 1.10.1 to 1.10.2 would be supported.
