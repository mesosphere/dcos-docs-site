...
There are no specific instructions for patching since it occurs as a part of the release. Refer to [Upgrading instructions](/1.11/installing/oss/upgrading/#instructions) for upgrading DC/OS.
