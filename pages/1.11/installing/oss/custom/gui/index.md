...
<table class="table">
  ...
  <tr>
    ...
    <td>Contains the [ZooKeeper](/1.11/overview/concepts/#zookeeper) data.</td>
  </tr>
  <tr>
...
3.  Click **Begin Installation**.
    ...
    ![Begin Install](/1.11/img/dcos-gui-install.png)
...
7.  Click **Run Post-Flight**. If errors any errors are found, fix and then click **Retry**.
    ...
    *  If you encounter errors such as `Time is marked as bad`, `adjtimex`, or `Time not in sync` during Post-Flight, verify that Network Time Protocol (NTP) is enabled on all nodes. For more information, see the [system requirements](/1.11/installing/oss/custom/system-requirements/#port-and-protocol).
...
8.  Click **Log In To DC/OS**. If this doesn't work, take a look at the [troubleshooting docs][9].
    ...
    ![login](/1.11/img/dcos-gui-login.png)
...
[2]: /1.11/networking/
[3]: /1.11/installing/oss/custom/system-requirements/
[4]: /1.11/administering-clusters/convert-agent-type/
[5]: /1.11/cli/install/
[7]: /1.11/installing/oss/custom/uninstall/
[9]: /1.11/installing/oss/troubleshooting/
[10]: /1.11/security/user-management/
