...
featureMaturity:
enterprise: true
navigationTitle:  Configuring DC/OS Access for Cassandra
---

This topic describes how to configure DC/OS access for Cassandra. Depending on your [security mode](/docs/1.9/overview/security/security-modes/), Cassandra requires [service authentication](/docs/1.9/security/service-auth/) for access to DC/OS.
