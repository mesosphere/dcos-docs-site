...
**Note:** Secrets are available only in Enterprise DC/OS 1.9 onwards. [Learn more about the secrets store](/docs/1.10/security/ent/secrets/).
...
[16]: /docs/1.10/overview/design/overlay/
[17]: /docs/1.10/deploying-services/containerizers/ucr/
[18]: http://mesos.apache.org/documentation/latest/endpoints/master/teardown/
[19]: https://docs.mesosphere.com/service-docs/spark/v2.0.1-2.2.0-1/hdfs/
