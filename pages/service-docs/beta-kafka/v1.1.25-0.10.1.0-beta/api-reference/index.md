...
If you are using open source DC/OS, follow these instructions to [pass your authentication token to the DC/OS endpoint](https://docs.mesosphere.com/docs/1.9/security/oss/iam-api/).
