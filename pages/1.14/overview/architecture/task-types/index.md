...
Additional schedulers can be installed as [scheduler services]\(/1.14/overview/concepts/#dcos-scheduler-service) on Marathon, either from the [Mesosphere Universe]\(/1.14/overview/concepts/#mesosphere-universe) or directly through Marathon.
