...
![Mesosphere DC/OS Enterprise Components]\(/1.14/img/dcos-components-1-12-updated.png)
...
The DC/OS package manager (Cosmos) installs and manages DC/OS packages from [DC/OS package repositories]\(/1.14/administering-clusters/repo/), such as the [Mesosphere Universe](https://github.com/mesosphere/universe).
