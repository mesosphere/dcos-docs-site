...
1. If you have a valid [authentication token](/mesosphere/dcos/1.14/security/oss/managing-authentication#log-in-cli) cookie (checked by Admin Router) you may proceed to the cluster front page. If not, you are redirected to the login page.
