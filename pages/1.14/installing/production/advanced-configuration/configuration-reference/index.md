...
| aws_template_storage_bucket                | The name of an S3 bucket to contain [customized advanced AWS templates]\(/1.14/installing/evaluation/community-supported-methods/aws/advanced/#create-your-templates). |
...
| ca_certificate_path                   | Use this to set up a custom CA certificate. See [using a Custom CA Certificate]\(/1.14/security/ent/tls-ssl/ca-custom#configuration-parameter-reference) page for a detailed configuration parameter reference. [enterprise type="inline" size="small" /] |
| ca_certificate_key_path           | Use this to set up a custom CA certificate. See [using a Custom CA Certificate]\(/1.14/security/ent/tls-ssl/ca-custom#configuration-parameter-reference) page for a detailed configuration parameter reference. [enterprise type="inline" size="small" /] |
| ca_certificate_chain_path       | Use this to set up a custom CA certificate. See [using a Custom CA Certificate]\(/1.14/security/ent/tls-ssl/ca-custom#configuration-parameter-reference) page for a detailed configuration parameter reference. [enterprise type="inline" size="small" /] |
...
| [iam_ldap_sync_interval]\(/1.14/security/ent/ldap/ldap-sync/) | Interval in seconds between LDAP synchronization operations. [enterprise type="inline" size="small" /] |
...
For more information on how these custom checks are used, see the [examples]\(/1.14/installing/ent/custom/configuration/examples/#custom-checks) and [Node and Cluster Health Check]\(/1.14/installing/production/deploying-dcos/configuration/examples/#custom-checks) documentation.
