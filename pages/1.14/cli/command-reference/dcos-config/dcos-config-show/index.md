...
The `dcos config show` command will display the DC/OS configuration file contents of the currently [attached cluster](/1.14/cli/command-reference/dcos-cluster/dcos-cluster-attach/).
