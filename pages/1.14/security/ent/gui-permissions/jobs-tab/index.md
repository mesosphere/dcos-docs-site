...
You can grant users access to the [**Jobs**](/1.14/gui/jobs/) tab. By default, new users have no permissions.
...
6.  Copy and paste the permission in the **Permissions Strings** field. Choose the permission strings based on your [security mode](/1.14/security/ent/#security-modes) and click **ADD PERMISSIONS** and then **Close**.
