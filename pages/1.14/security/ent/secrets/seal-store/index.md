...
The intended status of the seal is persisted, so after sealing the store the restart of `dcos-secrets` will not unseal it - only the steps depicted in [unsealing the store]\(/1.14/security/ent/secrets/unseal-store/) will.
