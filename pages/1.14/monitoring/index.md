...
![node detail](/mesosphere/dcos/1.14/img/GUI-Components-Compenent_Detail_View-1_12.png)

Figure 2. Individual component detail

You can debug further by clicking the node to view the component `journald` (log) output.

![log](/mesosphere/dcos/1.14/img/GUI-Components-Individual_Node_Detail_View-1_12.png)
