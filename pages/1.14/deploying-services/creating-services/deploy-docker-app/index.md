...
1.  If you used the [AWS CloudFormation templates](/mesosphere/dcos/1.14/installing/oss/cloud/aws/) to expose the app to the port specified in your app definition (for example, port 80), you must reconfigure the health check on the public ELB.
...
1.  Go to your public agent to see the site running. To find your public agent IP address, see [Finding a Public Agent IP](/mesosphere/dcos/1.14/administering-clusters/locate-public-agent/).
