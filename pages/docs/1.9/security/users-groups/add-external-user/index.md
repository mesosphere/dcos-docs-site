...
- An external [LDAP directory](/docs/1.9/security/ldap/). 
- An [OpenID Connect or SAML provider](/docs/1.9/security/sso/).
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/docs/1.9/security/iam-api/) endpoint. 
