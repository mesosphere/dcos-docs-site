...
The default Linux user of a service or job can vary according to the security mode and the container type. See [Linux users](/docs/1.9/security/ent/#linux-users) for more information.
