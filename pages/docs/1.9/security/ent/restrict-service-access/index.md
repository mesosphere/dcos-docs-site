...
- Enterprise DC/OS is [installed](/docs/1.9/installing/ent/) in permissive [mode](/docs/1.9/security/ent/#security-modes).
...
1.  Log out of the current user and then back in as a user with [superuser](/docs/1.9/security/ent/perms-reference/#superuser) permission. You will see that both services are running in the prod-a and prod-b-groups.  
