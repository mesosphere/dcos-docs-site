...
2. If the user has a valid [authentication token](/docs/1.9/security/oss/managing-authentication#log-in-cli) cookie (checked by Admin Router)
...
5. The login page dispatches a request with the user token to the
   ...
   in the [User Management](/docs/1.9/security/oss/user-management/) page.
