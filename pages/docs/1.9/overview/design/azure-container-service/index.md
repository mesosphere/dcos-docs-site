...
For a more comprehensive architectural description of DC/OS, see [The Architecture of DC/OS](/docs/1.9/overview/architecture/); for a more complete discussion of components, see [An Introduction to DC/OS Components](/docs/1.9/overview/architecture/components/).
...
![Azure Container Service architecture using DC/OS.](/docs/1.9/img/dcos-acs.png)
