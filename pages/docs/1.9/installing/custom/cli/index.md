...
1.  From your home directory, run this command to create a hashed password for superuser [authentication](/docs/1.9/security/#superuser). The hashed password is automatically appended to `config.yaml`.
...
- If something goes wrong and you want to rerun your setup, use these cluster <a href="/docs/1.9/installing/custom/uninstall/" target="_blank">cleanup instructions</a>.
