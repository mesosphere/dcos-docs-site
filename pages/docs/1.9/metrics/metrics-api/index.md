...
For examples of how to use the Metrics API, see the [Metrics Quick Start Guide](/docs/1.9/metrics/quickstart/).
...
To assign permissions to your account, see the [permissions reference](/docs/1.9/security/ent/perms-reference/).
...
[api-explorer api='/docs/1.9/api/metrics.yaml']
