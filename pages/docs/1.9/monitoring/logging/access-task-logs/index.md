...
**Important:** The functionality described in this document is only available in [strict security mode](/docs/1.9/security/ent/#security-modes).
...
Here is an overview of the [permissions](/docs/1.9/security/ent/perms-reference/) that are required:
...
- DC/OS and DC/OS CLI are [installed](/docs/1.9/installing/ent/) and you are logged in as a superuser.
