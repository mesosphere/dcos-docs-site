...
You can also  [configure Marathon's behavior when a task is unreachable](/docs/1.9/deploying-services/task-handling/configure-task-handling/).

![Task Handling Flow](/docs/1.9/img/task-handling.png)
