...
# Isolating Resources
Enterprise DC/OS [security features](/docs/1.9/security/ent/) provide robust fine-grained access control. However, there are situations when you might want a partitioned environment, for example: 
