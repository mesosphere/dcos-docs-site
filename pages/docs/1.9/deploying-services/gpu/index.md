...
1.  Install DC/OS using the [custom advanced installation instructions](/docs/1.9/installing/oss/custom/advanced/). Here are the GPU-specific configuration parameters:
    ...
    For more information, see the [configuration parameter documentation](/docs/1.9/installing/oss/custom/configuration/configuration-parameters/#enable_gpu_isolation) and Mesos [Nvidia GPU Support documentation](http://mesos.apache.org/documentation/latest/gpu-support/#external-dependencies). 

## AWS EC2 DC/OS Installation with GPUs

###  Prerequisites
- The AWS DC/OS advanced template [system requirements](/docs/1.9/installing/oss/cloud/aws/advanced/).
- The `zen.sh` script copied to your local machine. The script and instructions are [here](/docs/1.9/installing/oss/cloud/aws/advanced/).
...
1. Follow the instructions [here](/docs/1.9/installing/oss/cloud/aws/advanced/) to create a cluster with advanced AWS templates, using the following GPU-specific configuration.
