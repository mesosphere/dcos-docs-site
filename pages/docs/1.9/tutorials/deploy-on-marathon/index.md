...
Jenkins for DC/OS can be accessed through the Dashboard or Services navigation menu’s within the [DC/OS web interface](/docs/1.9/gui/). 

Click the “Jenkins” service and then "Open Service" to access the Jenkins web interface.

![dcos-velocity-jenkins-ui.png](/docs/1.9/img/dcos-velocity-jenkins-ui.png)
...
![dcos-velocity-jenkins-creds-new.png](/docs/1.9/img/dcos-velocity-jenkins-creds-new.png)
...
![dcos-jenkins-new-freestyle.png](/docs/1.9/img/dcos-jenkins-new-freestyle.png)
...
![dcos-jenkins-repourl.png](/docs/1.9/img/dcos-jenkins-repourl.png)
...
![dcos-velocity-jenkins-build-docker.png](/docs/1.9/img/dcos-velocity-jenkins-build-docker.png)
...
![dcos-velocity-jenkins-build-docker-config.png](/docs/1.9/img/dcos-velocity-jenkins-build-docker-config.png)
...
![dcos-jenkins-plugin-popup.png](/docs/1.9/img/dcos-jenkins-plugin-popup.png)
...
![dcos-velocity-marathon-config.png](/docs/1.9/img/dcos-velocity-marathon-config.png)
...
![dcos-jenkins-build-now.png](/docs/1.9/img/dcos-jenkins-build-now.png)
...
![dcos-jekyll-site1.png](/docs/1.9/img/dcos-jekyll-site1.png)
...
![dcos-jekyll-updated.png](/docs/1.9/img/dcos-jekyll-updated.png)
