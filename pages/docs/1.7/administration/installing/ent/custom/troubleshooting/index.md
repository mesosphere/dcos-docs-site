...
*   SSH to your agent node and enter this command to view the logs from boot time:
 ...
 [1]: /docs/1.7/administration/installing/ent/custom/configuration-parameters/#scrollNav-5
 [2]: https://open.mesosphere.com/reference/mesos-master/
 [3]: /docs/1.7/administration/installing/ent/custom/configuration-parameters/#scrollNav-7
 [4]: /docs/1.7/overview/architecture/#boot
 [5]: /docs/1.7/administration/installing/ent/custom/configuration-parameters
