...
#### [Zen](#zen) template
The [Zen](/docs/docs/1.7/administration/installing/oss/cloud/aws/advanced/template-reference/#zen) templates orchestrate the individual component templates to create a DC/OS cluster.

#### Agent template
The [agent](/docs/docs/1.7/administration/installing/oss/cloud/aws/advanced/template-reference/#private-agent) templates create [public](/docs/docs/1.7/overview/concepts/#public) or [private](/docs/docs/1.7/overview/concepts/#private) agent nodes that are then attached to a DC/OS cluster as a part of an AutoScalingGroup. 

#### Master template
The [master](/docs/docs/1.7/administration/installing/oss/cloud/aws/advanced/template-reference/#master) templates create master nodes, on top of the infrastructure stack already created.

#### Infrastructure template
The [infrastructure](/docs/docs/1.7/administration/installing/oss/cloud/aws/advanced/template-reference/#infrastructure) template defines and creates a DC/OS specific infrastructure that works well with an existing VPC. 
