...
2. If the user has a valid [authentication token](/docs/1.7/administration/id-and-access-mgt/managing-authentication#log-in-cli) cookie (checked by Admin Router)
