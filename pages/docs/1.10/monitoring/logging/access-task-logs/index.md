...
**Important:** The functionality described in this document is only available in [strict security mode](/docs/1.10/security/#security-modes).
...
Here is an overview of the [permissions](/docs/1.10/security/perms-reference/) that are required:
...
1.  Select **Organization** and choose **Groups**.
    ...
    ![New group](/docs/1.10/img/new-user-group.png)

1.  Create a new group.

    ![Prod group](/docs/1.10/img/new-user-group-prod.png)

    1.  Select the group name and from the **Permissions** tab, click **ADD PERMISSION**.

        ![Add permission to prod-group](/docs/1.10/img/new-user-group-prod-permission.png)
    ...
    1.  Click **INSERT PERMISSION STRING** to toggle the dialog, and then paste in the following permissions and click **ADD PERMISSIONS**.
        ...
        ![Add permission](/docs/1.10/img/new-user-group-prod-permission-string.png)

        The permissions tab should now look like this:

        ![prod-group permissions complete](/docs/1.10/img/new-user-group-prod-permission-done.png)
...
1.  From the **Group Membership** tab, type in the search box and choose the group name. This will grant the group permissions to an individual user.
    ...
    ![Add alice to security group](/docs/1.10/img/new-user-alice-add-group.png)
...
1.  Deploy a simple application in your group.
    ...
    1.  Select **Single Container** and define your service as:
        ...
        ![Define nested service](/docs/1.10/img/new-user-alice-service-group.png)

    1.  Click **REVIEW & RUN** to complete your installation. You should now see a service that is running in a group.

        ![Service running within group](/docs/1.10/img/new-user-alice-service-done.png)
...
**Prerequisite:**
You must [get the root cert](/docs/1.10/networking/tls-ssl/get-cert/) before issuing the curl commands in this section.
