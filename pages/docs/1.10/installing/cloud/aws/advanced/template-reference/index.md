...
### Agent templates
The [agent](#private-agent) templates create [public](/docs/1.10/overview/concepts/#public) or [private](/docs/1.10/overview/concepts/#private) agent nodes that are then attached to a DC/OS cluster as a part of an AutoScalingGroup. 
