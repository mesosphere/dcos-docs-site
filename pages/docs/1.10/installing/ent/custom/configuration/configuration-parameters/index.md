...
For more information, see the [examples](/docs/1.10/installing/ent/custom/configuration/examples/#docker-credentials).
...
For more information on how these custom checks are used, see the [examples](/docs/1.10/installing/ent/custom/configuration/examples/#custom-checks) and [Node and Cluster Health Check](/docs/1.10/installing/ent/custom/node-cluster-health-check/) documentation.
...
**Important:** Virtual networks require Docker version 1.11 or later. If you are using Docker 1.10 or earlier, you must specify `dcos_overlay_enable: 'false'`. For more information, see the [system requirements](/docs/1.10/installing/ent/custom/system-requirements/).
...
*  `dcos_overlay_enable: 'true'` Enable the DC/OS virtual network. This is the default value. After the virtual network is enabled, you can also specify the following parameters:
 ...
 For more information, see the [example](/docs/1.10/installing/ent/custom/configuration/examples/#overlay) and [documentation](/docs/1.10/networking/virtual-networks/).
...
*  `enable_docker_gc: 'true'` Run the docker-gc scripts once every hour. This is the default value for [cloud](/docs/1.10/installing/ent/cloud/) template installations.
*  `enable_docker_gc: 'false'` Do not run the docker-gc scripts once every hour. This is the default value for [custom](/docs/1.10/installing/ent/custom/) installations.
...
For more information, see the [examples](/docs/1.10/installing/ent/custom/configuration/examples/#http-proxy).
