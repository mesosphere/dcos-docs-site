...
For a complete set of DC/OS configuration options, see the [Advanced AWS Install Guide](/docs/1.10/installing/ent/cloud/aws/advanced/).
...
*   5 [private](/docs/1.10/overview/concepts/#private) Mesos agent nodes is the default.
*   1 [public](/docs/1.10/overview/concepts/#public) Mesos agent node is the default.
...
1.  Enter the username and password of the superuser account. 
    ...
    **Tip:** The default username is `bootstrapuser` and default password is `deleteme`.
    ...
    ![alt text](/docs/1.10/img/ui-installer-auth-1-7.gif)
