...
- Add a flag to the custom installer, `dcos_generate_config.sh --cli-telemetry-disabled`, to disable the CLI basic telemetry. For more information, see the [documentation](/docs/1.10/installing/oss/custom/cli/).
...
[1]: /docs/1.10/installing/oss/custom/cli/
[2]: /docs/1.10/installing/oss/custom/advanced/
[3]: /docs/1.10/installing/oss/custom/configuration/configuration-parameters/
[4]: /docs/1.10/installing/oss/custom/configuration/configuration-parameters/
