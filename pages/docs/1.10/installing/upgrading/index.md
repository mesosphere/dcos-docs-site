...
- [`check_time`](/docs/1.10/installing/custom/configuration-parameters/#check-time)
- [`dns_search`](/docs/1.10/installing/custom/configuration-parameters/#dns-search)
- [`docker_remove_delay`](/docs/1.10/installing/custom/configuration-parameters/#docker-remove)
- [`gc_delay`](/docs/1.10/installing/custom/configuration-parameters/#gc-delay)
- [`resolvers`](/docs/1.10/installing/custom/configuration-parameters/#resolvers)
- [`telemetry_enabled`](/docs/1.10/installing/custom/configuration-parameters/#telemetry-enabled)
- [`use_proxy`](/docs/1.10/installing/custom/configuration-parameters/#use-proxy)
    - [`http_proxy`](/docs/1.10/installing/custom/configuration-parameters/#use-proxy)
    - [`https_proxy`](/docs/1.10/installing/custom/configuration-parameters/#use-proxy)
    - [`no_proxy`](/docs/1.10/installing/custom/configuration-parameters/#use-proxy)
...
See the security [mode](/docs/1.10/installing/custom/configuration-parameters/#security) for a description of the different security modes and what each means.
...
This procedure upgrades a DC/OS 1.9 cluster to DC/OS 1.10 without changing the cluster's [security mode](/docs/1.10/installing/custom/configuration-parameters/#security).
...
1.  Merge the old `config.yaml` into the new `config.yaml` format. In most cases the differences will be minimal.
    ...
    *  The syntax of the `config.yaml` may be different from the earlier version. For a detailed description of the current `config.yaml` syntax and parameters, see the [documentation](/docs/1.10/installing/custom/configuration-parameters/).
...
This procedure upgrades to DC/OS 1.10 in [permissive security mode](/docs/1.10/installing/custom/configuration-parameters/#security).
...
**Important:** Any [custom node or cluster healthchecks](/docs/1.10/installing/custom/node-cluster-health-check/#custom-health-checks) you have configured will fail for an upgrade from disabled to permissive security mode. A future release will allow you to bypass the healthchecks.
...
This procedure upgrades to DC/OS 1.10 in security strict [mode](/docs/1.10/installing/custom/configuration-parameters/#security).
...
If your upgrade fails because of a [custom node or cluster check](/docs/1.10/installing/custom/node-cluster-health-check/#custom-health-checks), run these commands for more details:
```bash
