...
![Concept of distributed process management in DC/OS](/docs/1.10/img/dcos-architecture-distributed-process-management-concept.png)

Here is an example, using the Marathon service and a user launching a container based on a Docker image:

![Example of distributed process management in DC/OS](/docs/1.10/img/dcos-architecture-distributed-process-management-example.png)
...
![Sequence diagram for distributed process management in DC/OS](/docs/1.10/img/dcos-architecture-distributed-process-management-seq-diagram.png)
