...
Consult the [Quickstart Guide](/docs/1.10/networking/edge-lb/quickstart.md) for an example of a real-life Edge-LB configuration.
...
definitions:
  ...
  Pool:
    ...
    description: >-
      ...
      made to this section will relaunch the tasks.
    default:
      {
    ...
    properties:
      ...
      role:
        type: string
        description: >-
          Mesos role. Common ones include "*" (the default role) and
          "slave_public" (the public role).
      cpus:
        type: number
      cpusAdminOverhead:
        type: number
  ...
  Server:
    ...
    properties:
      ...
      task:
        ...
        properties:
          value:
            description: The Task name. This field is not needed for VIPs.
            type: string
          match:
            $ref: '#/definitions/Match'
      check:
