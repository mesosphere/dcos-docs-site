...
*   DC/OS installed by using the AWS [cloud templates](/docs/1.10/installing/oss/cloud/aws/) with at least three [private](/docs/1.10/overview/concepts/#private) agent and one [public](/docs/1.10/overview/concepts/#public-agent-node) agent.
...
1.  [Install](/docs/1.10/networking/marathon-lb/usage-ee/) the internal Marathon-LB instance with the custom options specified.
