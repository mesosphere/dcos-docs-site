...
Enterprise DC/OS requires the SAML identity provider (IdP) to:
...
While Enterprise DC/OS supports the full range of SAML 2.0 IdPs, the following procedure takes the OneLogin IdP as an example and provides step-by-step instructions.
...
**Tip:** This procedure uses the Identity and Access Management API (IAM API). For more details on the IAM API, you can visit the [IAM API documentation](/docs/1.10/security/ent/iam-api/).
...
3. Assign the desired permissions to the account. For more information about assigning permissions, visit the [Permissions](/docs/1.10/security/ent/perms-reference/) documentation.
