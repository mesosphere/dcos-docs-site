...
- An external [LDAP directory](/docs/1.10/security/ent/ldap/). 
- An [OpenID Connect or SAML provider](/docs/1.10/security/ent/sso/).
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/docs/1.10/security/ent/iam-api/) endpoint. 
