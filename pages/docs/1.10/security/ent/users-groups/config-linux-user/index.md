...
The default Linux user of a service or job can vary according to the security mode and the container type. See [Linux users](/docs/1.10/security/ent/#linux-users) for more information.
...
- If your [security mode](/docs/1.10/security/ent/#security-modes) is `permissive` or `strict`, you must follow the steps in [Downloading the Root Cert](/docs/1.10/networking/tls-ssl/#get-dcos-cert) before issuing the curl commands in this section. If your [security mode](/docs/1.10/security/ent/#security-modes) is `disabled`, you must delete `--cacert dcos-ca.crt` from the commands before issuing them.
