...
Permissions can be applied to users and groups using either the DC/OS GUI, the [IAM HTTP API](/docs/1.10/security/ent/iam-api/) or the [Enterprise DC/OS CLI](/docs/1.10/cli/enterprise-cli/).
