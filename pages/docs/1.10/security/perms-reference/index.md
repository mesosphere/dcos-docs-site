...
See [Permission Management](/docs/1.10/security/perms-management/) for details how to control permissions.
...
navigationTitle:  Permissions Reference
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------|---|---|---|---|
| `dcos:secrets:default:[<path-name>/]<secret-name>`<br> Controls access to individual [secrets](/docs/1.10/security/secrets/).                                                                                                                                                           | x    | x | x | x | x |
| `dcos:secrets:list:default:/[<path>]`<br> Controls view access to the names of [secrets](/docs/1.10/security/secrets/).                                                                                                                                                                 |      |   | x |   |   |
