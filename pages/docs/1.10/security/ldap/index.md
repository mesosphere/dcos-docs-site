...
**Important:** Review the DC/OS user ID requirements in [Managing users and groups](/docs/1.10/security/users-groups/).

**Requirement** The directory server must support [LDAP 3](https://tools.ietf.org/html/rfc4511).

To set up an LDAP connection:

1. [Configure your connection](/docs/1.10/security/ldap/ldap-conn/).

2. [Configure your authentication](/docs/1.10/security/ldap/ldap-auth/).

3. [Verify the connection](/docs/1.10/security/ldap/ldap-verify/).
