...
The default Linux user of a service or job can vary according to the security mode and the container type. See [Linux users](/1.10/security/#linux-users) for more information.
...
- If your [security mode](/1.10/security/#security-modes) is `permissive` or `strict`, you must follow the steps in [Downloading the Root Cert](/1.10/networking/tls-ssl/#get-dcos-cert) before issuing the curl commands in this section. If your [security mode](/1.10/security/#security-modes) is `disabled`, you must delete `--cacert dcos-ca.crt` from the commands before issuing them.
