...
1.  Copy and paste the permission in the **Permissions Strings** field. Choose the permission strings based on your [security mode](/docs/1.10/overview/security/security-modes/) and click **ADD PERMISSIONS** and then **Close**.
    ...
    To view task details and logs, you must grant access to the [Mesos UI](/docs/1.10/security/gui-permissions/mesos-ui/).   
    ...
    ### Task details and logs
    To view Marathon task details and logs, you must grant access to the [Mesos UI](/docs/1.10/security/gui-permissions/mesos-ui/).
