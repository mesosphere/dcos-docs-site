...
# Mesos-DNS
  ...
  The default scheduler for jobs is [Marathon](/docs/1.10/overview/architecture/components/#marathon), so the Mesos-DNS name for your Redis service is *redis.marathon.mesos*.
