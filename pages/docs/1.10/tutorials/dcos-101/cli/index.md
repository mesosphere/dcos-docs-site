...
# Steps
  * Install the DC/OS CLI
    * Follow the steps [here](/docs/1.10/cli/install/oss/) or the `Install CLI` instruction in the lower left corner of the DC/OS GUI.
    ...
    * You can also add/invite friends and co-workers to your cluster. See [user management documentation](/docs/1.10/security/ent/user-management/) for details
