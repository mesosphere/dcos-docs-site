...
1. Use the [Marathon API](/docs/1.10/deploying-services/marathon-api/) to deploy the app `basic-3-docker`. Refer to [Authentication HTTP API Endpoint](/docs/1.10/security/ent/iam-api/) to learn more about the API token required in the command below.
