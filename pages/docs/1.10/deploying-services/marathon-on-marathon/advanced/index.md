...
This topic describes how to deploy a non-native instance of Marathon with isolated roles, reservations, quotas, and security features. The advanced non-native Marathon procedure should only be used if you require [secrets](/docs/1.10/security/ent/secrets/) or fine-grain ACLs, otherwise use the [basic procedure](/docs/1.10/deploying-services/marathon-on-marathon/basic/).
...
-  DC/OS and DC/OS CLI [installed](/docs/1.10/installing/ent/).
