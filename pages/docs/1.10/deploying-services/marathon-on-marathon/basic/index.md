...
The basic procedure does not support [secrets](/docs/1.10/security/ent/secrets/) or fine-grained ACLs. If you require these features, you must use the custom non-native Marathon [procedure](/docs/1.10/deploying-services/marathon-on-marathon/advanced/).
