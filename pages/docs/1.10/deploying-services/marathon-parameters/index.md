...
- **type** The containerizer type, either `MESOS` or `DOCKER`. For more information, see the [Containerizers documentation](/1.10/deploying-services/containerizers/). 
...
### ipAddress
Declares that your application will use [virtual networking](/1.10/networking/load-balancing-vips/virtual-networks/).
