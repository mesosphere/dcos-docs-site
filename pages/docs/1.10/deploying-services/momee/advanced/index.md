...
This advanced procedure should only be used if you require a feature that is not supported by the [default non-native Marathon instance](/1.10/deploying-services/marathon-on-marathon/) in Universe. For example, these features are only supported by the custom non-native Marathon instance:

- [DC/OS Secrets](/1.10/security/secrets/) 
