...
- If something goes wrong and you want to rerun your setup, use these cluster <a href="/docs/1.8/administration/installing/custom/uninstall/" target="_blank">cleanup instructions</a>.
...
It is recommended that you save your DC/OS installer file immediately after installation completes and before you start using DC/OS. These installer files can be used to add more agent nodes to your cluster, including the [public agent](/docs/1.8/administration/installing/custom/convert-agent-type/) node.
...
2.  Run the installation steps beginning with [installing the cluster][15] prerequisites:
 ...
 [1]: /docs/1.8/administration/installing/custom/system-requirements/
 [2]: /docs/1.8/administration/installing/custom/uninstall/
 [3]: /docs/1.8/administration/installing/custom/configuration-parameters/
 [5]: /docs/1.8/administration/installing/custom/configuration-parameters/#rexray-config
 [6]: http://rexray.readthedocs.io/en/stable/user-guide/config/
 [7]: /docs/1.8/usage/storage/external-storage/
 [8]: /docs/1.8/administration/installing/custom/advanced/#configuration
 [9]: /assets/images/chef-zk-status.png
 [10]: /assets/images/gui-installer-login-ee.gif
 [11]: /assets/images/dashboard-ee.gif
 [12]: /docs/1.8/administration/id-and-access-mgt/
 [13]: #hardware
 [14]: #software
 [15]: #two
