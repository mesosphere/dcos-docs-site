...
- Manual modifications of Admin Router config are no longer supported. If you require a custom certificate, you must run [HAProxy in front of Admin Router](/docs/1.8/administration/tls-ssl/haproxy-adminrouter/).
...
For more information, see the [documentation](/docs/1.8/administration/tls-ssl/).
...
Enterprise DC/OS can be configured to enable or require TLS/SSL encryption. For more information, see the [documentation](/docs/1.8/administration/tls-ssl/).
...
- DCOS-9090 Marathon-LB does not install with default options on an auth-enabled DC/OS cluster. For a workaround, see the [documentation](https://docs.mesosphere.com/docs/1.8/usage/service-discovery/marathon-lb/usage/).
...
- DCOS-9092 - Insecure certificate warning. <!-- For a workaround, see the [documentation](). --> (Enterprise Only)
<!-- DCOS-7724 - The Secret Store requires the `dcos:superuser` permission to access. (Enterprise Only) -->
