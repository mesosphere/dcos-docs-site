...
The ability to provision Spark with a service account varies by [security mode](/docs/1.8/administration/installing/custom/configuration-parameters/#security).
