...
Whether you can or must provision Kafka with a service account varies by [security mode](/docs/1.8/administration/installing/custom/configuration-parameters/#security).
