...
To get an authentication token, pass the user name and password of a `superuser` in the body of a request to the `/auth/login` endpoint of the [Identity and Access Management Service API](/docs/1.8/administration/id-and-access-mgt/iam-api/). It returns an authentication token as shown below.
...
[api-explorer api='/docs/1.8/api/secrets.yaml']
