...
**Prerequisite:** A local copy of the [root certificate of your DC/OS CA](/docs/1.8/administration/tls-ssl/ent/get-cert/).

If you have not [set up a proxy](/docs/1.8/administration/tls-ssl/ent/haproxy-adminrouter/), you should use `--cacert dcos-ca.crt` in your curl commands in `permissive` and `strict` security modes. 
