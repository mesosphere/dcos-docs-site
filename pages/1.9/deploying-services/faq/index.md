...
This is not currently supported. For more information, see [this document](/docs/1.9/networking/high-availability/).
...
For more information, see the installation [documentation](/docs/1.9/installing/oss/).
