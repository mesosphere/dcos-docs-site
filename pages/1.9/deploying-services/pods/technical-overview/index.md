...
Below are example environment variables reflecting the [multi-pod JSON pod definition example](/1.9/deploying-services/pods/examples/#multi-pod).
...
Marathon pods support the [DC/OS Universal container runtime](/1.9/deploying-services/containerizers/). The Universal container runtime [supports multiple images, such as Docker](http://mesos.apache.org/documentation/latest/container-image/).
