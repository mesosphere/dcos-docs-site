...
1.  If you used the [AWS CloudFormation templates](/docs/1.9/installing/oss/cloud/aws/), you must reconfigure the health check on the public ELB to expose the app to the port specified in your app definition (e.g. port 80). 
