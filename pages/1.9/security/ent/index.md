...
By default, all tasks will run inside of Docker containers. However, a user service can be configured to run tasks inside of Docker containers instead. Please see [Deploying a Docker-based Service to Marathon](/1.9/deploying-services/creating-services/deploy-docker-app/) for an example.
