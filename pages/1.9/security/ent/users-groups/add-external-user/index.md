...
- An external [LDAP directory](/1.9/security/ent/ldap/).
- An [OpenID Connect or SAML provider](/1.9/security/ent/sso/).
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/1.9/security/ent/iam-api/) endpoint.
