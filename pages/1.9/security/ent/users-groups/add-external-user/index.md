...
- An external [LDAP directory](/mesosphere/dcos/1.9/security/ent/ldap/).
- An [OpenID Connect or SAML provider](/mesosphere/dcos/1.9/security/ent/sso/).
...
6. When completed, your dialog should look something like the following.
   ...
   ![LDAP Group Import Configuration](/mesosphere/dcos/1.9/img/ldap-group-import.png)
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/mesosphere/dcos/1.9/security/ent/iam-api/) endpoint.
