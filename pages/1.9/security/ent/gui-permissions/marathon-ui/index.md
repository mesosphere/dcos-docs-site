...
1.  Copy and paste the permission in the **Permissions Strings** field. Choose the permission strings based on your [security mode](/mesosphere/dcos/1.9/security/ent/#security-modes) and click **ADD PERMISSIONS** and then **Close**.
    ...
    To view task details and logs, you must grant access to the [Mesos UI](/mesosphere/dcos/1.9/security/ent/gui-permissions/mesos-ui/).   
    ...
    ### Task details and logs
    To view Marathon task details and logs, you must grant access to the [Mesos UI](/mesosphere/dcos/1.9/security/ent/gui-permissions/mesos-ui/).
