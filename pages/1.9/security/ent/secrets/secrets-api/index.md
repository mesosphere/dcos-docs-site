...
To get an authentication token, pass the user name and password of a `superuser` in the body of a request to the `/auth/login` endpoint of the [Identity and Access Management Service API](/1.9/security/ent/iam-api/). It returns an authentication token as shown below.
...
[api-explorer api='/1.9/api/secrets.yaml']
