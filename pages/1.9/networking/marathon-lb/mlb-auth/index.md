...
This topic describes how to configure DC/OS access for Marathon-LB. Depending on your [security mode](/1.9/security/#security-modes), Marathon-LB requires [service authentication](/1.9/security/service-auth/) for access to DC/OS.
