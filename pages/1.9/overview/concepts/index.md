...
- Prior to version 1.6, DC/OS was known as the Distributed Cloud Operating System (DCOS). With version 1.6 the platform was renamed to DC/OS and open sourced.
...
The [DC/OS graphical user interface (GUI)](/1.9/gui/) is an interface for remotely controlling and managing a DC/OS cluster from a web browser. The GUI is also sometimes called the DC/OS UI or DC/OS web interface.

# <a name="dcos-cli"></a>DC/OS CLI

The [DC/OS command line interface (CLI)](/1.9/cli/) is an interface for remotely controlling and managing a DC/OS cluster from a terminal.
...
For more information, see [Network Security](/1.9/administering-clusters/) and [Adding Agent Nodes](/1.9/administering-clusters/add-a-node/).
...
For more information, see the [Mesos-DNS documentation](/1.9/networking/mesos-dns/).
