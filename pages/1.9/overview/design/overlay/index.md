...
![Agent configuration for containers running on MesosContainerizer and Docker once the VxLAN has been configured.](/mesosphere/dcos/1.9/img/overlay-fig-1.png)
...
![Software architecture for DC/OS overlay control plane.](/mesosphere/dcos/1.9/img/overlay-fig-2.png)
