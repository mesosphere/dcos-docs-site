...
![Mesosphere DC/OS Enterprise Components](/mesosphere/dcos/1.9/img/dcos-enterprise-components-1.9.png)
...
The **Mesos Persistent Volume Discovery service** was removed in DC/OS 1.9.0. Detection of [mounted disk resources](/mesosphere/dcos/1.9/storage/mount-disk-resources/) is now handled by the DC/OS Setup service.
...
Most DC/OS components run as [systemd services](/mesosphere/dcos/1.9/overview/concepts/#systemd-service) on the DC/OS nodes.
