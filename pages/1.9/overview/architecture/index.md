...
![DC/OS Architecture Layers](/mesosphere/dcos/1.9/img/dcos-architecture-layers.png)
...
For more information, see [Task Types](/mesosphere/dcos/1.9/overview/architecture/task-types/).
...
For more information, see [Components](/mesosphere/dcos/1.9/overview/architecture/components/), [Node Types](/mesosphere/dcos/1.9/overview/architecture/node-types/), and [Host Operating System](/mesosphere/dcos/1.9/overview/concepts/#host-operating-system).
...
For more information, see [Installing](/mesosphere/dcos/1.9/installing/oss/).

## External Components

In addition to the software that runs in the datacenter, DC/OS includes and integrates with several external components: the [GUI](/mesosphere/dcos/1.9/gui/), [CLI](/mesosphere/dcos/1.9/cli/), [package repository](/mesosphere/dcos/1.9/administering-clusters/repo/), and [container registry](/mesosphere/dcos/1.9/overview/concepts/#container-registry).
