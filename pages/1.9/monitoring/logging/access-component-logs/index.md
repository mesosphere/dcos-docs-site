...
Here is the [permission](/mesosphere/dcos/1.9/security/ent/perms-reference/) that is required to view the system and component logs:
...
1.  From the **Permissions** tab, select **ADD PERMISSION**.
    ...
    ![Add permission to user](/mesosphere/dcos/1.9/img/permission-user.png)
...
1.  Click **INSERT PERMISSION STRING** to toggle the dialog and paste in the following permissions and click **ADD PERMISSIONS**.
    ...
    ![Add permission](/mesosphere/dcos/1.9/img/comp-log-perms.png)
      
    The permissions tab should now look like this:
      
    ![prod-group permissions complete](/mesosphere/dcos/1.9/img/comp-log-perms-done.png)
