...
### Agent templates
The [agent](#private-agent) templates create [public](/1.9/overview/concepts/#public) or [private](/1.9/overview/concepts/#private) agent nodes that are then attached to a DC/OS cluster as a part of an AutoScalingGroup. 
