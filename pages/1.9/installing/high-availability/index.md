...
DC/OS multiple zone (multi-AZ) configuration support is [preview](/1.9/overview/feature-maturity/#preview) and multiple region configuration support is [experimental](/1.9/overview/feature-maturity/#experimental).
...
For more information, see the [multi-zone](/1.9/installing/ent/high-availability/multi-zone/) and [multi-region](/1.9/installing/ent/high-availability/multi-region/) documentation.
