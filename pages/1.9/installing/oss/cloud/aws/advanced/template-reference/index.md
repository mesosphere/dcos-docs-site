...
#### Agent template
The [agent](/1.9/installing/oss/cloud/aws/advanced/template-reference/#private-agent) templates create [public](/1.9/overview/concepts/#public-agent-node) or [private](/1.9/overview/concepts/#private) agent nodes that are then attached to a DC/OS cluster as a part of an AutoScalingGroup.
