...
### Agent templates
The [agent](#private-agent) templates create [public](/1.8/overview/concepts/#public) or [private](/1.8/overview/concepts/#private) agent nodes that are then attached to a DC/OS cluster as a part of an AutoScalingGroup. 
