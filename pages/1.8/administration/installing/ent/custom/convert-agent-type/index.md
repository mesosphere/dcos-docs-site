...
*   DC/OS is installed using the [custom](/1.8/administration/installing/ent/custom/) installation method and you have deployed at least one [master](/1.8/overview/concepts/#master) and one [private](/1.8/overview/concepts/#private) agent node.
