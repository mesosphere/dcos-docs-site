...
The recommended way to install production ready DC/OS that can be upgraded in-place is to use the [Advanced Installer](/1.8/administration/installing/oss/custom/advanced/).
[/message]
