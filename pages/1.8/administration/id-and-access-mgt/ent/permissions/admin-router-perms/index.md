  ...
  <tr>
    <td colspan="2">
     Allows access to:<br/>
      ...
      &#x25cf; <code>dcos task</code> <b>command of the <a href="/1.8/usage/cli/command-reference/#scrollNav-10">DC/OS CLI</a>:</b> allows you to list tasks and retrieve task information such as sandbox data.
    </td>
  </tr>
</table>
