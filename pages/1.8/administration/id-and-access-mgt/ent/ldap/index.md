...
**Important:** Review the DC/OS user ID requirements in [Managing users and groups](/1.8/administration/id-and-access-mgt/ent/users-groups/).

**Requirement** The directory server must support [LDAP 3](https://tools.ietf.org/html/rfc4511).

To set up an LDAP connection:

1. [Configure your connection](/1.8/administration/id-and-access-mgt/ent/ldap/ldap-conn/).

2. [Configure your authentication](/1.8/administration/id-and-access-mgt/ent/ldap/ldap-auth/).

3. [Verify the connection](/1.8/administration/id-and-access-mgt/ent/ldap/ldap-verify/).
