...
To get an authentication token, pass the user name and password of a user with the necessary permissions in the body of a request to the `/auth/login` endpoint of the [Identity and Access Management Service API](/1.8/administration/id-and-access-mgt/ent/iam-api/). It returns an authentication token as shown below.
...
[swagger api='/1.8/api/certificate-authority.yaml']
