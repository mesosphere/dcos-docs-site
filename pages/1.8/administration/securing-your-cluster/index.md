...
navigationTitle: Securing Your Cluster
menuWeight: 7
---
...
If you run HAProxy in front of Admin Router, you should secure the communication between them. For information about securing your communication, see the [documentation](/docs/1.8/networking/tls-ssl/haproxy-adminrouter/).
...
[Marathon-LB](/1.8/usage/service-discovery/marathon-lb/) with HTTPS for
...
See the [Security Administrator's Guide](/1.8/administration/id-and-access-mgt/ent/) for more information.
