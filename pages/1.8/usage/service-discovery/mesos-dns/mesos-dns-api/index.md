...
To authenticate API requests, see [Obtaining an authentication token](/1.8/administration/id-and-access-mgt/ent/iam-api/#obtaining-an-authentication-token) and [Passing an authentication token](/1.8/administration/id-and-access-mgt/ent/iam-api/#passing-an-authentication-token).
...
To assign permissions to your account, see the [permissions reference](/1.8/administration/id-and-access-mgt/ent/permissions/).
