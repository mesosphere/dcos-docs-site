...
### Prerequisites
- [A DC/OS cluster](/1.8/administration/installing/oss/) with at least one [private](/1.8/overview/concepts/#private-agent-node) agent and one [public](/1.8/overview/concepts/#public-agent-node) agent.
