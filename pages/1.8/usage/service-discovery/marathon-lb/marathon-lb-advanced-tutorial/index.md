...
1.  Verify that Marathon-LB is working. Find the public IP for your [public node](/1.8/administration/locate-public-agent/) and navigate to `<public-agent-IP>:9090/haproxy?stats`. You will see a statistics report page like this:
    ...
    ![lb2](/1.8/usage/service-discovery/marathon-lb/img/lb2.jpg)
...
1.  [Install](/1.8/usage/service-discovery/marathon-lb/usage-ee/) the internal Marathon-LB instance with the custom options specified.
...
1.  Test the configuration by [SSHing][4] into one of the instances in the cluster (such as a master), and curl the endpoints:
    ...
    ![lb3](/1.8/usage/service-discovery/marathon-lb/img/lb3.jpg)
...
1.  Navigate to the public agent in your browser and you should see the following:
    ...
    ![lb6](/1.8/usage/service-discovery/marathon-lb/img/lb6.jpg)
