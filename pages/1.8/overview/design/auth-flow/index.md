...
2. If the user has a valid [authentication token](/1.8/administration/id-and-access-mgt/managing-authentication#log-in-cli) cookie (checked by Admin Router)
...
5. The login page dispatches a request with the user token to the
   ...
   in the [User Management](/1.8/administration/id-and-access-mgt/user-management/) page.
