...
```
FROM mesosphere/kubeflow:1.0.1-0.4.1-pytorch-1.5.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:mnist-pytorch-1.0.1-0.4.1` in case you want to skip it for now.
