...
```
    ...
    Requires: six, astunparse, protobuf, tensorflow-estimator, absl-py, keras-preprocessing, tensorboard, numpy, scipy, google-pasta, termcolor, wheel, gast, opt-einsum, wrapt, grpcio, h5py
    Required-by: ml-metadata
...
```
FROM mesosphere/kubeflow:1.0.1-0.3.0-tensorflow-2.2.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:tensorflow-2.2-mnist-1.0.1-0.3.0` in case you want to skip it for now.
        ...
        spec:
          containers:
            - name: tensorflow
              ...
              image: mesosphere/kubeflow:tensorflow-2.2-mnist-1.0.1-0.3.0
              args:
                - --epochs
                - "15"
                - --steps
