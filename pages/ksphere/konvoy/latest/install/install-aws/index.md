...
* [kubectl][install_kubectl] v1.15.3 or later (for interacting with the running cluster)
...
* `cluster.yaml` - defines the Konvoy configuration for the cluster, where you customize [your cluster provisioning configuration][cluster_provision] and [your add-ons][add-ons_config].
