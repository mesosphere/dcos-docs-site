---
layout: layout.pug
navigationTitle:  Deploy to multiple clusters
title: Deploy to multiple clusters
menuWeight: 10
beta: false
excerpt: Deploy different versions of an application to staging and production environments.
---
...
- [GitOps Based Deployments](../../../deployment/rolling-deployment/)
...
This tutorial modifies the "hello-world" application repository and the accompanying
"hello-world-gitops" gitops repository to deploy to separate "staging" and "production"
environments.

## Add the clusters to ArgoCD

In order to manage the staging and production clusters, ArgoCD needs access to those
clusters. Add two new clusters to ArgoCD (i.e., staging and production) to serve as the two
clusters:
