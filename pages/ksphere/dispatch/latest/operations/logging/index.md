...
The Dispatch CLI supports viewing the logs of the [pipelines controller](/charts/dispatch/charts/tekton/templates/tekton.yaml) and [event sink](/charts/dispatch/templates/event-sink.yaml) components.
...
In order to list the pipeline runs (active and completed):
