...
- A configured [Identity Provider](https://docs.d2iq.com/ksphere/kommander/1.1/tutorials/authorize-all-users/).
...
You can use the Kommander UI or the `kubectl` CLI to create policies, as explained in the [role-based access control configuration tutorial](https://docs.d2iq.com/ksphere/kommander/1.1/tutorials/configure-rbac/). This tutorial will explain you how to offer a certain access to a given group.
