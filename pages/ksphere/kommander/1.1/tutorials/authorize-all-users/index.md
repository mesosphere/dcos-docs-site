...
![Setting up the GitHub OAuth App](/ksphere/kommander/1.1.0-beta/img/tutorial-idp-github-oauth-app.png)

Once we create this application we are going to see something like this:

![Created a GitHub OAuth App](/ksphere/kommander/1.1.0-beta/img/tutorial-idp-github-oauth-created.png)
...
![Adding the GitHub OAuth App](/ksphere/kommander/1.1.0-beta/img/tutorial-idp-github-added.png)
...
![Adding a developer group](/ksphere/kommander/1.1.0-beta/img/tutorial-auth-developer-group.png)
...
![Adding a read role](/ksphere/kommander/1.1.0-beta/img/tutorial-auth-developer-role.png)
...
![Adding a policy](/ksphere/kommander/1.1.0-beta/img/tutorial-auth-developer-policy.png)

Lastly, follow the example in the [Access Control documentation](https://docs.d2iq.com/ksphere/kommander/1.1.0-beta/operations/access-control/#special-limitation-for-opsportal-and-kommander-roles) to grant users access to the Opsportal and Kommander routes on your cluster.
