---
layout: layout.pug
navigationTitle: Amazon Web Services (AWS) Cloud Provider
title: Amazon Web Services (AWS) Cloud Provider
excerpt: Managing the AWS cloud provider used by Kommander
---

Kommander needs authentication keys to AWS to automate its provisioning. It is possible to have many accounts for a single cloud provider.
...
![Cloud Provider Form with values](/ksphere/kommander/img/AWS-cloud-provider-with-values.png)
