...
![Create Cluster Upload YAML](/ksphere/kommander/1.0/img/create-cluster-yaml.png)
...
![Update Kubernetes Version Action](/ksphere/kommander/1.0/img/upgrade-kubernetes-confirmation.png)

## Editing Clusters

![Edit a Cluster Action](/ksphere/kommander/1.0/img/edit-cluster-action.png)
...
![Edit a Cluster Form](/ksphere/kommander/1.0/img/edit-cluster-form-name.png)
...
![Cluster card with resources](/ksphere/kommander/1.0/img/cluster-card.png)
...
For more detailed information, see the <a href="https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/" target="_blank">Kubernetes documentation</a> about resources.
...
![Cluster Detail Page](/ksphere/kommander/1.0/img/cluster-detail-page.png)
