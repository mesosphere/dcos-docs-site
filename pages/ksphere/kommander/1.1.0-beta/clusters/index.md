...
You will already need to have run `konvoy up` with the Kommander addon deployed. You should be looking at the Kommander UI.
If you are creating a cluster with a cloud partner (Azure, AWS), you will need to configure your [infrastructure provider](/ksphere/kommander/1.1.0-beta/operations/infrastructure-providers/).
...
- [Creating Konvoy Clusters on AWS](/ksphere/kommander/1.1.0-beta/clusters/creating-konvoy-cluster-aws/)
- [Creating Konvoy Clusters on Azure](/ksphere/kommander/1.1.0-beta/clusters/creating-konvoy-cluster-azure/)
- [Creating Konvoy Clusters on your own infrastructure](/ksphere/kommander/1.1.0-beta/clusters/creating-konvoy-cluster-on-prem/)
...
See [Attach Cluster](/ksphere/kommander/1.1.0-beta/clusters/attach-cluster/)

### Creating a Konvoy Cluster via YAML

Clicking the Upload YAML option will allow you to utilize a config generated by the Konvoy CLI tool. An example config can be created in the file `cluster.yaml` by [running](/ksphere/konvoy/1.5.0-beta/reference/command-line-interface/konvoy-init/) `konvoy init`, or one is generated after running `konvoy up`. Ensure the correct Cloud Provider credentials are selected and add any cluster labels that apply.

![Create Cluster Upload YAML](/ksphere/kommander/1.1.0-beta/img/create-cluster-yaml.png)

#### Adding Infrastructure Provider Tags

A tag is similar to a label and can help manage and track this cluster at the infrastructure provider level along with other provider resources. As providers support different amounts of tags, up to 10 tags may be added here as baseline. You can always add more directly via your infrastructure provider.
...
Figure 1:
![Update Kubernetes Version Action](/ksphere/kommander/1.1.0-beta/img/upgrade-kubernetes-action-1-1-0.png)
Figure 2:
![Update Kubernetes Version Action](/ksphere/kommander/1.1.0-beta/img/upgrade-kubernetes-confirmation-1-1-0.png)
...
![Edit an Attached Cluster](/ksphere/kommander/1.1.0-beta/img/edit-cluster-attached-1-1-0.png)
...
![Edit a Cluster Form](/ksphere/kommander/1.1.0-beta/img/edit-cluster-form-name-1-1-0.png)
...
![Edit a Cluster Node Pools](/ksphere/kommander/1.1.0-beta/img/edit-cluster-node-pools.png)

#### Editing labels and cloud provider tags

When editing labels, you can not delete the region or provider labels.

![Edit a Cluster Labels and Cloud Provider Tags](/ksphere/kommander/1.1.0-beta/img/edit-cluster-labels-tags-1-1-0.png)
...
![Cluster card with resources](/ksphere/kommander/1.1.0-beta/img/cluster-card.png)
...
For more detailed information, see the <a href="https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/" target="_blank">Kubernetes documentation</a> about resources.
