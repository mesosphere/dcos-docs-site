...
If you are creating a cluster with a cloud partner (Azure, AWS), you need to configure your [infrastructure provider](/ksphere/kommander/1.1/operations/infrastructure-providers/).
If you are planning on attaching more than one cluster, ensure you enter your valid [license](/ksphere/kommander/1.1/licensing/).
...
- [Creating Konvoy Clusters on AWS](/ksphere/kommander/1.1/clusters/creating-konvoy-cluster-aws/)
- [Creating Konvoy Clusters on Azure](/ksphere/kommander/1.1/clusters/creating-konvoy-cluster-azure/)
- [Creating Konvoy Clusters on your own infrastructure](/ksphere/kommander/1.1/clusters/creating-konvoy-cluster-on-prem/)
...
See [Attach Cluster](/ksphere/kommander/1.1/clusters/attach-cluster/)
...
![Create Cluster Upload YAML](/ksphere/kommander/1.1/img/create-cluster-yaml.png)
...
Cluster labels are matched to the selectors created for [projects](/ksphere/kommander/1.1/projects/). If a cluster is removed from a project, any resources deployed to the cluster from that Project are removed. If a cluster is added to a project any existing project resources are deployed to the cluster.
...
Figure 1:
![Update Kubernetes Version Action](/ksphere/kommander/1.1/img/upgrade-kubernetes-action-1-1-0.png)
Figure 2:
![Update Kubernetes Version Action](/ksphere/kommander/1.1/img/upgrade-kubernetes-confirmation-1-1-0.png)

## Editing Clusters

![Edit a Cluster Action](/ksphere/kommander/1.1/img/edit-cluster-action.png)

### Editing an Attached cluster

For an Attached cluster you can only edit labels that are assigned to it.

![Edit an Attached Cluster](/ksphere/kommander/1.1/img/edit-cluster-attached-1-1-0.png)
...
![Edit a Cluster Form](/ksphere/kommander/1.1/img/edit-cluster-form-name-1-1-0.png)
...
![Edit a Cluster Node Pools](/ksphere/kommander/1.1/img/edit-cluster-node-pools.png)

#### Editing labels and cloud provider tags

When editing labels, you can not delete the region or provider labels.

![Edit a Cluster Labels and Cloud Provider Tags](/ksphere/kommander/1.1/img/edit-cluster-labels-tags-1-1-0.png)
...
![Cluster card with resources](/ksphere/kommander/1.1/img/cluster-card.png)
...
![Cluster Detail Page](/ksphere/kommander/1.1/img/cluster-detail-page.png)
