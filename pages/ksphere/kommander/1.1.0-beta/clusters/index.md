...
![Update Kubernetes Version Action](/ksphere/kommander/1.1.0-beta/img/upgrade-kubernetes-action.png)

![Update Kubernetes Version Action](/ksphere/kommander/1.1.0-beta/img/upgrade-kubernetes-confirmation.png)
...
![Edit an Attached Cluster](/ksphere/kommander/1.1.0-beta/img/edit-cluster-attached.png)

### Editing a Managed cluster

For a Managed cluster you can edit its name, labels, cloud provider tags and its node pools.

![Edit a Cluster Form](/ksphere/kommander/1.1.0-beta/img/edit-cluster-form-name.png)
...
![Edit a Cluster Labels and Cloud Provider Tags](/ksphere/kommander/1.1.0-beta/img/edit-cluster-labels-tags.png)
