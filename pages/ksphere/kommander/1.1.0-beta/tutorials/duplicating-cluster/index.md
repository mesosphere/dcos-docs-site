...
![Creating a role](/ksphere/kommander/1.1.0-beta/img/tutorial-ecommerce-role.png)
...
![Created ConfigMaps](/ksphere/kommander/1.1.0-beta/img/tutorial-ecommerce-config-maps.png)
...
![Create Cloud Provider](/ksphere/kommander/1.1.0-beta/img/tutorial-ecommerce-create-cloud-provider.png)

Once we did this we can go to the clusters view, click the Add Cluster button and select Create Konvoy Cluster.

![Create Cluster](/ksphere/kommander/1.1.0-beta/img/tutorial-ecommerce-create-cluster.png)
...
![Created Secrets](/ksphere/kommander/1.1.0-beta/img/tutorial-ecommerce-target-secret.png)
![Created Config Map](/ksphere/kommander/1.1.0-beta/img/tutorial-ecommerce-target-configmap.png)
![Created Role](/ksphere/kommander/1.1.0-beta/img/tutorial-ecommerce-target-role.png)
