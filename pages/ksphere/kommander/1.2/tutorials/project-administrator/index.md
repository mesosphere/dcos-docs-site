...
- _Project admin_: these users can administer the projects they have specifically been given access to.
...
You have already assigned users to the group that represents the persona. You must now modify the resource access level for this persona by associating roles with the groups using policies.
...
Project Policies Table
   ...
   The default role that will be used for this persona is:

- _Kommander Project Admin Role_: because this is a Kommander Role type role, it applies to the management cluster. This role grants admin access to the project namespace on the management cluster. When a policy is created with this role, another role and policy is automatically created at the workspace level to allow access to this project specifically.
