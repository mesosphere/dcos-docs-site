...
```
FROM mesosphere/kubeflow:1.0.1-0.3.0-pytorch-1.5.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:pytorch-1.5-mnist-1.0.1-0.3.0` in case you want to skip it for now.
        ...
        spec:
          containers:
            - name: pytorch
              ...
              image: mesosphere/kubeflow:pytorch-1.5-mnist-1.0.1-0.3.0
