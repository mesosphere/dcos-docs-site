...
#### Agent template
The [agent](/1.7/administration/installing/oss/cloud/aws/advanced/template-reference/#private-agent) templates create [public](/1.7/overview/concepts/#public) or [private](/1.7/overview/concepts/#private) agent nodes that are then attached to a DC/OS cluster as a part of an AutoScalingGroup. 
