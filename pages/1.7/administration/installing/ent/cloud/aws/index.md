...
For a complete set of DC/OS configuration options, see the [Advanced AWS Install Guide](/docs/1.7/administration/installing/ent/cloud/aws/advanced/).
...
- [Scaling considerations][4]
 ...
 [10]: /docs/1.7/administration/id-and-access-mgt/ent/
