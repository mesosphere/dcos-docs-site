...
![image04](/1.7/usage/service-discovery/marathon-lb/img/image04.png)
...
![image00](/1.7/usage/service-discovery/marathon-lb/img/image00.png)
...
3.  Launch siege, a tool for generating HTTP request traffic. The JSON app definition [can be found here][9]. Save the file, and launch with:
    ...
    ![image02](/1.7/usage/service-discovery/marathon-lb/img/image02-800x508.png)
