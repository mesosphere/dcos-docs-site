...
- [用户帐户](/1.12/security/ent/users-groups/) 将权限分配给

所有 CLI 命令也可通过 [IAM API] 执行(/1.12/security/ent/iam-api/)。您可以在 [CLI 命令参考部分] (/1.12/cli/command-reference/dcos-security/)看到更多有关 `dcos security org users` 命令的详细信息。
