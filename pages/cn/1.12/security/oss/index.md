...
开箱即用 DC/OS 具有 OpenID Connect 1.0 端点，位于 [dcos.auth0.com](https://dcos.auth0.com/.well-known/openid-configuration)（与 [Auth0] 合作(https://auth0.com/)）， 与 Google、GiThub 和 Microsoft 连接，为 DC/OS 安装提供基本身份认证。DC/OS 自动添加登录到 DC/OS 群集的第一个用户。
...
![Auth0 标记](/1.12/img/a0-badge-light.png)
