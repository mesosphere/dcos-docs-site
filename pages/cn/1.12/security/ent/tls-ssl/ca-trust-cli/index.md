...
<p class="message--note"><strong>注意：</strong>如果您已<a href="/1.12/security/ent/tls-ssl/haproxy-adminrouter/">设置代理</a>，则不需要该程序。</p>


默认情况下，DC/OS CLI 不验证 TLS 证书的签名者。我们建议完成以下简短程序，以确保 DC/OS CLI 仅信赖您的 DC/OS CA，并拒绝与其他方的连接。

**先决条件：**[DC/OS CA 根证书](/1.12/security/ent/tls-ssl/get-cert/)的本地副本。
