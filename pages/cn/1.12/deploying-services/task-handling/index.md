...
也可以 [在无法访问任务时配置 Marathon 的行为](/mesosphere/dcos/deploying-services/task-handling/configure-task-handling/)。

![Task Handling Flow](/mesosphere/dcos/img/task-handling-corrected.png)
