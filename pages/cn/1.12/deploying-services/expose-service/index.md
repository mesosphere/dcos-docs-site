...
1. 创建 Marathon 应用定义，并指定所需的 `"acceptedResourceRoles":["slave_public"]` 参数。例如：
 ...
 有关 `acceptedResourceRoles` 参数的更多信息，请参阅 Marathon API [文档](/1.11/deploying-services/marathon-api/)。
...
1. 使用此命令将您的应用程序添加到 Marathon，其中 `myApp.json` 是包含 Marathon 应用定义的文件。
 ...
 如果添加成功，则没有输出。您还可以使用 DC/OS [Web 界面](/1.11/gui/services/) 的 **Services** 选项卡添加您的应用程序 。
