...
2. 将此脚本添加到 bootstrap 节点的 `genconf` 文件夹。[更多信息](/1.12/installing/production/deploying-dcos/installation/#create-a-fault-domain-detection-script)。

1. [安装 DC/OS ](/1.12/installing/production/deploying-dcos/installation/)。
