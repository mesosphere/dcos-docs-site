...
- [已安装 Enterprise DC/OS CLI 0.4.14 或更高版本](/1.11/cli/enterprise-cli/#ent-cli-install)。
- 如果您的 [安全模式](/1.9/security/ent/#security-modes/) 是 `permissive` 或 `strict`，您必须 [获取 root 证书](/1.11/networking/tls-ssl/get-cert/)，才能发出本部分中的 curl 命令。
