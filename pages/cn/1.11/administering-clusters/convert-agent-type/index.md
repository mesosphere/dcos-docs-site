...
您可以将现有 DC/OS 集群的代理节点转换为公共或私有节点。在安装过程中，代理节点被指定为 [公共](/cn/1.11/overview/concepts/#public-agent-node) 或 [私有](/cn/1.11/overview/concepts/#private-agent-node)节点。默认情况下，它们在[安装](/cn/1.11/installing/evaluation/cloud-installation/)期间被指定为私有节点。
