...
在启用 GPU 的 DC/OS 之后，您可以通过 `gpus` 参数在应用定义中指定 GPU。
...
## 先决条件
- AWS DC/OS 高级模板 [系统要求](/1.11/installing/evaluation/cloud-installation/aws/advanced/)。
...
2. 请根据 [此处](/1.11/installing/evaluation/cloud-installation/aws/advanced/) 说明，使用以下 GPU 专用配置创建具有高级 AWS 模板的群集。
