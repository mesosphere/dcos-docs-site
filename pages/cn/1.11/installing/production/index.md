...
- 若要安装 DC/OS Enterprise 版本，请联系销售代表或 <sales@mesosphere.io>。您可以使用 [登录凭据](https://support.mesosphere.com/s/login/) 从 [支持网站](https://support.mesosphere.com/s/downloads) 访问 DC/OS Enterprise 配置文件。[enterprise type="inline" size="small" /]
