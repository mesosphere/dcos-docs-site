...
#### 代理模板
[代理](#private-agent) 模板创建 [公共](/mesosphere/dcos/cn/1.11/overview/concepts/#public-agent-node) 或 [专用](/mesosphere/dcos/cn/1.11/overview/concepts/#private-agent-node) 代理节点，然后作为 AutoScalingGroup 的一部分附加到 DC/OS 群集。
...
<table class="table">
  ...
  <tr>
    ...
    <td>内部负载均衡器的 DNS 名称。必须有效代理才能加入正在运行的集群</td>
  </tr>
  <tr>
    <td>KeyName</td>
    <td>AWS EC2 密钥对，用于 SSH 到实例</td>
