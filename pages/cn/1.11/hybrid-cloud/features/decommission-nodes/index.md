...
如果您的节点以意外方式停工，您只需要 [停用节点](/mesosphere/dcos/cn/1.11/administering-clusters/delete-node/#decommission-the-node/)。

# 关闭节点

1. （您希望关闭的）[SSH 至代理节点](/mesosphere/dcos/cn/1.11/administering-clusters/sshcluster/)。
