...
1. 使用 [自定义高级安装说明] 安装 DC/OS (/cn/1.11/installing/production/deploying-dcos/installation/)。以下是 GPU 专有的配置参数：
...
- NVIDIA GPU 支持仅适用于使用 [DC/OS 通用容器运行时间] 启动的任务(/cn/1.11/deploying-services/containerizers/)。
