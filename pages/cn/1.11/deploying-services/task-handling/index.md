...
Marathon 将任务分为三类：初始、非终端和终端。这些类别中的任务可能处于下图所示的几种状态之一。如需了解任务的状态，可以查看分布式云操作系统日志或查询 [ Marathon  API](http://mesosphere.github.io/marathon/api-console/index.html) 的 [事件流](http://mesosphere.github.io/marathon/docs/event-bus.html) (/v2/events)。
