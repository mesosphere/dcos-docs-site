...
**先决条件：** [DC/OS 和 DC/OS CLI](/mesosphere/dcos/cn/1.11/installing/) 已安装。
...
1. SSH 到您的节点。例如，使用以下命令对管理节点执行 [SSH]：
   ...
   如需更多信息，请参阅 SSH [文档](/mesosphere/dcos/cn/1.11/administering-clusters/sshcluster/)。
...
1. 从管理节点运行此命令以查看节点详情：
 ...
 [1]: /mesosphere/dcos/cn/1.11/overview/concepts/
