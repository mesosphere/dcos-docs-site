...
有关 DC/OS 更全面的架构描述，请参阅 [DC/OS 架构](/1.11/overview/architecture/)。

关于更完整的组件讨论，请参阅 [DC/OS 组件](/1.11/overview/architecture/components/)。
...
![使用 DC/OS 的 Azure 容器服务架构。](/1.11/img/dcos-acs.png)
