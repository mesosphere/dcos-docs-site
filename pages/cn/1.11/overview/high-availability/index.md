...
通过 DC/OS，您可以在机架之间将管理节点分配给 HA。代理可以跨地区分配，建议您用描述其位置的属性来标记代理。ZooKeeper 等同步服务也应留在同一区域内，以减少网络延迟。如需更多信息，请参阅配置高可用性 [文档](/mesosphere/dcos/cn/1.11/installing/production/advanced-configuration/configuring-zones-regions/)。
 ...
 * 使用 HA 负载均衡器，如 [Marathon-LB](/mesosphere/dcos/cn/1.11/networking/marathon-lb/)，或内部 [第 4 层负载均衡器](/mesosphere/dcos/cn/1.11/networking/load-balancing-vips/)。
