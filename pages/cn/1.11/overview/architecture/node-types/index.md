...
公共代理节点是位于网络上的代理节点，允许通过群集的 [基础架构网络] 从群集外部进入(/cn/1.11/overview/concepts/#infrastructure-network)。
...
专用代理节点是位于网络上的代理节点，不允许通过群集的 [基础架构网络] 从群集外部访问(/cn/1.11/overview/concepts/#infrastructure-network)。
...
有关安全的更多信息，请参阅 [保护您的群集](/cn/1.11/administering-clusters/)。

有关扩展群集的更多信息，请参阅 [添加代理节点](/cn/1.11/administering-clusters/add-a-node/)。
