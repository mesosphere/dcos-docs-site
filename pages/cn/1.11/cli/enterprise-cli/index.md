...
- [`dcos backup`](/mesosphere/dcos/cn/1.11/cli/command-reference/dcos-backup/)
- [`dcos license`](/mesosphere/dcos/cn/1.11/cli/command-reference/dcos-license/)
- [`dcos security`](/mesosphere/dcos/cn/1.11/cli/command-reference/dcos-security/)

# <a name="ent-cli-install"></a>安装 DC/OS Enterprise CLI

## 先决条件

DC/OS CLI 必须已经是 [已安装](/mesosphere/dcos/cn/1.11/cli/install/)。
