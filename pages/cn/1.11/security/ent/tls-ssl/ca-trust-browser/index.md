...
1. 双击密钥链中的证书，展开 **信任** 部分，并选择**使用此证书时** **始终信任**。
...
1. 在地址栏中键入您的集群 URL 并按 ENTER 键。地址栏中的 DC/OS Web 界面的路径应标记为 **Secure**。您也可以尝试访问每个管理节点的公共 IP 地址，以确认所有管理节点均显示为 **Secure**。
