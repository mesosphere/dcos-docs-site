...
- 通过高级安装程序安装 DC/OS Enterprise 是根据相应[文档](/1.11/installing/production/deploying-dcos/installation/)编写，直至文档的[**安装 DC/OS**](/1.11/installing/production/deploying-dcos/installation/#install-dcos)部分。
