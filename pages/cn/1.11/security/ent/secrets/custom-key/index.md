...
1. [通过 SSH 进入主节点](/1.11/administering-clusters/sshcluster/)。
...
祝贺您！您已成功重新初始化密钥存储库。要拆封它，请参阅[使用自定义钥匙拆封密封的密钥存储库](/1.11/security/ent/secrets/unseal-store/#unseal-cust-keys)。
