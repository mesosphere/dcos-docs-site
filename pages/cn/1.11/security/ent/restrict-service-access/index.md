...
1. 创建用户和组并定义每个组所需的权限。
 ...
 ![所有用户](/1.11/img/service-group4.png)
...
1. 选择 **Services > Services**，然后单击加号 (**+**) 来部署服务。
 ...
 ![JSON 视图](/1.11/img/service-group15.png)
