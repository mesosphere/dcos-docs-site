...
The V1 and V2 specifications were merged into a single spec; however, there are still separate [v1](/services/edge-lb/1.2/pool-configuration/v1-examples/) and [v2](/services/edge-lb/1.2/pool-configuration/v2-examples/) docs for reference configs, pool examples, etc.
