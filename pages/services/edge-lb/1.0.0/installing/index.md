...
* `service.name`: `"dcos-edgelb/api"`. The service path for the apiserver. `dcos-edgelb` corresponds to `pool.namespace` when [configuring pools](/services/edge-lb/1.0.0/pool-configuration/).
