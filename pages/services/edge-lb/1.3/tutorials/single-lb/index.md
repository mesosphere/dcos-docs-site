...
* Edge-LB is installed following the [Edge-LB Installation](/mesosphere/dcos/services/edge-lb/1.3/installing/) instructions.
...
1. Create a [pool configuration](/mesosphere/dcos/services/edge-lb/1.3/pool-configuration/) name `sample-minimal.json`.
