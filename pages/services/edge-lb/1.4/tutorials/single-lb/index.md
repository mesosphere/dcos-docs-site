...
* Edge-LB is installed following the [Edge-LB Installation](/services/edge-lb/1.4/getting-started/installing/) instructions.
...
1. Create a [pool configuration](/services/edge-lb/1.4/pool-configuration/) name `sample-minimal.json`.
