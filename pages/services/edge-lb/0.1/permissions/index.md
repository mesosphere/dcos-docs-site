...
In order for Edge-LB to operate, it must be configured to use a [service account](/services/edge-lb/latest/installing/#create-a-service-account/) with the following permissions:
