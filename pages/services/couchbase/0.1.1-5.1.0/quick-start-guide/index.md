...
[<img src="/services/couchbase/0.1.1-5.1.0/img/couch_3.png" alt="Couchbase 3rd Node"/>](/services/couchbase/0.1.1-5.1.0/img/couch_3.png)
...
[<img src="/services/couchbase/0.1.1-5.1.0/img/couch_cluster.png" alt="Couchbase cluster"/>](/services/couchbase/0.1.1-5.1.0/img/couch_cluster.png)
...
[<img src="/services/couchbase/0.1.1-5.1.0/img/data_bucket.png" alt="Data Bucket"/>](/services/couchbase/0.1.1-5.1.0/img/data_bucket.png)

Next create a user ‘todo’ with password ‘todo188’.

[<img src="/services/couchbase/0.1.1-5.1.0/img/add_user.png" alt="Add User"/>](/services/couchbase/0.1.1-5.1.0/img/add_user.png)

Followed by giving the ‘todo’ user access to the ‘todo’ bucket.

[<img src="/services/couchbase/0.1.1-5.1.0/img/new_user.png" alt="New User"/>](/services/couchbase/0.1.1-5.1.0/img/new_user.png)
...
[<img src="/services/couchbase/0.1.1-5.1.0/img/edit_conf.png" alt="Edit Configuration"/>](/services/couchbase/0.1.1-5.1.0/img/edit_conf.png)
...
[<img src="/services/couchbase/0.1.1-5.1.0/img/running.png" alt="running"/>](/services/couchbase/0.1.1-5.1.0/img/running.png)
