...
At least one volume must be available for Grafana to use. For more on creating volumes, see the [DSS documentation](https://docs.mesosphere.com/services/beta-storage/0.5.3-beta/cli-references/dcos-storage-volume/dcos-storage-volume-create).
...
![Grafana DSS GUI example](/services/beta-dcos-monitoring/0.4.3-beta/img/grafana-dss-gui.png)
