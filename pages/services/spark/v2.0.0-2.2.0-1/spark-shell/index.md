...
1. [Launch a long-running interactive bash session using `dcos task exec`](/docs/1.9/monitoring/debugging/task/exec/#launch-a-long-running-interactive-bash-session).
