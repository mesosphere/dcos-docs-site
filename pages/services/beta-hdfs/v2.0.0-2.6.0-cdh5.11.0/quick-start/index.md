...
-  Depending on your [security mode](/docs/1.10/security/ent/#security-modes/), HDFS requires a service authentication for access to DC/OS. For more information, see [Configuring DC/OS Access for HDFS](/service-docs/hdfs/hdfs-auth/).
