...
-  Depending on your [security mode](/1.9/security/ent/#security-modes/), HDFS requires a service authentication for access to DC/OS. For more information, see [Configuring DC/OS Access for HDFS](/services/hdfs/hdfs-auth/).
