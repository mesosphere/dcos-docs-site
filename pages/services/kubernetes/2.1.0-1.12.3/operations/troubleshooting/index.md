...
See the [Resources section](/services/kubernetes/2.1.0-1.12.3/getting-started/install-basic/#resources) of the [Installing](/services/kubernetes/2.1.0-1.12.3/getting-started/install-basic/) page for more detail on setting up your cluster.

## Scheduler is restarting

If the scheduler task is starting for your Kubernetes cluster but is in a "Failed" restart loop, verify all of the installation [prerequisites](/services/kubernetes/2.1.0-1.12.3/getting-started/install-basic/#prerequisites) have been met.
...
Before re-installing DC/OS Kubernetes, make sure that all DC/OS agents are healthy, and that the DC/OS cluster itself is healthy and that there are no networking problems, and meets all the [prerequisites](/services/kubernetes/2.1.0-1.12.3/getting-started/install-basic/#prerequisites).
