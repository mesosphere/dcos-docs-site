...
In this case use the `dcos kubernetes cluster debug pod` [CLI](/services/kubernetes/2.1.0-1.12.3/cli#debug-pod-1) to assist in debugging and recovering failed, flapping or otherwise misbehaving tasks.
