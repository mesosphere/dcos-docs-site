...
![Screenshot of AWS EBS from above "in-use".](/services/kubernetes/2.3.0-1.14.1/img/ebs-in-use.png)
...
![Screenshot of AWS EBS from above still "available".](/services/kubernetes/2.3.0-1.14.1/img/ebs-available.png)
...
![Screenshot of AWS EBS volume absent from where it had been.](/services/kubernetes/2.3.0-1.14.1/img/ebs-missing.png)
...
![Screenshot of AWS EBS volume "available" for newly created volume.](/services/kubernetes/2.3.0-1.14.1/img/ebs-pre-provisioned-created.png)
...
![Screenshot of AWS EBS from above "in-use".](/services/kubernetes/2.3.0-1.14.1/img/ebs-pre-provisioned-in-use.png)
...
![Screenshot of AWS EBS volume "available" with Retain reclaim policy.](/services/kubernetes/2.3.0-1.14.1/img/ebs-pre-provisioned-available-retain.png)
