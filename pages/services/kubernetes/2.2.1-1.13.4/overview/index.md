...
title: Overview
menuWeight: 20
excerpt: What's new in DC/OS Kubernetes 2.2.1-1.13.4
---

<!-- This source repo for this topic is https://github.com/mesosphere/dcos-kubernetes-cluster -->

When compared with previous versions, DC/OS Kubernetes 2.2.1-1.13.4 brings in a number of important improvements to how Kubernetes clusters are managed, as well as to how they operate.
...
$ dcos kubernetes cluster list
  ...
  dev/kubernetes01  v1.13.4             stub-universe
  dev/kubernetes02  v1.13.4             stub-universe
```
...
See the [CLI](/mesosphere/dcos/services/kubernetes/2.2.1-1.13.4/cli/) section for documentation on the new CLI.
