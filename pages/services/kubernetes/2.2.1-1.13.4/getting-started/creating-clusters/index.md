...
Nice work! You now have multiple Kubernetes clusters running throughout your DC/OS Enterprise cluster. With the internal workings of the cluster all set, you can move on to [Configuring Edge-LB](/services/kubernetes/2.2.1-1.13.4/getting-started/config-edgelb-for-k8s/) to set up a load balancer for your cluster.
