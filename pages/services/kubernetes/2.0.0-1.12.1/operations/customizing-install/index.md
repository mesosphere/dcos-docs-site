...
This section continues on from the instructions given in the [Basic Installation](/services/kubernetes/2.0.0-1.12.1/getting-started/install-basic/) section.
...
See the [Cluster Sizing](/services/kubernetes/2.0.0-1.12.1/getting-started/cluster-sizing/) page for a more detailed explanation.
