...
When compared with previous versions, DC/OS Kubernetes 2.0.0-1.12.1 brings in a number of important improvements to how Kubernetes clusters are managed, as well as to how they operate.
...
$ dcos kubernetes cluster list
  ...
  dev/kubernetes01  v1.12.1             stub-universe
  dev/kubernetes02  v1.12.1             stub-universe
```
