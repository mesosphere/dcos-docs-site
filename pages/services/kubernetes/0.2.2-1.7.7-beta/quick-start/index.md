...
If you are using Enterprise DC/OS, you can follow the same steps detailed for Open-Source DC/OS. However, it's recommended to read the [Install and Customize](/services/kubernetes/0.2.1-1.7.7-beta/install/) section for more information.
