...
Nice work! You now have multiple Kubernetes clusters running throughout your DC/OS Enterprise cluster. With the internal workings of the cluster all set, you can move on to [Configuring Edge-LB](/services/kubernetes/2.3.3-1.14.3/getting-started/config-edgelb-for-k8s/) to set up a load balancer for your cluster.
