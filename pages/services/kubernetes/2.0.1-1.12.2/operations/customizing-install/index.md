...
This section continues on from the instructions given in the [Basic Installation](/services/kubernetes/2.0.1-1.12.2/getting-started/install-basic/) section.
...
See the [Cluster Sizing](/services/kubernetes/2.0.1-1.12.2/getting-started/cluster-sizing/) page for a more detailed explanation.
...
![alt text](/services/kubernetes/2.0.1-1.12.2/img/tls.png "TLS design")
