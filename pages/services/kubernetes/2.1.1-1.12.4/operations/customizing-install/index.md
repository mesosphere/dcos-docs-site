...
This section continues on from the instructions given in the [Basic Installation](/services/kubernetes/2.1.1-1.12.4/getting-started/provision-install/) section.
...
See the [Cluster Sizing](/services/kubernetes/2.1.1-1.12.4/operations/cluster-sizing/) page for a more detailed explanation.
...
It is possible that the region may not have the resources required, make sure to read and understand [Cluster Sizing](/services/kubernetes/2.1.1-1.12.4/operations/cluster-sizing/) before attempting a deployment.
...
**NOTE:** Multi-Region deployment is not supported, see [Limitations](/services/kubernetes/2.1.1-1.12.4/limitations/index).
...
![alt text](/services/kubernetes/2.1.1-1.12.4/img/tls.png "TLS design")
