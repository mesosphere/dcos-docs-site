...
menuWeight: 20
excerpt: What makes Mesosphere Kubernetes Engine the best way to do Kubernetes?
---
...
$ dcos kubernetes cluster list
  ...
  dev/kubernetes01  v1.13.3             stub-universe
  dev/kubernetes02  v1.13.3             stub-universe
```
...
See the [CLI](/services/kubernetes/2.2.0-1.13.3/cli/) section for documentation on the new CLI.
