...
If you are using Enterprise DC/OS, follow the same steps as for Open-Source DC/OS. However, you should read the [Install and Customize](/services/kubernetes/0.5.0-1.9.1-beta/install/) section for more information.
