...
Now you have configured Edge-LB to connect to your Kubernetes clusters. In the last section, you will [test connections and view the Kubernetes Dashboard](/services/kubernetes/2.2.2-1.13.5/getting-started/test-connect/) via a web proxy on your browser.
