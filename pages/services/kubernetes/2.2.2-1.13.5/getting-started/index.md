...
In the [first part of the tutorial](/mesosphere/dcos/services/kubernetes/2.2.2-1.13.5/getting-started/setting-up/), you will set up your cluster for a successful installation of DC/OS Kubernetes.
