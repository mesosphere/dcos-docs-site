...
In the [first part of the tutorial](/services/kubernetes/2.3.1-1.14.2/getting-started/setting-up/), you will set up your cluster for a successful installation of DC/OS Kubernetes.
