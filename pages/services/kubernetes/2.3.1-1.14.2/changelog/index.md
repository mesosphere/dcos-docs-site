...
* Fix a few items in the [limitations section](/services/kubernetes/2.3.1-1.14.2/limitations/).
...
* Fix the [`etcd` snapshotting](/services/kubernetes/2.3.1-1.14.2/operations/troubleshooting/) instructions.
...
* Add a [Storage](/services/kubernetes/2.3.1-1.14.2/operations/storage/) page documenting Container Storage Interface (CSI).
...
* Documentation section on how to [upgrade](/services/kubernetes/2.3.1-1.14.2/operations/upgrade/#Mesosphere-Kubernetes-Engine) the `kubernetes` package.
...
* Add an [Overview](/services/kubernetes/2.3.1-1.14.2/overview/) page explaining in detail what changed since the 1.x series of releases.
* Add a [CLI](/services/kubernetes/2.3.1-1.14.2/cli/) page detailing the new Mesosphere Kubernetes Engine CLI.
* Merge `Advanced Installation` page merging its content into [Customizing your Installation](/services/kubernetes/2.3.1-1.14.2/operations/customizing-install/).
* Add a [Private Docker Registry](/services/kubernetes/2.3.1-1.14.2/operations/private-docker-registry/) page explaining how to configure it.
