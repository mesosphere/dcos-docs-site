...
**Note:** This requires at least 3 DC/OS agents, each with at least 2 CPUs, 2GB of RAM, and 512MB of disk not
...
The default worker node count is 1. To change this value, specify `kubernetes.node_count` in a JSON options file, as shown below.
...
![alt text](/services/kubernetes/1.2.0-1.10.5/img/tls.png "TLS design")
