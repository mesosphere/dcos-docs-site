...
Some changes, such as decreasing the number of nodes or changing volume requirements, are not supported after initial deployment. See [Limitations](/services/beta-kafka-zookeeper/2.1.2-3.4.11/limitations).
...
Placement constraints can be updated after initial deployment using the following procedure. See [Node Settings](/services/beta-kafka-zookeeper/2.1.2-3.4.11/service-settings/) above for more information on placement constraints.
