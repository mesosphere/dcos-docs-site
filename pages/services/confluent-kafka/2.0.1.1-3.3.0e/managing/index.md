...
Some changes, such as decreasing the number of nodes or changing volume requirements, are not supported after initial deployment. See [Limitations](/services/confluent-kafka/2.0.1.1-3.3.0e/limitations/).
...
To see a full listing of available options, run `dcos package describe --config confluent-kafka` in the CLI, or browse the Beta Confluent Kafka install dialog in the DC/OS web interface.
