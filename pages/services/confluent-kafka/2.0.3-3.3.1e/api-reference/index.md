  ...
  "pod-specs": [
    {
      ...
      "rlimits": [],
      "uris": [
        "https://packages.confluent.io/archive/3.3/confluent-3.3.1-2.11.tar.gz",
      ...
      "task-specs": [
        {
          ...
          "command-spec": {
            "value": "export JAVA_HOME=$(ls -d $MESOS_SANDBOX/jre*/) && mv -v *statsd*.jar $MESOS_SANDBOX/confluent-3.3.1/share/java/kafka/ && ./bootstrap -resolve=false && exec $MESOS_SANDBOX/confluent-3.3.1/bin/kafka-server-start $MESOS_SANDBOX/confluent-3.3.1/etc/kafka/server.properties\n",
            "environment": {
          ...
          "config-files": [
            {
              ...
              "relative-path": "confluent-3.3.1/etc/kafka/server.properties",
