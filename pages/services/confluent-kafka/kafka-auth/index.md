...
This topic describes how to configure DC/OS access for Confluent Kafka. Depending on your [security mode](/mesosphere/dcos/1.12/security/ent/#security-modes/), Confluent Kafka requires [service authentication](/mesosphere/dcos/1.12/security/ent/service-auth/) for access to DC/OS.
...
**Tip:** You can use the [DC/OS Secret Store](/mesosphere/dcos/1.12/security/ent/secrets/) to secure the key pair.
