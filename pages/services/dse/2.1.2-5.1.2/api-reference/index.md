...
If you are using open source DC/OS, follow these instructions to [pass your HTTP API token to the DC/OS endpoint](/latest/security/ent/iam-api/).
...
If you are using Enterprise DC/OS, the security mode of your installation may also require the `--ca-cert` flag when making REST calls. Refer to [Obtaining and passing the DC/OS certificate in cURL requests](/latest/security/ent/tls-ssl/) for information on how to use the `--cacert` flag. [If your security mode is `disabled`](/latest/security/ent/tls-ssl/), do not use the `--ca-cert` flag.
