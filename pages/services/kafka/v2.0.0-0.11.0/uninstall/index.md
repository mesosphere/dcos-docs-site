...
1. Stop the service. From the DC/OS CLI, enter `dcos package uninstall --app-id=<instance-name> <package-name>`.

For example, for a service `kafka-2`, you would run:
...
So for the service `kafka-2`, you would run:
