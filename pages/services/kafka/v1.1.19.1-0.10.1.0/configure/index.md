...
The following describes the most commonly used features of the Kafka service and how to configure them via the DC/OS CLI and from the DC/OS GUI. View the [default `config.json` in DC/OS Universe][11] to see all possible configuration options.
...
*   **DC/OS GUI**: The service name cannot be changed after the cluster has started.
...
*   **DC/OS GUI**: `BROKER_COUNT`: `integer`
...
*   **DC/OS GUI**: `PLACEMENT_STRATEGY`: `ANY` or `NODE`
...
* **DC/OS GUI**: Set the environment variable `DISK_TYPE`: `MOUNT`
...
* **DC/OS GUI**: Set the environment variable `BROKER_HEAP_MB`: `2000`
...
* **DC/OS GUI**: Set the environment variable `ENABLE_REPLACEMENT`: `true` to enable replacement.
...
* **DC/OS GUI**: Set the environment variable `RECOVERY_GRACE_PERIOD_SEC`: `1200`
...
* **DC/OS GUI**: Set the environment variable `REPLACE_DELAY_SEC`: `600`
...
* **DC/OS GUI**: Set the environment variable `ENABLE_BROKER_HEALTH_CHECK`: `true`
...
* **DC/OS GUI**: Set the environment variable `BROKER_HEALTH_CHECK_DELAY_SEC`: `15`
...
* **DC/OS GUI**: Set the environment variable `BROKER_HEALTH_CHECK_INTERVAL_SEC`: `10`
...
* **DC/OS GUI**: Set the environment variable `BROKER_HEALTH_CHECK_TIMEOUT_SEC`: `20`
...
* **DC/OS GUI**: Set the environment variable `BROKER_HEALTH_CHECK_GRACE_SEC`: `10`
...
* **DC/OS GUI**: Set the environment variable `BROKER_HEALTH_CHECK_MAX_FAILURES`: `3`

 [8]: #broker-count
 [11]: https://github.com/mesosphere/universe/tree/version-3.x/repo/packages/K/kafka
