---
layout: layout.pug
navigationTitle: {{ model.techName }} Service 2.6.0-6.3.2
title: {{ model.techName }} Service 2.6.0-6.3.2
excerpt: {{ model.techName }} lets you manage an Elasticsearch cluster
menuWeight: 1
...
{{ model.techName }} provides the following features:
