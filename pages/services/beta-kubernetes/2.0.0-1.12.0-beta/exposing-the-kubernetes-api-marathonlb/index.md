...
[public agent](/1.12/overview/architecture/node-types/#public-agent-nodes)
...
```
# dcos task exec kube-control-plane-0-instance cat ca-crt.pem > dcos-kubernetes-ca.pem
```
