...
-  [DC/OS and DC/OS CLI installed](/1.10/installing/) with a minimum of five private agent nodes, each with at least two CPU shares and eight GB of RAM available to the HDFS service.
-  Depending on your [security mode](/1.10/security/ent/#security-modes), HDFS requires a service authentication token for access to DC/OS. For more information, see [Configuring DC/OS Access for HDFS](/service-docs/hdfs/hdfs-auth/).
...
1.  [SSH](/1.10/administering-clusters/sshcluster/) to the leading master node.
