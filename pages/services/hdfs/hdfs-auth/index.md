...
This topic describes how to configure DC/OS access for HDFS. Depending on your [security mode](/1.9/overview/security/security-modes/), HDFS requires [service authentication](/1.9/security/ent/service-auth/) for access to DC/OS.
