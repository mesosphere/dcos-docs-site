...
Sample JSON options file named `sample-{{ model.serviceName }}.json`:
...
For more information on service configuration see [the documentation on configuring a service from the catalog](/latest/deploying-services/config-universe-service/).
