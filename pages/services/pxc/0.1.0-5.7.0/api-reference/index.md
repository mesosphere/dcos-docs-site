...
<!-- {% raw %} disable mustache templating in this file: retain pxc examples as-is -->
...
<!-- TODO: using node-0 here, but ensure that the node name matches a Apache pxc service node type -->
