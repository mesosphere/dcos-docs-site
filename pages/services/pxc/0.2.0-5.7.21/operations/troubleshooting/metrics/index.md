...
excerpt: How to see Metrics with Prometheus and Garafana with DC/OS
title: Metrics
menuWeight: 38
...
* A cluster running DC/OS 1.11 

## Install

[Prometheus](/services/prometheus/) can be installed via either the DC/OS Catalog web interface or by using the CLI. The following command will launch the install via the DC/OS CLI:
