...
This topic describes how to configure DC/OS access for Elastic. Depending on your [security mode](/1.9/overview/security/security-modes/), Elastic requires [service authentication](/1.10/security/ent/service-auth/) for access to DC/OS.
