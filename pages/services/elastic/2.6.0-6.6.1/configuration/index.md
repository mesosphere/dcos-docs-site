...
Otherwise, due to a currently known [limitation](/services/elastic/2.6.0-6.6.1/limitations#kibana-configured-with-x-pack-security-enabled) you won't be able to access it through the default DC/OS UI Service link.

In this case you'll have to [expose Kibana using EdgeLB](/services/elastic/2.6.0-6.6.1/how-to-guides#expose-kibana-using-edgelb).
