...
8. Launch another Marathon app requesting a 100M persistent volume with profile `fast`.
...
11. Assume that the volume `my-volume-1` is no longer needed.
...
15. The storage service can be uninstalled at any time.
