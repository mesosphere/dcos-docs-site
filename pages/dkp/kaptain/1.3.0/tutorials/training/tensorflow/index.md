...
```
FROM mesosphere/kubeflow:1.3.0-tensorflow-2.5.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:1.3.0-mnist-tensorflow-2.5.0-gpu` in case you want to skip it for now.


```python
%env IMAGE mesosphere/kubeflow:1.3.0-mnist-tensorflow-2.5.0-gpu
```
