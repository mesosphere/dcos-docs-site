...
```
FROM mesosphere/kubeflow:1.3.0-pytorch-1.7.1-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:1.3.0-mnist-pytorch-1.7.1-gpu` in case you want to skip it for now.


```python
%env IMAGE mesosphere/kubeflow:1.3.0-mnist-pytorch-1.7.1-gpu
```
