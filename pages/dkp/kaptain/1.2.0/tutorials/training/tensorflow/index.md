...
You will do that using Kubeflow Fairing, so that you do not have to leave your favorite notebook environment at all!
...
To build and push Docker images from within a notebook, check out the [Kubeflow Fairing notebook](../../fairing).
