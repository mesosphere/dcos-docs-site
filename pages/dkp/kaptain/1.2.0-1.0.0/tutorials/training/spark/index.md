...
```
FROM mesosphere/kubeflow:1.2.0-1.0.0-spark-3.0.0-horovod-0.21.0-tensorflow-2.4.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:mnist-spark-1.2.0-1.0.0` in case you want to skip it for now.
...
IMAGE = "mesosphere/kubeflow:mnist-spark-1.2.0-1.0.0"
```
