...
EPOCHS = 5
GPUS = 1
PYTORCH_IMAGE = "mesosphere/kubeflow:mnist-pytorch-1.2.0-1.0.0"  # modify this parameter if you like to use a custom image
```
...
```
FROM mesosphere/kubeflow:1.2.0-1.0.0-pytorch-1.7.1-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:mnist-pytorch-1.2.0-1.0.0` in case you want to skip it for now.
