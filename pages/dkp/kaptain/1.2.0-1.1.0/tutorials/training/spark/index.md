...
You can do that with Kubeflow Fairing, so that you do not have to leave your favourite notebook environment at all!
...
```
FROM mesosphere/kubeflow:1.2.0-1.1.0-spark-3.0.0-horovod-0.21.0-tensorflow-2.4.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:1.2.0-1.1.0-mnist-spark-3.0.0-horovod-0.21.0-tensorflow-2.4.0` in case you want to skip it for now.
...
spec:
  ...
  mode: cluster
  pythonVersion: "3"
  image: mesosphere/kubeflow:1.2.0-1.1.0-mnist-spark-3.0.0-horovod-0.21.0-tensorflow-2.4.0
