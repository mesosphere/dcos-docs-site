...
```
FROM mesosphere/kubeflow:1.2.0-1.1.0-tensorflow-2.4.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:1.2.0-1.1.0-mnist-tensorflow-2.4.0` in case you want to skip it for now.
        ...
        spec:
          containers:
            - name: tensorflow
              ...
              image: mesosphere/kubeflow:1.2.0-1.1.0-mnist-tensorflow-2.4.0
              args:
                - --epochs
                - "${EPOCHS}"
                - --steps
