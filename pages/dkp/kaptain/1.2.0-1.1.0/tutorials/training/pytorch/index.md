...
```
FROM mesosphere/kubeflow:1.2.0-1.1.0-pytorch-1.7.1-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:1.2.0-1.1.0-mnist-pytorch-1.7.1` in case you want to skip it for now.
    ...
    Master:
      ...
      template:
        ...
        spec:
          containers:
            - name: pytorch
              image: mesosphere/kubeflow:1.2.0-1.1.0-mnist-pytorch-1.7.1
              args:
                - --epochs
                - "${EPOCHS}"
                - --seed
