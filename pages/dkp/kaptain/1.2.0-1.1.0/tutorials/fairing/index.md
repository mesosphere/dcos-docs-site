...
```python
BASE_IMAGE = "mesosphere/kubeflow:1.2.0-1.1.0-tensorflow-2.4.0" + ("-gpu" if USE_GPU else "")
```


```python
BASE_IMAGE = "mesosphere/kubeflow:1.2.0-1.1.0-pytorch-1.7.1" + ("-gpu" if USE_GPU else "")
```
