...
```
FROM mesosphere/kubeflow:1.0.1-0.6.0-spark-3.0.0-horovod-0.19.5-tensorflow-2.2.0-gpu
ADD mnist.py /
...
The image is available as `mesosphere/kubeflow:mnist-spark-1.0.1-0.6.0` in case you want to skip it for now.
...
spec:
  ...
  mode: cluster
  pythonVersion: "3"
  image: mesosphere/kubeflow:mnist-spark-1.0.1-0.6.0
