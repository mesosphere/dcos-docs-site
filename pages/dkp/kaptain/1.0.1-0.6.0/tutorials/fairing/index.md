...
```python
BASE_IMAGE = "mesosphere/kubeflow:1.0.1-0.6.0-tensorflow-2.2.0" + ("-gpu" if USE_GPU else "")
```


```python
BASE_IMAGE = "mesosphere/kubeflow:1.0.1-0.6.0-pytorch-1.5.0" + ("-gpu" if USE_GPU else "")
```
