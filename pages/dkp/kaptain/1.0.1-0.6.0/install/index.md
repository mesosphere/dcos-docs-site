...
<p class="message--important"><strong>IMPORTANT: </strong>This release of Kaptain does not include support for lifecycle management (upgrading). This capability will be included in a future release of Kaptain. Until this capability is available, you must uninstall and reinstall to move to new releases of Kaptain.</p>
