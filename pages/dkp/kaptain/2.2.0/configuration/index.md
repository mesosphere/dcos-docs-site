...
<p class="message--note"><strong>NOTE:</strong> For the properties that require user credentials, ensure that the admin or a person with sufficient administrative rights has modified the initial or default user passwords.</p>
