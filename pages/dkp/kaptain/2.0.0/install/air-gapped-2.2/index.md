...
The folloing catalog will need to be added to the Komamnder install configuration file alonig with the DKP applications catalog:
...
1.  Load the Kaptain chart archive after the Kommander installation with:
