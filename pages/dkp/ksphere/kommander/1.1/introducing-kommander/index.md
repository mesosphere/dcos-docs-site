...
| [**Centralized Monitoring, Logging and Alerting**](/dkp/kommander/1.1/centralized-monitoring) | Enables central monitoring and alerting of issues arising in operational and application infrastructure and deep cross-cluster logging for easier troubleshooting. As issues are detected, they are resolved before they escalate, saving valuable time. |
| [**Cluster Configuration Manager**](/dkp/kommander/1.1/clusters)                              | Simplifies and delivers consistent configuration for services and cross cluster operations.                                                                                                                                                              |
| [**Services Catalog**](/dkp/kommander/1.1/projects/platform-services)                         | Push button catalog of current cloud native services. This helps organizations quickly deploy services to multiple clusters. Governance-based access to data services ensures roles and responsibilities are maintained.                                 |
...
| [**Centralized Cost Monitoring**](/dkp/kommander/1.1/centralized-cost-monitoring)             | Provides central cost monitoring on all clusters, giving visibility and insight into Kubernetes spend across key resources in all managed clusters.                                                                                                      |
