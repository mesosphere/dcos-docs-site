...
![Create Project](/dkp/kommander/1.1/img/create-project-form.png)

The following procedures are supported for projects:

- [Deploy Platform Services](/dkp/kommander/1.1/projects/platform-services)
- [Manage Project Roles](/dkp/kommander/1.1/projects/project-roles)
- [Manage Project Policies](/dkp/kommander/1.1/projects/project-policies)
- [Manage Project ConfigMaps](/dkp/kommander/1.1/projects/project-configmaps)
- [Manage Project Secrets](/dkp/kommander/1.1/projects/project-secrets)
- [Manage Project Quotas](/dkp/kommander/1.1/projects/project-quotas)
