...
Lastly, follow the example in the [Access Control documentation](https://docs.d2iq.com/dkp/kommander/1.1/operations/access-control/#special-limitation-for-opsportal-and-kommander-roles) to grant users access to the Opsportal and Kommander routes on your cluster.
