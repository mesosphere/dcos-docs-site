...
- An [Identity Provider](https://docs.d2iq.com/dkp/kommander/1.2/tutorials/authorize-all-users/) has been created.
...
- 4 configured [groups](https://docs.d2iq.com/dkp/kommander/1.2/operations/identity-providers/) in Kommander
...
Kommander has [three levels of access control](https://docs.d2iq.com/dkp/kommander/1.2/operations/access-control/) to support global, workspace, and project use cases. Kommander creates default roles at all three levels to simplify the process of assigning users to different levels of access to resources.
