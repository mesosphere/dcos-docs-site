...
- [Creating Konvoy Clusters on AWS](/dkp/kommander/1.0/clusters/creating-konvoy-cluster-aws/)
- [Creating Konvoy Clusters on Azure](/dkp/kommander/1.0/clusters/creating-konvoy-cluster-azure/)
- [Creating Konvoy Clusters on your own infrastructure](/dkp/kommander/1.0/clusters/creating-konvoy-cluster-on-prem/)
...
See [Attach Cluster](/dkp/kommander/1.0/clusters/attach-cluster/)
...
![Create Cluster Upload YAML](/dkp/kommander/1.0/img/create-cluster-yaml.png)
...
![Update Kubernetes Version Action](/dkp/kommander/1.0/img/upgrade-kubernetes-action.png)

![Update Kubernetes Version Action](/dkp/kommander/1.0/img/upgrade-kubernetes-confirmation.png)

## Editing Clusters

![Edit a Cluster Action](/dkp/kommander/1.0/img/edit-cluster-action.png)

### Editing an Attached cluster

For an Attached cluster you can only edit labels that are assigned to it.

![Edit an Attached Cluster](/dkp/kommander/1.0/img/edit-cluster-attached.png)

### Editing a Managed cluster

For a Managed cluster you can edit its name, labels, cloud provider tags and its node pools.

![Edit a Cluster Form](/dkp/kommander/1.0/img/edit-cluster-form-name.png)
...
![Edit a Cluster Node Pools](/dkp/kommander/1.0/img/edit-cluster-node-pools.png)

#### Editing labels and cloud provider tags

![Edit a Cluster Labels and Cloud Provider Tags](/dkp/kommander/1.0/img/edit-cluster-labels-tags.png)
...
![Cluster card with resources](/dkp/kommander/1.0/img/cluster-card.png)
...
![Cluster Detail Page](/dkp/kommander/1.0/img/cluster-detail-page.png)
