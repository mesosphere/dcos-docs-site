...
1. Go to **Administration > Infrastructure Providers** and select the **Add Infrastructure Provider** button.
   ...
   ![Adding an Infrastructure Provider](/dkp/kommander/1.0/img/empty-infrastructure-providers.png)

   ![Add Infrastructure Provider Form](/dkp/kommander/1.0/img/add-infrastructure-provider.png)

   - Select the **Amazon Web Services (AWS)** option from the **Add Infrastructure Provider** dialog box.

   ![AWS Role Infrastructure Provider Form](/dkp/kommander/1.0/img/infrastructure-provider-form-aws-role.png)
