...
![Creating an E-Commerce project](/ksphere/kommander/1.0/img/tutorial-ecommerce-project.png)
...
![Creating a role](/ksphere/kommander/1.0/img/tutorial-ecommerce-role.png)
...
![Creating a policy](/ksphere/kommander/1.0/img/tutorial-ecommerce-policy.png)
...
![Created ConfigMaps](/ksphere/kommander/1.0/img/tutorial-ecommerce-config-maps.png)

The backend also needs access to our AWS S3 Bucket and to GitHub, so we create two secrets for this:

![Created Secrets](/ksphere/kommander/1.0/img/tutorial-ecommerce-secrets.png)
...
![Create Cloud Provider](/ksphere/kommander/1.0/img/tutorial-ecommerce-create-cloud-provider.png)

Once we did this we can go to the clusters view, click the Add Cluster button and select Create Konvoy Cluster.

![Create Cluster](/ksphere/kommander/1.0/img/tutorial-ecommerce-create-cluster.png)
...
![Created Secrets](/ksphere/kommander/1.0/img/tutorial-ecommerce-target-secret.png)
![Created Config Map](/ksphere/kommander/1.0/img/tutorial-ecommerce-target-configmap.png)
![Created Role](/ksphere/kommander/1.0/img/tutorial-ecommerce-target-role.png)
