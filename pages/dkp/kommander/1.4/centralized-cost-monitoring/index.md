...
<p class="message--important"><strong>IMPORTANT: </strong>Make sure you access the cluster's Kubecost UI linked above, not the centralized Kubecost UI running on the Kommander host cluster.</p>
