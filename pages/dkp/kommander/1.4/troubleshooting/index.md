...
## I cannot access Kommander UI from Konvoy UI
...
![Links to Kommander from Konvoy UI](/dkp/kommander/1.4/img/kommander-links.png)
...
## I cannot see the workspace dropdown in the header or other global navigation links
...
![Konvoy UI](/dkp/kommander/1.4/img/konvoy-ui.png)
Konvoy UI

![Kommander UI](/dkp/kommander/1.4/img/kommander-ui.png)
Kommander UI

## I cannot see the global dashboard in Kommander
...
## I cannot see specific pages, buttons, or actions
...
[rbac-docs]: /dkp/konvoy/1.8/access-authentication/rbac/#portal-authorization
