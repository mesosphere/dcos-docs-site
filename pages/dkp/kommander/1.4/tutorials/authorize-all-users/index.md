...
<p class="message--warning"><strong>Important: </strong>
Use your Konvoy URL followed by <code>/dex/callback</code> as the Authorization callback URL.
</p>

![Setting up the GitHub OAuth App](/dkp/kommander/1.4/img/tutorial-idp-github-oauth-app.png)

Once we create this application we are going to see something like this:

![Created a GitHub OAuth App](/dkp/kommander/1.4/img/tutorial-idp-github-oauth-created.png)
...
![Adding the GitHub OAuth App](/dkp/kommander/1.4/img/tutorial-idp-github-added.png)
...
![Adding a developer group](/dkp/kommander/1.4/img/tutorial-auth-developer-group.png)
...
![Adding a read role](/dkp/kommander/1.4/img/tutorial-auth-developer-role.png)
...
![Adding a policy](/dkp/kommander/1.4/img/tutorial-auth-developer-policy.png)

Lastly, follow the example in the [Access Control documentation](/dkp/kommander/1.4/operations/access-control/#special-limitation-for-opsportal-and-kommander-roles) to grant users access to the opsportal and Kommander routes on your cluster.
