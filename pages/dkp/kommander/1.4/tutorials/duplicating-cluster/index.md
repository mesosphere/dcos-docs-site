...
![Creating an E-Commerce project](/dkp/kommander/1.4/img/tutorial-ecommerce-project.png)
...
You have defined the developer access control group beforehand from the [Identity Providers page](/dkp/kommander/1.4/operations/identity-providers/#groups) at the global level.
...
![Creating a policy](/dkp/kommander/1.4/img/tutorial-ecommerce-policy.png)
...
![Created ConfigMaps](/dkp/kommander/1.4/img/tutorial-ecommerce-configmaps.png)

The backend also needs access to your AWS S3 Bucket and to GitHub, so create two secrets for this:

![Created Secrets](/dkp/kommander/1.4/img/tutorial-ecommerce-secrets.png)
...
![Create Infrastructure Provider](/dkp/kommander/1.4/img/tutorial-ecommerce-infraprovider.png)

Then go to the workspace clusters view, select **Add Cluster** > **Create Konvoy Cluster**.

![Create Cluster](/dkp/kommander/1.4/img/tutorial-ecommerce-cluster.png)
...
![Project Clusters](/dkp/kommander/1.4/img/tutorial-ecommerce-projectclusters.png)
