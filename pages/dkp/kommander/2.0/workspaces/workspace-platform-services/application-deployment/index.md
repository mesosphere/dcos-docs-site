...
To use the Kommander UI to deploy applications, see [Customize a workspace's platform applications](../../workspace-platform-services#customize-a-workspaces-applications).
