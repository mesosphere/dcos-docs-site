...
![Project Catalog](../../img/project-catalog.png)
...
![Deploy Helm Platform Service](../../img/project-catalog-deploy-helm.png)

For KUDO-based platform services, fill out the form fields supported by that platform service's parameters schema:

![Deploy KUDO Platform Service](../../img/project-catalog-deploy-kudo.png)
...
![Project platform service edit form](../../img/project-catalog-addon-edit.png)
