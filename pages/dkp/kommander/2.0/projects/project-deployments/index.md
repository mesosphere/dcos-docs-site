...
![Continuous Deployment (CD)](../../img/project-cd-welcome-screen.png)
...
![Create GitOps Source](../../img/project-cd-gitops-source-create.png)
...
![Suspend GitOps Source Sync](../../img/project-cd-gitops-source-sync-suspend.png)
...
![Resume GitOps Source Sync](../../img/project-cd-gitops-source-sync-resume.png)
