...
<p class="message--note"><strong>NOTE: </strong>to allow users to access the Kommander UI, ensure they have the appropriate `dkp-kommander-` role in addition to the Kommander roles granted in the Kommander UI. For more information, see the [Access Control section of the Kommander documentation](/dkp/kommander/2.1/operations/access-control/).</p>
