...
![Created a GitHub OAuth App](/dkp/kommander/2.0/img/tutorial-idp-github-oauth-created.png)
...
![Adding the GitHub OAuth App](/dkp/kommander/2.0/img/tutorial-idp-github-added.png)
...
![Adding a developer group](/dkp/kommander/2.0/img/tutorial-auth-developer-group.png)
...
![Adding a read role](/dkp/kommander/2.0/img/tutorial-auth-developer-role.png)
...
![Adding a policy](/dkp/kommander/2.0/img/tutorial-auth-developer-policy.png)

Lastly, follow the example in the [Access Control documentation](/dkp/kommander/2.0/operations/access-control/#special-limitation-for-kommander-roles) to grant users access to Kommander routes on your cluster.
