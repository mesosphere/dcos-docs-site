...
Depending on your infrastructure, Konvoy can generate a set of cluster objects that can be customized for unusual use cases. Visit the [documentation for AWS](https://docs.d2iq.com/dkp/konvoy/2.1/choose-infrastructure/aws/advanced/new/#create-a-new-aws-kubernetes-cluster) for an example on how to use the `--dry-run` and `--output` flags to create a set of cluster objects.
