...
- An [Identity Provider](/dkp/kommander/1.2/tutorials/authorize-all-users/) has been created.
...
- 4 configured [groups](/dkp/kommander/1.2/operations/identity-providers/) in Kommander
...
Kommander has [three levels of access control](/dkp/kommander/1.2/operations/access-control/) to support global, workspace, and project use cases. Kommander creates default roles at all three levels to simplify the process of assigning users to different levels of access to resources.
...
If you have not done so already, create a group to represent each of the personas. For more details on groups, see the [Identity Providers page](/dkp/kommander/1.2/operations/identity-providers/) and the [Identity Provider tutorial](/dkp/kommander/1.2/tutorials/authorize-all-users/).
