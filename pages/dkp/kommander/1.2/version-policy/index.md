...
D2iQ&reg; supports N-2 of the latest `MAJOR.MINOR` version of Kommander. For example, if the current version of Konvoy&reg; is version 1.4, then D2iQ supports all patch versions of Kommander 1.4, 1.3, and 1.2.
