...
```
      --additional-security-group-ids strings   A comma separated list of existing security group IDs to use for the nodes in addition to those created automatically
  ...
  -h, --help                                    help for aws
      ...
      --iam-instance-profile string             Name of the IAM instance profile to assign to the machines.
      --instance-type string                    Machine instance type (ex. 't3.large')
