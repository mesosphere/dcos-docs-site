...
```
      --additional-security-group-ids strings       A comma separated list of existing security group IDs to use for the control-plane and worker nodes in addition to those created automatically (default [])
  ...
  -c, --cluster-name name                           Name used to prefix the cluster and all the created resources.
      ...
      --control-plane-instance-type string          Control Plane machine instance type (ex. 't3.large') (default "m5.xlarge")
  ...
  -h, --help                                        help for aws
      ...
      --kind-cluster-image string                   Kind node image for the bootstrap cluster (default "mesosphere/konvoy-bootstrap:v2.2.0-rc.1")
