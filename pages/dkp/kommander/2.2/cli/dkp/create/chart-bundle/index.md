...
```
      --catalog-repository string         Git repository containing catalog application definitions (default "github.com/mesosphere/kommander-applications.git?ref=v2.2.0-rc.1")
