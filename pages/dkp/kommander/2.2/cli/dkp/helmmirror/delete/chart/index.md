---
layout: layout.pug
navigationTitle:  dkp helmmirror delete chart
title:  dkp helmmirror delete chart
menuWeight: 10
...
## dkp helmmirror delete chart

Delete a chart from the repository

```
dkp helmmirror delete chart [chartName] [chartVersion] [flags]
```
