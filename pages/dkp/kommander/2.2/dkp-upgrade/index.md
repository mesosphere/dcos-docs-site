...
1.  [Upgrade all DKP Catalog applications][catalog_apps] that may be deployed to any Workspaces or Projects.
    ...
    <p class="message--warning"><strong>WARNING: </strong>Ensure your **Custom** Catalog Applications are compatible with Kubernetes 1.22. If not, upgrade them before continuing with the Konvoy upgrade process. Refer to your Custom Catalog Application provider for information on how to upgrade. 
</p>
