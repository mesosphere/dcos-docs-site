...
![Project Catalog](/dkp/kommander/1.1/img/project-catalog.png)
...
![Deploy Helm Platform Service](/dkp/kommander/1.1/img/project-catalog-deploy-helm.png)

For KUDO-based addons, fill out the form fields supported by that addon's parameters schema:

![Deploy KUDO Platform Service](/dkp/kommander/1.1/img/project-catalog-deploy-kudo.png)
