...
If you want to be able to explore an application's UI after it's finished, consider setting up the [Spark History Server](https://github.com/mesosphere/kudo-spark-operator/blob/master/kudo-spark-operator/docs/latest/history-server.md).
