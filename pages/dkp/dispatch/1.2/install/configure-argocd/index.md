...
On Konvoy, the Dex kubeaddon can act as an Identity Provider. See [Setting up an external identity provider](https://docs.d2iq.com/dkp/konvoy/latest/security/external-idps/) for more information on how to connect Dex to your external Identity Provider.
