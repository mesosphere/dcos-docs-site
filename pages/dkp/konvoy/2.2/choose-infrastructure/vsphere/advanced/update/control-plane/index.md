...
There exist many reasons to update the control plane. This topic covers three of the most common:

1. Upgrade the Kubernetes version
1. Update the machine image
1. Update the machine hardware

The control plane is described by a KubeadmControlPlane resource. This references an immutable vSphereMachineTemplate resource. This topic explains how to create a new vSphereMachineTemplate and patch the KubeadmControlPlane to update the control plane.
