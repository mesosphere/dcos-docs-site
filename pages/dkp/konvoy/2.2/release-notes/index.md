...
| Application Name     | Platform Application                           | Version | Component Versions                                                                                                     |
|----------------------|------------------------------------------------|---------|------------------------------------------------------------------------------------------------------------------------|
|                      | cert-manager                                   | 1.7.1   | - chart: 1.7.1 - cert-manager: 1.7.1                                                                                   |
| Dex                  | dex                                            | 2.9.14  | - chart: 2.9.14 - dex: 2.22.0                                                                                          |
|                      | external-dns                                   | 6.1.8   | - chart: 6.1.8 - external-dns: 0.10.2                                                                                  |
...
|                      | logging-operator                               | 3.17.2  | - chart: 3.17.2 - logging-operator: 3.17.2                                                                             |
| Minio                | minio-operator                                 | 4.4.10  | - chart: 4.4.10 - minio: 4.4.10                                                                                        |
|                      | nfs-server-provisioner                         | 0.6.0   | - chart: 0.6.0 - nfs-provisioner: 2.3.0                                                                                |
| Nvidia               | nvidia                                         | 0.4.4   | - chart: 0.4.4 - nvidia-device-plugin: 0.9.0                                                                           |
|                      | project-grafana-logging                        | 6.20.6  | - chart: 6.20.6 - grafana: 8.3.6                                                                                       |
| Grafana              | project-grafana-loki                           | 0.33.2  | - chart: 0.33.1 - loki: 2.2.1                                                                                          |
|                      | project-logging                                | 1.0.0   |                                                                                                                        |
|                      | prometheus-adapter                             | 2.17.1  | - chart: 2.17.1 - prometheus-adapter: 0.9.1                                                                            |
|                      | reloader                                       | 0.0.104 | - chart: 0.0.104 - reloader: 0.0.104                                                                                   |
| Thanos               | thanos                                         | 0.4.6   | - chart: 0.4.6 - thanos: 0.9.0                                                                                         |
| Traefik              | traefik                                        | 10.9.1  | - chart: 10.9.1 - traefik: 2.5.6                                                                                       |
|                      | traefik-forward-auth                           | 0.3.6   | - chart: 0.3.6 - traefik-forward-auth: 3.1.0                                                                           |
