...
1.  Run setup.
    ...
    sudo ./setup
    ```
<p class="message--important"><strong>NOTE: This setup process will take around fifteen minutes, so stretch your legs a bit.</p>
...
libmspack-0.5-0.8.alpha.el7.x86_64.rpm		      polkit-0.112-26.el7.x86_64.rpm
 ```
 <p class="message--important"><strong>NOTE: The version numbers of the files included within the air-gapped bundle may be different than the versions listed above.</p>
