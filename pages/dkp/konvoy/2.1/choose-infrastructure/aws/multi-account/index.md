...
1. Deploy a management cluster in the AWS account (source account)
...
<ol type="a">
  <li>The prerequisite IAM policies for DKP are documented here: https://docs.d2iq.com/dkp/konvoy/2.1/choose-infrastructure/aws/iam-policies//li>
  
</ol>
 
Establish a trust relationship in workload account for the management account
<ol type="a">
  <li>Go to your target (workload) account</li>
  <li>Search for the role control-plane.cluster-api-provider-aws.sigs.k8s.io</li>
  <li>Navigate to the Trust Relationship tab and click Edit Trust Relationship</li>
 <li>Add the following relationship</li>
</ol>
