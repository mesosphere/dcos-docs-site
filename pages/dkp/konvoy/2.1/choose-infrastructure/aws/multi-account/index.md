...
Getting Started with DKP on AWS - https://docs.d2iq.com/dkp/konvoy/2.1/choose-infrastructure/aws/
...
https://docs.d2iq.com/dkp/konvoy/2.1/choose-infrastructure/aws/quick-start-aws/#configure-aws-prerequisites

Deploy DKP on AWS
 Deploy a management cluster in the AWS account (source account)
Configure a trusted relationship between source and target accounts.
Create a management cluster:
AWS: https://docs.d2iq.com/dkp/konvoy/2.1/choose-infrastructure/aws/quick-start-aws/#create-a-new-aws-kubernetes-cluster
EKS: https://docs.d2iq.com/dkp/konvoy/2.1/choose-infrastructure/eks/quick-start/#create-a-new-eks-kubernetes-cluster
...
Create all policies and roles in management and workload accounts
The prerequisite IAM policies for DKP are documented here: https://docs.d2iq.com/dkp/konvoy/2.1/choose-infrastructure/aws/iam-policies/ 
Establish a trust relationship in workload account for the management account
Go to your target (workload) account
Search for the role control-plane.cluster-api-provider-aws.sigs.k8s.io
Navigate to the Trust Relationship tab and click Edit Trust Relationship
...
Give permission to role in the source (management cluster) account to call sts:AssumeRole API
Login to source AWS account and attach the following inline policy to control-plane.cluster-api-provider-aws.sigs.k8s.io role
