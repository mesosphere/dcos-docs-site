...
For example, Konvoy 2.1.0 supports:
...
Konvoy and Kommander release `MAJOR.MINOR` versions together and are compatible with each other for that version set. This means, Kommander 2.1, and all of its patch versions (e.g. 2.1.0, 2.1.1), can deploy successfully on any version of Konvoy 2.1. Mixing minor versions is prohibited and the following is not supported:
