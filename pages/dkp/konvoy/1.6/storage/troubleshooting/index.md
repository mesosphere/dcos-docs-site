...
Some storage drivers may be significantly different from others. For the purposes of this documentation we are covering the AWS, GCP and Azure storage drivers which come by default in a Konvoy deployment.
