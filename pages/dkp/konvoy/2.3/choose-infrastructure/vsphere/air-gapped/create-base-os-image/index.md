...
The next step is to [create a vSphere VM template][create-vsphere-template] that contains all of the configuration and artifacts needed to create a Kubernetes cluster.
