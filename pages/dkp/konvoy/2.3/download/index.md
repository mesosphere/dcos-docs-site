...
<p class="message--note"><strong>NOTE: </strong> In DKP 2.3, the Konvoy and Kommander binaries have been merged into a single binary, which you can find by selecting the Download DKP button above.
...
You will now see the `dkp` binary in your working directory. Follow the [Kommander installation instructions](/dkp/kommander/2.3/install/networked) using these binaries, and then [add your license](/dkp/kommander/2.3/licensing/add/) to Kommander. If you have problems downloading or installing Kommander, contact your sales representative or <a href="mailto:sales@d2iq.com">sales@d2iq.com</a>.
