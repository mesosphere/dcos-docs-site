---
layout: layout.pug
navigationTitle: Preprovisioned
title: Preprovisioned
menuWeight: 10
excerpt: Install Konvoy on preprovisioned infrastructure
enterprise: false
---

<!-- markdownlint-disable MD034 -->

The following procedure describes installing Konvoy on a preprovisioned on-premises infrastructure.

<p class="message--note"><strong>NOTE: </strong>While the steps for an air gap installation are similar certain files must be accessible locally for a successful installation.</p>
