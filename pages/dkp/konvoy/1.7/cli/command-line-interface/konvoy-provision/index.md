...
```
      --addons-repositories strings   A comma separated list of addons repositories with uri@version (default [https://github.com/mesosphere/kubeaddons-kommander@stable-1.19-1.3.0,https://github.com/mesosphere/kubeaddons-dispatch@stable-1.19-1.4.1,https://github.com/mesosphere/kubernetes-base-addons@stable-1.19-3.2.0])
