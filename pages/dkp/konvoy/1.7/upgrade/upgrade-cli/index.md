...
```bash
konvoy image upgrade --version=v1.7.0-rc.7
Wrote Konvoy CLI version 'v1.7.0-rc.7' to '.konvoy/cli_version'
```

After the upgrade command completes, you can start using the new Konvoy version.

### Upgrading Konvoy from v1.6.x to v1.7.0-rc.7
...
If you use Kommander, you need to change the `configVersion` for your `configRepository`: `https://github.com/mesosphere/kubeaddons-kommander` to be `spec.addons.configVersion: testing-1.19-1.3.0-rc.8`.

The version of Konvoy is now `v1.7.0-rc.7`, set `spec.version: v1.7.0-rc.7`.
