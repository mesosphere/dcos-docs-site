...
- Prerequisites - This role handles all of the [requirements to run DC/OS](/mesosphere/dcos/1.13/installing/production/system-requirements/#software-prerequisites).
