...
![new DC/OS user](/mesosphere/dcos/1.13/img/1-11-add-user-to-cluster.png)
...
1.  [SSH](/mesosphere/dcos/1.13/administering-clusters/sshcluster/) to a master node and run this command, where `<email>` is the user's email:
