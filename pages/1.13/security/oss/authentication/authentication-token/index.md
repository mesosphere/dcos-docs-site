...
In DC/OS Open Source, Authentication tokens are valid for five days after they have been issued. After five days, you must log in again to obtain a new token. Using [service accounts](/mesosphere/dcos/1.13/security/oss/user-account-management/service-accounts/) and the [service login](/mesosphere/dcos/1.13/security/oss/login/service-login/) make it easy to automate this process when deploying long-running services.
...
* [External user login](/mesosphere/dcos/1.13/security/oss/login/external-user-login/)
* [Local user login](/mesosphere/dcos/1.13/security/oss/login/local-user-login/)
* [Service login](/mesosphere/dcos/1.13/security/oss/login/service-login/)

# Pass an Authentication token to the API

## Prerequisite
- [DC/OS Authentication token](/mesosphere/dcos/1.13/security/oss/authentication/authentication-token/)
