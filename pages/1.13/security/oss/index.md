...
Ensure the network is set up according to the information for [securing your cluster](/mesosphere/dcos/1.13/administering-clusters/securing-your-cluster/).
...
- [Understand DC/OS security](/mesosphere/dcos/1.13/administering-clusters/)
- [Learn how to monitor a DC/OS cluster](/mesosphere/dcos/1.13/monitoring/)
