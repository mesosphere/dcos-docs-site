...
DC/OS Enterprise supports [directory-based authentication through LDAP](/mesosphere/dcos/1.13/security/ent/ldap/). Users and user groups can be imported from the external directory into the DC/OS IAM. See [managing users and groups](/mesosphere/dcos/1.13/security/ent/users-groups/).
...
The exact period is configurable on installation. See the [configuration reference](/mesosphere/dcos/1.13/installing/production/advanced-configuration/configuration-reference/) under [advanced configuration](/mesosphere/dcos/1.13/installing/production/advanced-configuration/). 
