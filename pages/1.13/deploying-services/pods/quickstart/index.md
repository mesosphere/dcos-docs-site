...
### Prerequisites
- DC/OS [installed](/mesosphere/dcos/1.13/installing/)
...
You can also launch a pod from the [**Services**](/mesosphere/dcos/1.13/gui/) tab of the DC/OS web interface. Select **Services -> Services -> RUN A SERVICE -> Multi-container (Pod)**, then toggle to JSON mode and paste in the application definition supplied above.
