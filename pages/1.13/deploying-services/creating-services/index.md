...
1. Use the [DC/OS CLI](/1.13/cli/) to add the service to DC/OS.
...
1. Choose whether to use the Universal Container Runtime (UCR) or Docker Engine runtime. See [Using Containerizers](/1.13/deploying-services/containerizers/).
...
1. Scroll down to the **Marathon Task Configuration** section and note the PORTS property.
   ...
   ![container port](/1.13/img/container-port.png)

   Figure 1. Container port
   
1. Determine the [IP address of the public node](/1.13/administering-clusters/locate-public-agent/).
