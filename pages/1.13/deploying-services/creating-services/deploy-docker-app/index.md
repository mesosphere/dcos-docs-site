...
1.  Go to your public agent to see the site running. To find your public agent IP address, see [Finding a Public Agent IP](/1.13/administering-clusters/locate-public-agent/).
...
Learn how to load balance your app on a public node using [Marathon-LB](/1.13/networking/marathon-lb/marathon-lb-basic-tutorial/).
