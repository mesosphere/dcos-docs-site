...
In this step, a Marathon Service Account is created. Depending on your [security mode](/1.13/security/ent/#security-modes), a Marathon Service Account is either optional or required.
