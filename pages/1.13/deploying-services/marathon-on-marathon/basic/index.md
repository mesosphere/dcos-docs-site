...
1.  [SSH](/mesosphere/dcos/1.13/administering-clusters/sshcluster/) to your private agent node.
...
In this step, a Marathon Service Account is created. Depending on your [security mode](/mesosphere/dcos/1.13/security/ent/#security-modes), a Marathon Service Account is either optional or required.
...
1.  Select the name of the user or group to grant the permission to.
    ...
    ![Add permission cory](/mesosphere/dcos/1.13/img/GUI-Organization-Users-List_View-1_12.png)
