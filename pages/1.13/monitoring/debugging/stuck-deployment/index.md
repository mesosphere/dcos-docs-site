...
- Marathon is not getting the resource offers it needs to launch the app.
  Use the [CLI](/1.13/monitoring/debugging/cli-debugging/) debug subcommands or the [debugging page in the DC/OS UI](/1.13/monitoring/debugging/gui-debugging/) to troubleshoot unmatched or unaccepted resource offers from Mesos. You can also [consult the service and task logs](/1.13/monitoring/logging/).
