...
The following example will create a pod with two containers and one shared persistent volume. Also see [Pods](/mesosphere/dcos/1.12/deploying-services/pods/).
