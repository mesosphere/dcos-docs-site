...
![new DC/OS user](/mesosphere/dcos/1.12/img/1-11-add-user-to-cluster.png)
...
1.  [SSH](/mesosphere/dcos/1.12/administering-clusters/sshcluster/) to a master node and run this command, where `<email>` is the user's email:
...
![log out](/mesosphere/dcos/1.12/img/1-11-user-drop-down-menu.png)
...
For more information on security, check out [Security and Authentication](/mesosphere/dcos/1.12/security/oss/)
