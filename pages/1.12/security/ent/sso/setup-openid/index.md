...
1. Paste the client secret value from Google into the **Client Secret** field.
    ...
    ![Google IdP Configuration](/1.12/img/oidc-google.png)
...
1. Assign this user the appropriate [permissions](/1.12/security/ent/perms-reference/).

### <a name="using-cli"></a>Using the DC/OS CLI

**Prerequisite:** [DC/OS CLI installed](/1.12/cli/install/).
...
1. You should see a message similar to the following.
    ...
    ![CLI IdP Auth Token](/1.12/img/cli-auth-token.png)
