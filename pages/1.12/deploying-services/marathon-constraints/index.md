...
Use the `@region` and `@zone` field names to configure [fault domain awareness and capacity extension](/mesosphere/dcos/1.12/deploying-services/fault-domain-awareness/).
