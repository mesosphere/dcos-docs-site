...
The process for updating packages from the [DC/OS Catalog](/1.12/gui/catalog/) is different. For more information, see the [documentation](/1.12/deploying-services/config-universe-service/).
