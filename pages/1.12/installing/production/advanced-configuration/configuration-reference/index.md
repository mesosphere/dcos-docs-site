...
The default is `logrotate`. Due to performance issues, `journald` is not recommended. For details, see [Logging Reference](/1.12/monitoring/logging/logging-api/#compatibility).
