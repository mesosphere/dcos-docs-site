...
The only informations this module needs to receive are the outputs of our `dcos` and `dcos-usw2` modules. We will append this module to the end of your `main.tf`
