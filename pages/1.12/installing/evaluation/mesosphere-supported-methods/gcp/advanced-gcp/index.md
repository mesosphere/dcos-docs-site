...
| [enterprise]dcos_license_key_contents[/enterprise] | Used to privide the license key of DC/OS for Enterprise Edition. Optional if license.txt is present on bootstrap node. | string | `` | no |
...
| [enterprise]dcos_zk_super_credentials[/enterprise] | Set the zk super credentials (recommended) | string | `` | no |
