...
- A node that meets the bootstrap node [system requirements](//installing/ent/custom/system-requirements/).
...
For parameters descriptions and configuration examples, see the [documentation](//installing/ent/custom/configuration/configuration-parameters/).
...
- On the **Select Template** page, upload the [Zen](//installing/evaluation/cloud-installation/aws/advanced/template-reference/#zen) template from your workstation and click **Next**.
...
1.  Click **Log In To DC/OS**.
    ...
    ![UI installer success](//img/gui-installer-success-ee.gif)
...
1.  Enter the username and password of the superuser account.
    ...
    **Note:** The default username is `bootstrapuser` and default password is `deleteme`.
    ...
    ![UI dashboard](//img/dashboard-ee.png)
...
You can add more agent nodes by creating a new stack. Use the [advanced-priv-agent.json](//installing/evaluation/cloud-installation/aws/advanced/template-reference/#private-agent) or [advanced-pub-agent.json](//installing/evaluation/cloud-installation/aws/advanced/template-reference/#public-agent) templates. These templates create agents which are then attached to the `PrivateAgentStack` or `PublicAgentStack` as a part of an AutoScalingGroup.
...
For all of the advanced configuration options, see the template reference [documentation](//installing/evaluation/cloud-installation/aws/advanced/template-reference/).
...
# Template reference
For the complete advanced configuration options, see the template reference [documentation](//installing/evaluation/cloud-installation/aws/advanced/template-reference/).
