...
#### Agent templates
The [agent](#private-agent) templates create [public](//overview/concepts/#public-agent-node) or [private](//overview/concepts/#private-agent-node) agent nodes that are then attached to a DC/OS cluster as a part of an AutoScalingGroup.
