...
**Important:** If you downloaded the CLI from PyPI or from the DC/OS UI version 1.7 or earlier, you must completely [uninstall](/1.12/cli/uninstall/) the CLI. You cannot upgrade.
