...
# Description
The dcos config show command will display the DC/OS configuration file contents of the currently [attached](/1.12/cli/command-reference/dcos-cluster/dcos-cluster-attach/) cluster.
