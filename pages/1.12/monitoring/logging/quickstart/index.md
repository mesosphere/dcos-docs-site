...
Use this guide to get started with DC/OS logging. Many of the commands used here are described more fully in the [CLI Command Reference](/1.12/cli/command-reference/dcos-task/).
...
You can view logs from tasks or the host subsystem with the `dcos node log` command. find more information on these commands in the [CLI Command Reference](/1.12/cli/command-reference/dcos-node/) section.
