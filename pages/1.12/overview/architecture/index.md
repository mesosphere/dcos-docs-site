...
![DC/OS Architecture Layers](/mesosphere/dcos/1.12/img/architecture-layers-redesigned.png)
...
For more information, see [Task Types](/mesosphere/dcos/1.12/overview/architecture/task-types/).
...
- [Node Types](/mesosphere/dcos/1.12/overview/architecture/node-types/)
- [Host Operating System](/mesosphere/dcos/1.12/overview/concepts/#host-operating-system).
...
For more information, see [Installing](/mesosphere/dcos/1.12/installing/).

## External components

In addition to the software that runs in the datacenter, DC/OS includes and integrates with several external components:

- [GUI](/mesosphere/dcos/1.12/gui/)
- [CLI](/mesosphere/dcos/1.12/cli/)
- [package repository](/mesosphere/dcos/1.12/administering-clusters/repo/)
- [container registry](/mesosphere/dcos/1.12/overview/concepts/#container-registry)
