...
![DC/OS Architecture Layers](/1.12/img/architecture-layers-redesigned.png)
...
For more information, see [Task Types](/1.12/overview/architecture/task-types/).
...
- [Node Types](/1.12/overview/architecture/node-types/)
- [Host Operating System](/1.12/overview/concepts/#host-operating-system).
...
For more information, see [Installing](/1.12/installing/).
...
- [GUI](/1.12/gui/)
- [CLI](/1.12/cli/)
- [package repository](/1.12/administering-clusters/repo/)
- [container registry](/1.12/overview/concepts/#container-registry)
