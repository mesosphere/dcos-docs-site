...
- Permission resources sometimes include the `/` character. Any `/` character in a resource must be replaced with `%252F` before it can be passed in a curl command. You can see this in the examples below.
