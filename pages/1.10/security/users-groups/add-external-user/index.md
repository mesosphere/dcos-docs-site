...
- An external [LDAP directory](/1.10/security/ldap/). 
- An [OpenID Connect or SAML provider](/1.10/security/sso/).
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/1.10/security/iam-api/) endpoint. 
...
- If your [security mode](/1.10/security/#security-modes) is `permissive` or `strict`, you must follow the steps in [Obtaining the root certificate of your DC/OS CA](/1.10/networking/tls-ssl/get-cert/) before issuing the curl commands in this section. If your [security mode](/1.10/security/#security-modes) is `disabled`, you must delete `--cacert dcos-ca.crt` from the commands before issuing them.
