...
1.  Click **Add Directory**.
   ...
   ![Add Directory dialog](/mesosphere/dcos/1.10/img/ldap-add-dir-conn.png)
...
1.  Specify your authentication method and parameters, as discussed in the [next section](/mesosphere/dcos/1.10/security/ent/ldap/ldap-auth/).
