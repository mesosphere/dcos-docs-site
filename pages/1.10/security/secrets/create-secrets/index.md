...
Secrets should include paths, unless you want to allow all services to access its value. See [Spaces](/1.10/security/#spaces) for more information about secret paths.
