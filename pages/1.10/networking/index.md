...
Two other load balancers, [Edge-LB](/services/edge-lb/) and [Marathon-LB](/services/marathon-lb/1.12/) can be installed as services from the DC/OS Universe package repository.
