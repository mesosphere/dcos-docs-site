...
**Prerequisites:** [DC/OS and DC/OS CLI](/mesosphere/dcos/1.10/installing/) are installed.
...
1.  SSH into your node. For example, use this CLI command to SSH to your master:
    ...
    For more information, see the SSH [documentation](/mesosphere/dcos/1.10/administering-clusters/sshcluster/).
...
2.  Run this command from your master node to view the node details:
 ...
 [1]: /mesosphere/dcos/1.10/overview/concepts/
