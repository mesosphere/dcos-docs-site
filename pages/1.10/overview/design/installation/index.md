...
- Initiates installation using the [DC/OS Component Package Manager (Pkgpanda)](/mesosphere/dcos/1.10/overview/architecture/components/#dcos-component-package-manager).
