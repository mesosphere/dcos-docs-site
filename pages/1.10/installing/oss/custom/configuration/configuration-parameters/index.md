...
This topic provides configuration parameters available for [DC/OS](https://dcos.io/). For configuration parameters available for [DC/OS Enterprise](https://mesosphere.com/product/) please refer to [Configuration Reference for DC/OS Enterprise](/1.10/installing/ent/custom/configuration/configuration-parameters/).
...
| Parameter                          | Description                                                                                                                                                |
|------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [oauth_enabled](#oauth-enabled-open-source)                                | Indicates whether to enable authentication for your cluster.  |
