...
| dcos_version | Specifies which DC/OS version instruction to use. Options: `1.11.8`, `1.12.2`, etc. See the [available version list](#supported-dcos-versions) for currently supported versions. | string | `1.10.8` | no |
