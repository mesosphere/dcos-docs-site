...
Terraform requires SSH access to the instances you launch as part of your DC/OS cluster. The SSH key used to SSH to these instances is added to your `ssh-agent`, prior to running `terraform`.
...
Terraform also makes it easy to upgrade your cluster to a newer version of DC/OS.
