...
- A node that meets the bootstrap node [system requirements](https://docs.mesosphere.com/1.12/installing/production/system-requirements/).
...
For parameters descriptions and configuration examples, see the [documentation](https://docs.mesosphere.com/1.12/installing/production/deploying-dcos/configuration/).
...
- On the **Select Template** page, upload the [Zen](https://docs.mesosphere.com/1.12/installing/evaluation/community-supported-methods/aws/advanced/template-reference/#zen) template from your workstation and click **Next**.
...
For all of the advanced configuration options, see the template reference [documentation](/1.11/installing/evaluation/community-supported-methods/aws/advanced/template-reference/).
...
# Template reference
For the complete advanced configuration options, see the template reference [documentation](/1.11/installing/evaluation/community-supported-methods/aws/advanced/template-reference/).
