...
*   The default is five [private](/1.10/overview/concepts/#private-agent-node) Mesos agent nodes.
*   The default is one [public](/1.10/overview/concepts/#public-agent-node) Mesos agent node. By default, ports are closed and health checks are configured for Marathon-LB. Ports 80 and 443 are configured for the AWS Elastic Load Balancer.
