...
The recommended way to install DC/OS that can be upgraded in-place is by following the [production installation process](/1.10/installing/production/deploying-dcos/installation/).
</p>
