...
The recommended way to install production-ready DC/OS that can be upgraded in-place is to use the [Installation method](1.10/installing/production/deploying-dcos/installation/).
[/message]
