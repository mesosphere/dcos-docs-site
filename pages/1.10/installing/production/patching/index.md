...
There are no specific instructions for patching since it occurs as a part of the release. Refer to [Upgrading instructions](/mesosphere/dcos/1.10/installing/production/upgrading/#instructions) for upgrading DC/OS.
