...
- from external machines to public agent nodes: block connection requests on all ports except [advertised port ranges](/mesosphere/dcos/1.10/installing/production/system-requirements/ports/#agent).
...
If you run HAProxy in front of Admin Router, you should secure the communication between them. For information about securing your communication, see the [documentation](/mesosphere/dcos/1.10/security/oss/tls-ssl/haproxy-adminrouter/).
...
[Marathon-LB](/mesosphere/dcos/services/marathon-lb/1.12/) with HTTPS for
...
![Security Zones](/mesosphere/dcos/1.10/img/security-zones.jpg)
...
See the [Security Administrator's Guide](/mesosphere/dcos/1.10/security/) for more information.
