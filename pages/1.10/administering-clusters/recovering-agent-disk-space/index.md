...
- If the work directory is on a separate volume (as recommended in [Agent nodes](/1.10/installing/custom/system-requirements/#agent-nodes), then you can empty this volume and restart the agent.
