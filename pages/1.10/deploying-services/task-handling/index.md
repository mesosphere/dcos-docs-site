...
You can also  [configure Marathon's behavior when a task is unreachable](/mesosphere/dcos/1.10/deploying-services/task-handling/configure-task-handling/).

![Task Handling Flow](/mesosphere/dcos/1.10/img/task-handling.png)
