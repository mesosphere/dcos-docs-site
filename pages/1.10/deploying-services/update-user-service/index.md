...
**Note:** The process for updating packages from the [DC/OS Universe](/1.10/gui/#-a-name-universe-a-universe) is different. For more information, see the [documentation](/1.10/deploying-services/config-universe-service/).
