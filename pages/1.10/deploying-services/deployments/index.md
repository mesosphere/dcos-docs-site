...
Every change in the definition of applications or groups in DC/OS is performed as a Marathon deployment. A [deployment](/1.10/deploying-services/marathon-api/#!/deployments/V2Deployments) is a set of actions, including:
