...
This topic describes how to use the DC/OS CLI to configure services. You can also customize services by using the [**Services**](/mesosphere/dcos/1.10/gui/services/) tab in the DC/OS UI. 
...
For more information, see the [dcos package](/mesosphere/dcos/1.10/cli/command-reference/dcos-package/) documentation.
