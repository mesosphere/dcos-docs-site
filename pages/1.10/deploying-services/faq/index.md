...
This is not currently supported. For more information, see [this document](/1.10/installing/production/advanced-configuration/configuring-zones-regions/).
...
For more information, see the installation [documentation](/1.10/installing/).
