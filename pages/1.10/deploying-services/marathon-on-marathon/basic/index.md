...
The basic procedure does not support [secrets](/1.10/security/secrets/) or fine-grained ACLs. If you require these features, you must use the custom non-native Marathon [procedure](/1.10/deploying-services/marathon-on-marathon/advanced/).
