...
In this step, a Marathon Service Account is created. Depending on your [security mode](/1.10/security/#security-modes), a Marathon Service Account is either optional or required. 
...
1. Store the IP address of each private agent in an environment variable. <!-- What is this step for -->The steps required depend on your [security mode](/1.10/security/#security-modes).
...
1.  Create a custom JSON config file and save as `config.json`. This file is used to install the custom non-native Marathon instance. The JSON file contents vary according to your [security mode](/1.10/security/#security-modes). Replace these variables in the examples with your specific information:
