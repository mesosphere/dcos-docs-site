...
# Prerequisites
* A [running DC/OS cluster](/mesosphere/dcos/1.10/tutorials/dcos-101/cli/) with [the DC/OS CLI installed](/mesosphere/dcos/1.10/cli/install/).
* [app2 and Marathon-LB](/mesosphere/dcos/1.10/tutorials/dcos-101/app2/) deployed and running in your cluster.
...
1. [Named VIPs](/mesosphere/dcos/1.10/networking/load-balancing-vips/).

You have already explored these load balancing mechanisms in the context of [service discovery](/mesosphere/dcos/1.10/tutorials/dcos-101/service-discovery/), and in a [previous](/mesosphere/dcos/1.10/tutorials/dcos-101/marathon-lb/) tutorial you used Marathon-LB to publicly expose app2. Now let's explore them a bit more.
...
Consider these features and benefits when choosing the load balancing mechanism.
   ...
   * [Named VIPs](/mesosphere/dcos/1.10/networking/load-balancing-vips/) are a layer 4 load balancer mechanism used for internal TCP traffic. As they are tightly integrated with the kernel, they provide a load balanced IP address which can be used from anywhere within the cluster.
