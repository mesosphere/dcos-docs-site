...
You have already explored these load balancing mechanisms in the context of [service discovery](https://dcos.io/1.10/tutorials/dcos-101/service-discovery/), and in a [previous](https://dcos.io/1.10/tutorials/dcos-101/marathon-lb/) tutorial you used Marathon-LB to publicly expose app2. Now let's explore them a bit more.
