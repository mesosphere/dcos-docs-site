...
For a more comprehensive architectural description of DC/OS, see [DC/OS Architecture](/mesosphere/dcos/2.1/overview/architecture/).

For a more complete discussion of components, see [DC/OS Components](/mesosphere/dcos/2.1/overview/architecture/components/).
...
![Azure Container Service architecture using DC/OS.](/mesosphere/dcos/2.1/img/dcos-acs.png)
