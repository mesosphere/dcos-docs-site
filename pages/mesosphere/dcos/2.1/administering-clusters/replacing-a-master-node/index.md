...
1. Back up ZooKeeper state information using Exhibitor, the Guano utility, or a custom script.
    ...
    For more information about backing up ZooKeeper using the Guano utility, see [How do I backup ZooKeeper using Guano?](/mesosphere/dcos/2.1/installing/installation-faq/#zk-backup)
