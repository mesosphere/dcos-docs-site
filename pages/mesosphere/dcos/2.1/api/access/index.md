...
To determine which agents are public agents, see [Finding a Public Agent IP](/mesosphere/dcos/2.1/administering-clusters/locate-public-agent/).
...
For more information, see [Securing Your Cluster](/mesosphere/dcos/2.1/administering-clusters/).
