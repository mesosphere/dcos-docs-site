...
The Logging API is backed by the [DC/OS Log component](/mesosphere/dcos/2.1/overview/architecture/components/#dcos-log), which runs on all nodes in the cluster. For more information about using the Logging API, see [Logging](/mesosphere/dcos/2.1/monitoring/logging/). For usage examples, see [Logging API Examples](/mesosphere/dcos/2.1/monitoring/logging/logging-api-examples/).
...
To determine the address of your cluster, see [Cluster Access](/mesosphere/dcos/2.1/api/access/).
...
All Logging API routes require authentication to use. To authenticate API requests, see [Obtaining an authentication token](/mesosphere/dcos/2.1/security/ent/iam-api/#/obtaining-an-authentication-token/) and [Passing an authentication token](/mesosphere/dcos/2.1/security/ent/iam-api/#/passing-an-authentication-token/).
...
All routes may also be reached by users with the _dcos:superuser_ permission. To assign permissions to your account, see [Permissions Reference](/mesosphere/dcos/2.1/security/ent/perms-reference/).
...
## Resources
 ...
 [swagger api='/mesosphere/dcos/2.1/api/logs2.yaml']
