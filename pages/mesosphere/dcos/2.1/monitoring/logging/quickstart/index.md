...
- You must have DC/OS and the DC/OS CLI [installed](/mesosphere/dcos/2.1/installing/).

- You must be logged in as as a superuser or have been granted user access to logging. For more information, see [Accessing system and component logs](/mesosphere/dcos/2.1/monitoring/logging/access-component-logs/) and [Accessing task logs](/mesosphere/dcos/2.1/monitoring/logging/access-task-logs/).
...
You can view logs from tasks or the host subsystem with the `dcos node log` command. find more information on these commands in the [CLI Command Reference](/mesosphere/dcos/2.1/cli/command-reference/dcos-node/) section.
