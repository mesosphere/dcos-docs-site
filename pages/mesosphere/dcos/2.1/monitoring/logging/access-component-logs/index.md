...
Here is the [permission](/mesosphere/dcos/2.1/security/ent/perms-reference/) that is required to view the system and component logs:
...
1.  From the **Permissions** tab, select **ADD PERMISSION**.
    ...
    ![Add permission to user](/mesosphere/dcos/2.1/img/GUI-Organization-Users-User_Main_View.png)
...
1.  Click **INSERT PERMISSION STRING** to toggle the dialog and paste in the following permissions and click **ADD PERMISSIONS**.
    ...
    ![Add permission](/mesosphere/dcos/2.1/img/GUI-Organization-User-Add_Single_User_Perm_String-1_12.png)

    Figure 3. Permission string dialog

    The **Permissions** tab should now look like this:

    ![prod-group permissions complete](/mesosphere/dcos/2.1/img/GUI-Organization-Users-User_View_w_Perm.png)
