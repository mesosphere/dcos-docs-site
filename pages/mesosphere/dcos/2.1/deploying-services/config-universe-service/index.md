...
This topic describes how to use the CLI to configure services. You can also customize services by using the [**Services**](/mesosphere/dcos/2.1/gui/services/) tab in the DC/OS UI.

1. View the available configuration options for the service with the [`dcos package describe --config <package-name>`](/mesosphere/dcos/2.1/cli/command-reference/dcos-package/dcos-package-describe/) command.
...
For more information, see the [dcos package](/mesosphere/dcos/2.1/cli/command-reference/dcos-package/) command reference documentation.
