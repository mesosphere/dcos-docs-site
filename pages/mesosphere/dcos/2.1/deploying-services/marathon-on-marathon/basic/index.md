...
This topic describes how to deploy a non-native instance of Marathon with isolated roles, reservations, and quotas. This procedure does not support [secrets](/mesosphere/dcos/2.1/security/ent/secrets/) or fine-grained ACLs. If you require these features, you must use the [custom non-native Marathon procedure](/mesosphere/dcos/2.1/deploying-services/marathon-on-marathon/advanced/).
...
1.  [SSH](/mesosphere/dcos/2.1/administering-clusters/sshcluster/) to your private agent node.
...
In this step, a Marathon Service Account is created. Depending on your [security mode](/mesosphere/dcos/2.1/security/ent/#security-modes), a Marathon Service Account is either optional or required.
...
1.  Select the name of the user or group to grant the permission to.
    ...
    ![Add permission cory](/mesosphere/dcos/2.1/img/GUI-Organization-Users-User_Main_View.png)
...
1.  Click **INSERT PERMISSION STRING** to toggle the dialog.
    ...
    ![Add permission](/mesosphere/dcos/2.1/img/GUI-Organization-Users-User_Alice_Add_Gen_Perms-1_12.png)

    Figure 3. Add permissions.

1.  Copy and paste the permission in the **Permissions Strings** field. Choose the permission strings based on your [security mode](/mesosphere/dcos/2.1/security/ent/#security-modes).
