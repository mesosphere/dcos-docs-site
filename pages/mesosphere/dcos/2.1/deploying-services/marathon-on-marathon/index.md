...
# Isolating Resources
DC/OS Enterprise [security features](/mesosphere/dcos/2.1/security/ent/) provides robust fine-grained access control. However, there are situations when you might want a partitioned environment, for example:
