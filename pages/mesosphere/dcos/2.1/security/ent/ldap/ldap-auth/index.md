...
1.  When you have completed your entries, the dialog should look like the following.
    ...
    ![Simple bind parameters](/mesosphere/dcos/2.1/img/GUI-LDAP-anonymous-simple-bind.png)

    Figure 1. Anonymous Bind with Simple Bind parameters 

1.  Click **Add Directory**.

1.  [Verify your connection](/mesosphere/dcos/2.1/security/ent/ldap/ldap-verify/).
...
1. When you have completed your entries, the dialog should look like the following:
    ...
    ![Anonymous Bind with Search](/mesosphere/dcos/2.1/img/GUI-LDAP-anonymous-search-bind.png)
...
1.  When you have completed your entries, the dialog should look like the following.
    ...
    ![Simple bind parameters](/mesosphere/dcos/2.1/img/GUI-LDAP-credentials-simple.png)
...
1. When you have completed your entries, the dialog should look like the following:
    ...
    ![LDAP Credentials with Search](/mesosphere/dcos/2.1/img/GUI-LDAP-credentials-search.png)
