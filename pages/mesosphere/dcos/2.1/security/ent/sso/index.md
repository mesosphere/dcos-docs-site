...
- Adding a [SAML Identity Provider](/mesosphere/dcos/2.1/security/ent/sso/setup-saml/)
- Adding an [OpenID Identity Provider](/mesosphere/dcos/2.1/security/ent/sso/setup-openid/):
