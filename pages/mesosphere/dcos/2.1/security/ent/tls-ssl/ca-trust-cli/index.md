...
<p class="message--note"><strong>NOTE: </strong>This procedure should be unnecessary if you have <a href="/mesosphere/dcos/2.1/security/ent/tls-ssl/haproxy-adminrouter/">set up a proxy</a>.</p>


By default, the DC/OS CLI does not verify the signer of TLS certificates. We recommend completing the following brief procedure to ensure that the DC/OS CLI trusts only your DC/OS CA and refuses connections with other parties.

**Prerequisite:** A local copy of the [root certificate of your DC/OS CA](/mesosphere/dcos/2.1/security/ent/tls-ssl/get-cert/).
