...
![new DC/OS user](/mesosphere/dcos/2.1/img/1-11-add-user-to-cluster.png)
...
1.  [SSH](/mesosphere/dcos/2.1/administering-clusters/sshcluster/) to a master node and run this command, where `<email>` is the user's email:
