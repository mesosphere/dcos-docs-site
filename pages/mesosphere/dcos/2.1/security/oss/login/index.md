...
DC/OS handles multiple user types. User accounts can be managed via the [IAM API](/mesosphere/dcos/2.1/security/oss/iam-api/); see [User Management](/mesosphere/dcos/2.1/security/oss/user-management/).
