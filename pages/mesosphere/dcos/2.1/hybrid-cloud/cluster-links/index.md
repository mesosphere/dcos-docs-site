...
You must be a superuser or have the appropriate cluster link [permission](/mesosphere/dcos/2.1/security/ent/perms-reference/#cluster-linker) to view, add, and remove links and grant permissions to view linked clusters.
...
1. At the far right of the cluster to switch to, click the vertical ellipsis and select **Switch**.
   ...
   ![swi linked cluster2](/mesosphere/dcos/2.1/img/switch-linked-cluster2.png)
