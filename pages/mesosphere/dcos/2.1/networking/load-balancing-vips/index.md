...
You can use the layer-4 load balancer by assigning a [VIP](/mesosphere/dcos/2.0/networking/load-balancing-vips/virtual-ip-addresses/) in your app definition. After you create a task, or a set of tasks, with a VIP, it will automatically become available to all nodes in the cluster, including the masters.
...
-  You must use a supported [operating system](/mesosphere/dcos/2.0/installing/production/system-requirements/).
...
- [Assign a VIP to your application](/mesosphere/dcos/2.0/networking/load-balancing-vips/virtual-ip-addresses/)
