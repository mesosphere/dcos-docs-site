...
* [app1](/mesosphere/dcos/1.14/tutorials/dcos-101/app1/) deployed and running in your cluster.
...
# Service Discovery
  [Service discovery](/mesosphere/dcos/1.14/networking/) enables addressing of applications independently of where they are running in the cluster, which is particularly useful in cases where applications may fail and be restarted on a different host.
...
# Named Virtual IPs
  ...
  * [Named VIPs](/mesosphere/dcos/1.14/networking/load-balancing-vips/) allow you to assign name/port pairs to your apps, which means you can give your apps meaningful names with a predictable port. They also provide built-in load balancing when using multiple instances of an application.
