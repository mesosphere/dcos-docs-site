...
2. Disable authentication using cloud installation on [AWS](/mesosphere/dcos/1.14/installing/evaluation/community-supported-methods/aws/): You can set the `OAuthEnabled` option to `false` on the **Specify Details** step to disable authentication.
