...
To back up ZooKeeper, follow the guide to back up and restore the [DC/OS ZooKeeper State](/mesosphere/dcos/1.14/administering-clusters/backup-and-restore/backup-restore-cli/#zookeeper).
