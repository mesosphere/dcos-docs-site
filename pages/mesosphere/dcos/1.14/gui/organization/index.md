...
![Users Permissions](/mesosphere/dcos/1.14/img/GUI-Organization-Users-2.png)

Figure 2 - **Permissions** tab

From this page, you can edit the user permissions or delete the user entirely. For more information see the  [Permissions Management](/mesosphere/dcos/1.14/security/ent/perms-management/) documentation.
...
![Group membership](/mesosphere/dcos/1.14/img/GUI-Organization-Users-Group-Membership.png)
...
![Details tab](/mesosphere/dcos/1.14/img/GUI-Organization-Users-Details.png)
...
![Groups tab](/mesosphere/dcos/1.14/img/GUI-Organization-Groups-Main.png)
...
![Groups Permissions](/mesosphere/dcos/1.14/img/GUI-Organization-Groups-Permissions.png)
...
![Groups Users](/mesosphere/dcos/1.14/img/GUI-Organization-Groups-Users.png)
...
For more information on managing groups, see the [Managing Users and Groups](/mesosphere/dcos/1.14/security/ent/users-groups/) documentation.