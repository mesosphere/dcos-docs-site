...
此程序使用身份和访问管理 API (IAM API)。有关 IAM API 的更多详细信息，请访问 [IAM API 文档](/mesosphere/dcos/cn/1.12/security/ent/iam-api/)。
...
1. 为帐户分配所需权限。有关分配权限的详细信息，请访问[权限](/mesosphere/dcos/cn/1.12/security/ent/perms-reference/)文档。
