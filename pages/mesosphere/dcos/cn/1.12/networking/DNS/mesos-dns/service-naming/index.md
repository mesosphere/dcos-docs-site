...
<p class="message--important"><strong>重要信息：</strong>要查询领导管理节点，应始终查询"leader.mesos"，而不是"master.mesos"。如需更多信息，请参阅 <a href="/mesosphere/dcos/cn/1.12/networking/DNS/mesos-dns/troubleshooting/#leader">此 FAQ 条目</a>。</p>
