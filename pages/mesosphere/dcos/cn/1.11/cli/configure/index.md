...
您可以使用 [dcos cluster](/mesosphere/dcos/cn/1.11/cli/command-reference/dcos-cluster/) 和 [dcos config](/mesosphere/dcos/cn/1.11/cli/command-reference/dcos-config/) 命令组访问 DC/OS CLI 配置。
