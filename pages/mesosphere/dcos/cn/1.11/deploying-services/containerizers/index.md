...
- [Universal Container Runtime](/mesosphere/dcos/cn/1.11/deploying-services/containerizers/ucr/)。
- [Docker Engine](/mesosphere/dcos/cn/1.11/deploying-services/containerizers/docker-containerizer/)。
