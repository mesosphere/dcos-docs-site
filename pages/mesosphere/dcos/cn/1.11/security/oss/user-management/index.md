...
![新 DC/OS 用户](/mesosphere/dcos/cn/1.11/img/1-11-add-user-to-cluster.png)
...
1. [SSH](/mesosphere/dcos/cn/1.11/administering-clusters/sshcluster/) 到管理节点并运行此命令，其中 `<email>` 是用户的电子邮件：
...
要退出 DC/OS Web 界面，请单击左上方的用户名，然后选择 **Sign Out**。
 ...
 ![退出](/mesosphere/dcos/cn/1.11/img/1-11-user-drop-down-menu.png)
...
有关安全的更多信息，请检查[安全和身份认证](/mesosphere/dcos/cn/1.11/security/oss/)
