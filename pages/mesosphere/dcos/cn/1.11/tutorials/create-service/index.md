...
## 先决条件
- [DC/OS 集群](/mesosphere/dcos/cn/1.11/installing/)
...
1. 单击 **Single Container**。
 ...
 如需更多信息，请参阅 [使用容器](/mesosphere/dcos/cn/1.11/deploying-services/containerizers/)。

1. 单击 **REVIEW & RUN** 和 **RUN SERVICE**。

 ![在 DC/OS UI 中创建服务](/mesosphere/dcos/cn/1.11/img/deploy-svs-ui.png)

 图 1. 在 Web 界面中创建服务

1. 单击 **Services** 视图中的服务名称，以查看其运行情况并监控运行状况。

 ![在 DC/OS UI 中运行服务](/mesosphere/dcos/cn/1.11/img/svc-running-ui.png)
...
1. 单击 **Container Settings** 选项卡，在 **CONTAINER IMAGE** 字段中输入以下内容：`mesosphere/hello-dcos:<image-tag>`. Replace `<image-tag>` 使用您在步骤 1 中复制的标记。
 ...
 ![DC/OS UI 中的容器化服务](/mesosphere/dcos/cn/1.11/img/deploy-container-ui.png)
...
1. 在 **Services** 选项卡中，单击服务名称，然后选择任务实例之一。单击 **Logs**，然后切换到 **STDERR** 和 **STDOUT** 以查看服务的输出。
 ...
 ![在 DC/OS UI 中运行容器化服务](/mesosphere/dcos/cn/1.11/img/container-running-ui.png)
