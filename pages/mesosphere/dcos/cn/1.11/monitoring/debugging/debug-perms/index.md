...
- [用户帐户](/mesosphere/dcos/cn/1.11/security/ent/users-groups/) 将权限分配给

所有 CLI 命令也可通过 [IAM API](/mesosphere/dcos/cn/1.11/security/ent/iam-api/) 执行。您可以在 [CLI 命令参考部分](/mesosphere/dcos/cn/1.11/cli/command-reference/dcos-security/) 看到更多有关 `dcos security org users` 命令的详细信息。
