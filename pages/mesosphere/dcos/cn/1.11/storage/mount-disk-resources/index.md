...
1. 检查当前代理节点的资源状态。
 ...
 - 在[公共](/mesosphere/dcos/cn/1.11/overview/concepts/#public-agent-node)代理节点上：
...
1. 停止代理节点。
    - 在[专用](/mesosphere/dcos/cn/1.11/overview/concepts/#private-agent-node)代理节点上：
...
![挂载磁盘](/mesosphere/dcos/cn/1.11/img/mount-disk.png)
