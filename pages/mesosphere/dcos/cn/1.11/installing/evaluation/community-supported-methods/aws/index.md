...
<p class="message--warning"><strong>警告: </strong> DC/OS CloudFormation 模板仅供参考，因为以下限制不推荐用于生产用途：</p>
...
安装可以就地升级的生产就绪型 DC/OS 的推荐方法是使用 [安装方法](/mesosphere/dcos/cn/1.11/installing/production/deploying-dcos/installation/)。
[/message]
