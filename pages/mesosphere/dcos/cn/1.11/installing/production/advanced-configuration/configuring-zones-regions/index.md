...
如需更多信息，请参阅 [多分区](/mesosphere/dcos/cn/1.11/installing/production/advanced-configuration/configuring-zones-regions/multi-zone/) 和 [多分域](/mesosphere/dcos/cn/1.11/installing/production/advanced-configuration/configuring-zones-regions/multi-region/) 文档。
 ...
 * 使用 HA 负载均衡器，如 [Marathon-LB](/mesosphere/dcos/services/marathon-lb/)，或内部 [第 4 层负载均衡器](/mesosphere/dcos/cn/1.11/networking/load-balancing-vips/)。
