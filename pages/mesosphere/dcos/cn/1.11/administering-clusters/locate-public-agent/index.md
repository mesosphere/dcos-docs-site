...
- DC/OS 已安装，有至少 1 个管理节点和 [公共代理](/mesosphere/dcos/cn/1.11/overview/concepts/#public-agent-node) 节点
- DC/OS [CLI](/mesosphere/dcos/cn/1.11/cli/) 0.4.6 或更高版本
- [jq](https://github.com/stedolan/jq/wiki/Installation)
- [SSH](/mesosphere/dcos/cn/1.11/administering-clusters/sshcluster/) 已配置
