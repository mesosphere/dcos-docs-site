...
1. 使用以下命令添加对您已添加到每个管理节点的本地 Universe 的指向。
    ...
    ```
    <p class="message--note"><strong>注意: </strong> 如果您需要帮助解析 <tt>master.mesos</tt>，请参阅 <a href="/mesosphere/dcos/1.11/administering-clusters/deploying-a-local-dcos-universe/#installing-your-own-set-of-universe-packages">安装您自己的 Universe 包集合</a>。</p>
