...
- 您只能从 DC/OS Enterprise [备份和恢复 CLI](/mesosphere/dcos/cn/1.11/administering-clusters/backup-and-restore/backup-restore-cli/) 和 [备份和恢复 API](/mesosphere/dcos/cn/1.11/administering-clusters/backup-and-restore/backup-restore-api/) 执行备份和恢复操作。
