...
CLI 在 [dcos cluster setup](/mesosphere/dcos/cn/1.13/cli/command-reference/dcos-cluster/dcos-cluster-setup/) 期间自动安装 Core 插件。
...
当检测 DC/OS EE 群集时，CLI 在 [dcos cluster setup](/mesosphere/dcos/cn/1.13/cli/command-reference/dcos-cluster/dcos-cluster-setup/) 期间自动安装此插件。
...
| [dcos license](/mesosphere/dcos/cn/1.13/cli/command-reference/dcos-license/) | 管理 DC/OS 许可证。 |
...
或者，您可以通过浏览 <a href="https://downloads.dcos.io/cli/index.html">https://downloads.dcos.io/cli/index.html></a> 网页找到这些插件的新版本，并使用 `--update` 命令行选项运行 [dcos plugin add](/mesosphere/dcos/cn/1.13/cli/command-reference/dcos-plugin/dcos-plugin-add/) 命令。
