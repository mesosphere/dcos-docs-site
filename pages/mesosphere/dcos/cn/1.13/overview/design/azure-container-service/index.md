...
有关 DC/OS 更全面的架构描述，请参阅 [DC/OS 架构](/mesosphere/dcos/1.13/overview/architecture/)。

关于更完整的组件讨论，请参阅 [DC/OS 组件](/mesosphere/dcos/1.13/overview/architecture/components/)。
