...
如果您一直密切注意，您可能会大喊“等一下”，因为您注意到应用定义中设置的内存限制为 32 MB，但错误消息提到 64MB。DC/OS 自动为[执行程序](/mesosphere/dcos/1.13/overview/architecture/task-types/#executors)保留一些高开销内存，在本例中为 32 MB。
