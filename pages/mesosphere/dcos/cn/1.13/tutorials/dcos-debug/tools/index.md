...
- [DC/OS Web 界面](#dcos-web-interfaces)
  - [DC/OS Web 界面](#dcos-web-interface)
  - [Mesos Web 界面](#mesos-web-interface)
  - [Zookeeper Web 界面](#zookeeper-web-interface)
- [日志](#logs)
      - [连接到管理节点](#connect-to-master-node)
      - [提高 MESOS 代理节点 10.0.2.219 上的日志级别](#raise-log-level-on-mesos-agent-1002219)
  - [任务/应用程序日志](#taskapplication-logs)
  - [调度器/Marathon 日志](#schedulermarathon-logs)
  - [Mesos 代理节点日志](#mesos-agent-logs)
  - [Mesos 管理节点日志](#mesos-master-logs)
  - [系统日志](#system-logs)
- [度量标准](#metrics)
- [交互式](#interactive)
