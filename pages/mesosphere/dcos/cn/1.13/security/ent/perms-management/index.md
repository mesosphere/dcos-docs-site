...
可以使用 DC/OS Web 界面、[IAM HTTP API](/mesosphere/dcos/1.13/security/ent/iam-api/) 或 [DC/OS Enterprise CLI](/mesosphere/dcos/cn/1.13/cli/enterprise-cli/) 对用户和组应用权限。每个接口提供管理访问控制条目 (ACE) 的方式。每个 ACE 包括以下信息：
