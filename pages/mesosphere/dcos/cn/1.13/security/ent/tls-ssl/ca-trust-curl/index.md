...
**先决条件：**[DC/OS CA 根证书](/mesosphere/dcos/1.13/security/ent/tls-ssl/get-cert/)的本地副本。

如果您没有[设置代理](/mesosphere/dcos/1.13/security/ent/tls-ssl/haproxy-adminrouter/)，您应该使用 `curl` 命令中 `--cacert dcos-ca.crt`。
