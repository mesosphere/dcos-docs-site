...
- 您的[安全模式](/mesosphere/dcos/cn/1.13/security/ent/#security-modes)的适当权限。
  ...
  只要密钥的路径和组的路径[匹配正确](/mesosphere/dcos/cn/1.13/security/ent/#spaces)，服务将能够访问密钥值。

该程序根据您是否要将密钥提供给 [pod](/mesosphere/dcos/cn/1.13/deploying-services/pods/) 或单个服务而有所不同。
