...
## 指定自定义运行状况检查
在安装 DC/OS，之前，必须在 `custom_checks` 安装配置参数中指定自定义运行状况检查。如果您想在安装后修改配置文件，就必须遵循 [DC/OS 升级流程](/mesosphere/dcos/1.13/installing/production/upgrading/)。
...
有关此参数的描述和示例，请参阅 [配置参数文档](/mesosphere/dcos/1.13/installing/production/advanced-configuration/configuration-reference/#custom-checks)。
...
1. [SSH 连接到群集节点](/mesosphere/dcos/1.13/administering-clusters/sshcluster/)。
