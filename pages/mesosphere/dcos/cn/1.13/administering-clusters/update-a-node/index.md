...
* [已安装和配置 SSH](/mesosphere/dcos/1.13/administering-clusters/sshcluster/)。这是通过手动终止代理来删除节点所需的。
* 可访问 [Admin Router 权限](/mesosphere/dcos/1.13/overview/architecture/components/#admin-router)。
...
1. 在代理节点上打开安全外壳 [SSH](/mesosphere/dcos/1.13/administering-clusters/sshcluster/)。
