...
在下面的示例中，建议从安装了 [DC / OS CLI](/mesosphere/dcos/cn/cn/1.13/cli/) 的主机运行应用程序。
...
要安装 DC/OS Enterprise MoM，必须联系 Mesosphere 服务支持以获取 Enterprise MoM 压缩文件，然后使用根 Marathon 进行部署。请参阅 [自定义非本地 Marathon 文档](/mesosphere/dcos/cn/1.13/deploying-services/marathon-on-marathon/advanced/)。
