...
UCR 使用 [Docker v2 registry API](https://docs.docker.com/registry/spec/api/) 获取 Docker 镜像/层。Docker 清单 [v2 schema1](https://docs.docker.com/registry/spec/manifest-v2-1/) 和 [v2 schema2](https://docs.docker.com/registry/spec/manifest-v2-2/) 都受到支持（支持 v2 schema2 从 DC/OS 1.13.0 开始）。
