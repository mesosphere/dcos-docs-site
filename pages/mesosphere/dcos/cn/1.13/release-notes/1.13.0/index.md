...
有关如何使日志记录与 Fluent Bit 整合，请参见 [日志记录](/mesosphere/dcos/cn/1.13/monitoring/logging/)。-->
...
- 用于调配弹性块存储 (EBS) 卷的 Universal 安装工具。(DCOS-47221)
    Universal 安装工具能够调配 Amazon 弹性块存储 (Amazon EBS) 卷，并将其附加到 DC/OS 群集中的专用代理节点。有关部署额外存储卷的详细信息，请参见 [调配额外代理卷](/mesosphere/dcos/cn/services/storage/latest/install/provision-extra-volumes/).
-->
