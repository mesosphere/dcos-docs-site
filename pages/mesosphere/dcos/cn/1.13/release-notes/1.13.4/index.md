...
[button color="light" href="https://downloads.dcos.io/dcos/stable/1.13.4/dcos_generate_config.sh"]下载 DC/OS 开源[/button]
...
- 修复 Docker 1.19 安装前 Docker® 版本检查失败的问题。(DCOS-56831)ß
