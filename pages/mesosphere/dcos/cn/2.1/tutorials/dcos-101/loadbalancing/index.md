...
# 先决条件
* [正在运行的 DC/OS 群集](/mesosphere/dcos/cn/2.1/tutorials/dcos-101/cli/)，[已安装 DC/OS CLI](/mesosphere/dcos/cn/2.1/cli/install/).
* [app2 和 Marathon-LB](/mesosphere/dcos/cn/2.1/tutorials/dcos-101/app2/) 已部署并在您的群集中运行。
...
1. [命名 VIP](/mesosphere/dcos/cn/2.1/networking/load-balancing-vips/)。

您已经在[服务发现](/mesosphere/dcos/cn/2.1/tutorials/dcos-101/service-discovery/)的上下文中探讨了这些负载均衡机制，并且在[之前的](/mesosphere/dcos/cn/2.1/tutorials/dcos-101/marathon-lb/)教程中，您使用 Marathon-LB 公开了 app2。现在让我们再深入探讨一下。
* 首先，将 app2 扩展为两个实例：
...
选择负载均衡机制时，请考虑这些功能和优点。
   ...
   * [命名 VIP](/mesosphere/dcos/cn/2.1/networking/load-balancing-vips/) 是用于内部 TCP 流量的第 4 层负载均衡器机制。由于它们与内核紧密集成，因此它们提供负载均衡的 IP 地址，可以在群集中的任何位置使用。
