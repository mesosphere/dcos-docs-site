...
![Services](/mesosphere/dcos/cn/2.1/img/GUI-Services-Enterprise.png)
...
![排序菜单](/mesosphere/dcos/cn/2.1/img/GUI-Services-Sort-List.png)
...
![Instances](/mesosphere/dcos/cn/2.1/img/services-instances-panel.png)
...
对于带有 UI 的服务，将鼠标悬停在服务名称上并单击 ![open service](/mesosphere/dcos/cn/2.1/img/open-service.png) 查看服务。您可以在  访问 Mesos UI。`<hostname>/mesos`.
...
有关部署服务的更多信息，请参阅 [部署服务和 Pod](/mesosphere/dcos/cn/2.1/deploying-services/) 文档。