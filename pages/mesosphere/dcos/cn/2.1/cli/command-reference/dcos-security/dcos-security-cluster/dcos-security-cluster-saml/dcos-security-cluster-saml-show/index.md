...
| 命令 | 说明 |
|---------|-------------|
| [dcos security cluster saml](/mesosphere/dcos/cn/2.1/cli/command-reference/dcos-security/dcos-security-cluster/dcos-security-cluster-saml//) | 管理您的安全声明标记语言 (SAML) 设置。 |
