...
---
<p class="message--warning"><strong>警告：</strong>从 DC/OS 1.13 开始，使用 <tt>dcos node</tt> 命令列出节点已被弃用。要列出 dcos 节点，请使用 <tt><a href="/mesosphere/dcos/2.1/cli/command-reference/dcos-node/dcos-node-list/">dcos node list</a></tt> 命令。</p>
