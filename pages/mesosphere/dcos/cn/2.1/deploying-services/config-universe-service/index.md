...
1. 使用 [`dcos package describe --config <package-name>`](/mesosphere/dcos/cn/2.1/cli/command-reference/dcos-package/dcos-package-describe/) 命令来查看服务的可用配置选项。
...
如需更多信息，请参阅 [dcos package](/mesosphere/dcos/cn/2.1/cli/command-reference/dcos-package/) 命令参考文档。
