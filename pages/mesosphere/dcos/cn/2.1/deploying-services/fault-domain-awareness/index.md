...
1. [安装 DC/OS ](/mesosphere/dcos/cn/2.1/installing/production/deploying-dcos/installation/).
...
要增加容量，请 [添加新节点](/mesosphere/dcos/cn/2.1/administering-clusters/add-a-node/) 到群集的远程分域或分区，然后更新服务以在相应的一个或多个分域启动实例。
