...
- [用户帐户](/mesosphere/dcos/cn/2.1/security/ent/users-groups/) 将权限分配给

所有 CLI 命令也可通过 [IAM API]执行。(/mesosphere/dcos/cn/2.1/security/ent/iam-api/). 您可以在 [CLI 命令参考部分]`dcos security org users`看到更多有关 (/mesosphere/dcos/cn/2.1/cli/command-reference/dcos-security/). 命令的详细信息。
