...
本指南仅适用于使用 **静态** 管理节点发现的群集，目前不支持 `master_http_loadbalancer`。请参阅 [管理节点发现](/mesosphere/dcos/cn/2.1/installing/production/advanced-configuration/configuration-reference/#master-discovery-required) 的配置参考。
