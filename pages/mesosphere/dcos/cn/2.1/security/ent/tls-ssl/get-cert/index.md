...
如果您的 DC/OS 群集是使用 [自定义外部证书](/mesosphere/dcos/cn/2.1/security/ent/tls-ssl/ar-custom/)，则此部分不适用。在这种情况下，您的客户端可能已经信任证书颁发机构。否则，您的群集管理员会告诉您如何获取和安装证书颁发机构的证书，以便您的客户端信任群集。
...
**先决条件：**您必须已[安装 DC/OS CLI](/mesosphere/dcos/cn/2.1/cli/install/)，以在以下命令中检索群集 URL。
