---
layout: layout.pug
navigationTitle:  授予访问 Marathon 选项卡的权限
...
### 任务详情和日志
  要查看任务详情和日志，您必须授予访问 [Mesos UI] 的权限。(/mesosphere/dcos/cn/2.1/security/ent/gui-permissions/mesos-ui/).
...
### 任务详情和日志
    要查看 Marathon 任务详情和日志，您必须授予访问 [Mesos UI] 的权限。(/mesosphere/dcos/cn/2.1/security/ent/gui-permissions/mesos-ui/).
