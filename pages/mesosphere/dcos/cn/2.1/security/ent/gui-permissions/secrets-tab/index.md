...
<p class="message--note"><strong>注意：</strong>此过程可授予访问<strong>密钥</strong>选项卡的全部用户权限。如果您希望配置更加细分的用户访问权限，请参阅 <a href="/mesosphere/dcos/2.1/security/ent/secrets/use-secrets/">文档</a>.</p>
...
1. 选择要授予权限的用户名或组名。
    ...
    ![添加授予权限的用户或组](/mesosphere/dcos/cn/2.1/img/GUI-Organization-Users-List_VIew-1_12.png)
    图 2. 选择要授予权限的用户或组
