...
# 开始之前
- 必须已安装 DC/OS，并且有至少一个管理节点和至少一个 [公共代理](/mesosphere/dcos/cn/2.1/overview/concepts/#public-agent-node) 节点。
- 必须安装了最新版本的 DC/OS [CLI](/mesosphere/dcos/cn/2.1/cli/)
- 必须安装了 [secure shell (SSH)](/mesosphere/dcos/cn/2.1/administering-clusters/sshcluster/) 并配置为允许远程会话访问群集节点。
