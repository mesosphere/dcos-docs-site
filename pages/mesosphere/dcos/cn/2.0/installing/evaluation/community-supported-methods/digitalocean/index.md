...
<p class="message--warning"><strong>免责声明：</strong>这是 [社区推动的项目]，未正式获得 Mesosphere 支持。这种安装方法用于快速演示和验证概念。本页说明如何在 Terraform 的 DigitalOcean 上安装 DC/OS 群集。仅供参考，不推荐用于生产用途。下列安装方法不支持升级。</p>
...
<p class="message--important"><strong></strong>重要信息：使用此方法就会默认打开网络。因此<a href="/mesosphere/dcos/{{ model.folder_version }}/administering-clusters/securing-your-cluster/#network-security">网络安全</a>令人担忧，管理员应尽快解决。</p>
