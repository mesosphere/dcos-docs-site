...
但是，这并没有说明任务失败的原因。那么接下来进入我们[策略](/mesosphere/dcos/cn/2.0/tutorials/dcos-debug/gen-strat/#agent-strat)的 [第 3 步](/mesosphere/dcos/cn/2.0/tutorials/dcos-debug/gen-strat/)：使用以下命令检查 [Mesos 代理节点日志](/mesosphere/dcos/cn/2.0/tutorials/dcos-debug/tools/#agent-logs)
