...
公共代理节点是位于网络上的代理节点，允许通过群集的 [基础架构网络](/mesosphere/dcos/cn/2.0/overview/concepts/#infrastructure-network 从群集外部进入)。
...
专用代理节点是位于网络上的代理节点，不允许通过群集的 [基础架构网络](/mesosphere/dcos/cn/2.0/overview/concepts/#infrastructure-network) 从群集外部访问。
