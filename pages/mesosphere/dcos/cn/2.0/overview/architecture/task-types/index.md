...
其他调度器可以从 [Mesosphere  {{ model.packageRepo }}](/mesosphere/dcos/cn/2.0/overview/concepts/#mesosphere-universe) 或直接通过 Marathon 安装在 Marathon 上，作为 [调度器服务](/mesosphere/dcos/cn/2.0/overview/concepts/#dcos-scheduler-service)。
