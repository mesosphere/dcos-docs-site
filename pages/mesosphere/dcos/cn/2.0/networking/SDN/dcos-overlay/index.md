...
![虚拟网络地址空间](/mesosphere/dcos/cn/2.0/img/overlay-network-address-space.png)
...
DC/OS 在不同的 [区域](/mesosphere/dcos/cn/2.0/networking/DNS/)提供 FQDN，提供通过可预测的 URL 访问服务的简洁方式。如果使用 DC/OS 覆盖，您应使用 DC/OS DNS 服务提供的 FQDN 之一，以便客户端能够轻松发现服务的位置。
