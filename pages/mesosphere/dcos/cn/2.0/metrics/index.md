...
* **容器：** 关于根据 DC/OS [通用容器运行时](/mesosphere/dcos/cn/2.0/deploying-services/containerizers/ucr/)或 [Docker 引擎](/mesosphere/dcos/cn/2.0/deploying-services/containerizers/docker-containerizer/)运行时中运行的任务进行 `cgroup` 分配的度量标准 。
