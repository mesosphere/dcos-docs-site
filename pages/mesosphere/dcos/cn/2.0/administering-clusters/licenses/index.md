...
配置群集安装时，要指定许可证文件。如需配置群集许可证，创建`genconf/license.txt`文件并加入您在授权支持联系人发送的电子邮件中收到的许可证密钥文本。有关此步骤的更多信息，请参阅 [运行安装程序] 的说明(/mesosphere/dcos/cn/2.0/installing/production/deploying-dcos/installation/)。
