...
1. 要通过 DC/OS CLI 登录，请替换以下 [auth login]`uid` 命令中的 `password` 和 (/mesosphere/dcos/cn/2.0/cli/command-reference/dcos-auth/dcos-auth-login/)
...
本地用户可以使用 [身份和访问管理 (IAM) API]登录。(/mesosphere/dcos/cn/2.0/security/oss/iam-api/).
