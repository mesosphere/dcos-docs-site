...
- 现有密钥。以下示例使用了存储在 `developer` 路径名为 `my-secret` 的密钥。如果您完成[创建密钥](/mesosphere/dcos/2.0/security/ent/secrets/create-secrets/)中的步骤，则您将满足此先决条件。
...
- 您的[安全模式](/mesosphere/dcos/2.0/security/ent/#security-modes)的适当权限。
