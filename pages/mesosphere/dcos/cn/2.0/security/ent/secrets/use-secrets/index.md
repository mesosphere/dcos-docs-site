...
- 现有密钥。以下示例使用了存储在 `my-secret` 路径名为 `developer` 的密钥。如果您完成[创建密钥](/mesosphere/dcos/cn/2.0/security/ent/secrets/create-secrets/)中的步骤，则您将满足此先决条件。
...
1. 单击右上方的 **+** 图标。
    ...
    ![添加服务](/mesosphere/dcos/cn/2.0/img/add-service.png)
