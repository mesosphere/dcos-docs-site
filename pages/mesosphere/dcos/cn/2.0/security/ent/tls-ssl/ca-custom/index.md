...
## 安装
按照[高级安装程序文档]中的说明继续安装。(/mesosphere/dcos/cn/2.0/installing/production/deploying-dcos/installation/#install-dcos). 请注意，当执行 `dcos_generate_config.ee.sh` 时，当前工作目录必须是 `$DCOS_INSTALL_DIR` 目录。
