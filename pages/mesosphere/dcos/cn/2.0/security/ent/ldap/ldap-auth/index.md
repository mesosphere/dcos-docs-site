...
1. 完成输入后，对话框应如下所示。
    ...
    ![简单绑定参数](/mesosphere/dcos/cn/2.0/img/GUI-LDAP-anonymous-simple-bind.png)
...
1. 完成输入后，对话框应如下所示：
    ...
    ![使用搜索绑定的匿名绑定](/mesosphere/dcos/cn/2.0/img/GUI-LDAP-anonymous-search-bind.png)
...
1. 完成输入后，对话框应如下所示。
    ...
    ![简单绑定参数](/mesosphere/dcos/cn/2.0/img/GUI-LDAP-credentials-simple.png)
...
1. 完成输入后，对话框应如下所示：
    ...
    ![使用搜索绑定的 LDAP 凭据](/mesosphere/dcos/cn/2.0/img/GUI-LDAP-credentials-search.png)
