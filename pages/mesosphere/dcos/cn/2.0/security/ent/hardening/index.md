...
- <a name="zk"></a>不要使用默认 ZooKeeper 凭据。而是为以下内容指定长的随机值：[`zk_super_credentials`](/mesosphere/dcos/2.0/installing/production/advanced-configuration/configuration-reference/#zk-superuser)、[`zk_master_credentials`](/mesosphere/dcos/2.0/installing/production/advanced-configuration/configuration-reference/#zk-master) 和 [`zk_agent_credentials`](/mesosphere/dcos/2.0/installing/production/advanced-configuration/configuration-reference/#zk-agent)。
...
- 通过在 config.yml 中 [设置 exhibitor_tls_required](/mesosphere/dcos/2.0/installing/production/advanced-configuration/configuration-reference/#exhibitor-tls-required) 为 `true` 来加强 Exhibitor 服务安全性。如果您的集群已部署，则 Exhibitor 安全性可以 [手动启用](/mesosphere/dcos/2.0/security/ent/tls-ssl/exhibitor)。
