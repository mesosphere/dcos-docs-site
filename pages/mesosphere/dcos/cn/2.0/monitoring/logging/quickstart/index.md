...
使用本指南开始使用 DC/OS 日志记录。此处使用的许多命令在 [CLI 命令参考] 中有更全面的描述(/mesosphere/dcos/2.0/cli/command-reference/dcos-task/)。

**前提条件：**

- 您必须 [安装了] DC/OS 和 DC/OS CLI(/mesosphere/dcos/2.0/installing/)。
