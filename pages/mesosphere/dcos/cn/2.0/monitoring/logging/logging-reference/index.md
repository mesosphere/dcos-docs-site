...
日志记录 API 由 [DC/OS 日志组件] 支持(/mesosphere/dcos/2.0/overview/architecture/components/#dcos-log)，后者在群集中的所有节点上运行。有关使用日志记录 API 的更多信息，请参阅 [日志记录](/mesosphere/dcos/2.0/monitoring/logging/)。关于使用示例，请参阅 [日志记录 API 示例](/mesosphere/dcos/2.0/monitoring/logging/logging-api-examples/)。
