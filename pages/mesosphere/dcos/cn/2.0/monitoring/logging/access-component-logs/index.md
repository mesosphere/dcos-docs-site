...
1. 从**权限**选项卡，选择**添加权限**。
    ...
    ![为用户添加权限](/mesosphere/dcos/cn/2.0/img/GUI-Organization-Users-User_Main_View.png)
...
1. 单击**插入权限字符串**以切换对话框，并粘贴到以下权限中，单击**添加权限**。
    ...
    ![添加权限](/mesosphere/dcos/cn/2.0/img/GUI-Organization-User-Add_Single_User_Perm_String-1_12.png)

    图 3. 权限字符串对话框

    **权限**选项卡现应当是这样的：

    ![prod-group permissions complete](/mesosphere/dcos/cn/2.0/img/GUI-Organization-Users-User_View_w_Perm.png)
