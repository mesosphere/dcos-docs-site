...
![认证包](/mesosphere/dcos/cn/2.0/img/GUI-Catalog-Certified-Services-1_14.png)
...
社区包由 D2iQ 合作伙伴和开源社区的成员贡献。它们没有被 D2iQ 验证为可与 DC/OS 互操作。但是，它们可以提供在认证 {{ model.packageRepo }} 中不可获得的许多功能。新包为定期提供。其中有些包在 [DC/OS 服务文档页面](/mesosphere/dcos/cn/services/) 提供 Mesosphere 特定的文档。

![包](/mesosphere/dcos/cn/2.0/img/GUI-Catalog-Community-Packages-1_14.png)
...
![搜索框](/mesosphere/dcos/cn/2.0/img/GUI-Catalog-Search-1_14.png)
...
1. 从 [服务](/mesosphere/dcos/cn/2.0/gui/services/) 选项卡查看部署的服务。
    ...
    ![服务部署](/mesosphere/dcos/cn/2.0/img/GUI-Services-Running_Services_View-1_12.png)

    图 5 - 服务部署

有关从 {{ model.packageRepo }} 安装、配置和部署服务的更多信息，请参阅 [部署服务文档](/mesosphere/dcos/cn/2.0/deploying-services/#dcos-services)。
