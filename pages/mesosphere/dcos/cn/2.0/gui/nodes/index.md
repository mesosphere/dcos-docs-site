...
有关排空节点的更多信息，请参见 [排空节点](/mesosphere/dcos/2.0/administering-clusters/draining-a-node/)。有关停用节点的更多信息，请参阅关于如何 [关闭和停用节点](/mesosphere/dcos/2.0/administering-clusters/delete-node/) 的文档。
...
有关日志记录的完整详情，请参阅 [日志记录](/mesosphere/dcos/2.0/monitoring/logging/) 文档。您还可以在 [CLI 命令参考](/mesosphere/dcos/2.0/cli/command-reference/dcos-node/dcos-node-log/) 文档中找到用于日志记录的命令行界面命令。
