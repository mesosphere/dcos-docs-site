...
如需更多示例，请参阅 [群集连接](/mesosphere/dcos/2.0/administering-clusters/multiple-clusters/cluster-connections/)。

# 父命令

| 命令 | 说明 |
|---------|-------------|
| [dcos cluster](/mesosphere/dcos/cn/2.0/cli/command-reference/dcos-cluster/) | 管理您的 DC/OS 群集
