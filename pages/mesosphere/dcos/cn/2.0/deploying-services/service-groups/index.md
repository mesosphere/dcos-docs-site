...
可以使用 DC/OS&trade; Web 界面、[API](/mesosphere/dcos/2.0/security/ent/iam-api/) 或 CLI，对服务实施细粒度用户访问 。
...
1. 在**权限字符串**字段中复制并粘贴权限。根据您的[安全模式](/mesosphere/dcos/2.0/security/ent/#security-modes)选择权限字符串。
...
## <a name="root-service-cli"></a>使用 CLI
...
## <a name="service-in-group-ui"></a>使用 DC/OS Web 界面
...
## <a name="service-in-group-cli"></a>使用 CLI
...
## <a name="service-group-ui"></a>使用 DC/OS Web 界面
...
## <a name="service-group-cli"></a>使用 CLI
