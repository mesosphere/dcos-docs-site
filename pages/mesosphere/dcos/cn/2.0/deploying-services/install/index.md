...
使用可选 `--options` 标记指定您在 [高级配置](/mesosphere/dcos/2.0/deploying-services/config-universe-service/)中创建的自定义 JSON 文件的名称。
...
在 DC/OS&trade; UI 中，您可以从 **服务** 或 **{{ model.packageRepo }}** 选项卡安装服务。“{{ model.packageRepo }}”选项卡显示包 [存储库](/mesosphere/dcos/2.0/administering-clusters/package-registry/) 中所有可用的 DC/OS 服务。“服务”选项卡为本地 DC/OS Marathon 实例提供了完整的功能界面。
