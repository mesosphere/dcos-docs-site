...
它还将自动安装 [Core 和 Enterprise CLI 插件](/mesosphere/dcos/1.14/cli/plugins/)。
...
# 示例
有关示例，请参阅 [群集连接](/mesosphere/dcos/1.14/administering-clusters/multiple-clusters/cluster-connections/)。
