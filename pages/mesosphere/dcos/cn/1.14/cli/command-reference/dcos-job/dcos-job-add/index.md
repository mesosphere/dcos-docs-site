...
有关作业示例，请参阅[创建作业](/mesosphere/dcos/1.14/deploying-jobs/examples/#create-job)。

有关如何使用此命令创建作业的信息，请参阅 [添加作业](/mesosphere/dcos/1.14/deploying-jobs/quickstart/#add-a-job-2)。
