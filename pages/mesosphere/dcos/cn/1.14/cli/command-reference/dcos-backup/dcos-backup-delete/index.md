...
查看 [`dcos backup list`](/mesosphere/dcos/1.14/cli/command-reference//dcos-backup/dcos-backup-list/) 的文档，获取备份 ID。
...
| 命令 | 说明 |
|---------|-------------|
| [DCOS 备份](/mesosphere/dcos/1.14/cli/command-reference/dcos-backup/) | 创建、删除、列出、恢复和显示备份命令。 |
