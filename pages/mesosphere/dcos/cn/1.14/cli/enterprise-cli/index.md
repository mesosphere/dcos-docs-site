...
要确认 dcos-enterprise-cli 已安装，请运行 `dcos plugin list`。您可以看到 Enterprise CLI，因为它现在是标准插件。要进行管理，请阅读 [关于 CLI 插件的文档](/mesosphere/dcos/1.14/cli/plugins/)。
...
DC/OS CLI 必须已经是 [已安装](/mesosphere/dcos/1.14/cli/install/)。
