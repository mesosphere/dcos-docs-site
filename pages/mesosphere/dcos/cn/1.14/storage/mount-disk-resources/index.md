...
1. 停止代理节点。
    - 在[专用](/mesosphere/dcos/1.14/overview/concepts/#private-agent-node)代理节点上：

      ```bash
      sudo systemctl stop dcos-mesos-slave.service
      ```

    - 在[公共](/mesosphere/dcos/1.14/overview/concepts/#public-agent-node)代理节点上：
...
![挂载磁盘](/mesosphere/dcos/1.14/img/mount-disk.png)
