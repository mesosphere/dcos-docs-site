...
- 必须安装、配置和登录 [DC/OS CLI](/mesosphere/dcos/1.14/cli/)。
...
<p class="message--important"><strong>重要信息：</strong>以下示例需要进行 journald 任务日志记录，它默认为 [禁用](/mesosphere/dcos/1.14/monitoring/logging/logging-reference/#compatibility)。</p>
