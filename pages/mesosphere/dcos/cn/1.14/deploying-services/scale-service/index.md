...
1. 在 **服务** 选项卡上，单击服务右侧的菜单圆点以访问 **更多操作**。
    ...
    ![菜单](/mesosphere/dcos/1.14/img/GUI-Services-More-Actions_Callout.png)
   
    图 1. 更多操作菜单

2. 从下拉菜单中，选择 **扩展**。

   ![更多操作菜单](/mesosphere/dcos/1.14/img/GUI-Services-More-Actions-Menu.png)
...
4. 在“服务”选项卡上，您可以看到您的服务扩展。
    ...
    ![服务部署](/mesosphere/dcos/1.14/img/GUI-Services-Scale-Confirmation.png)
