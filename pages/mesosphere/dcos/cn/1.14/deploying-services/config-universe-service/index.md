...
本主题介绍如何使用 CLI 来配置服务。您还可以使用 DC/OS UI 中的 [**Services**](/mesosphere/dcos/1.14/gui/services/) 选项卡自定义服务 。

1. 使用 [`dcos package describe --config <package-name>`](/mesosphere/dcos/1.14/cli/command-reference/dcos-package/dcos-package-describe/) 命令来查看服务的可用配置选项。
...
如需更多信息，请参阅 [dcos package](/mesosphere/dcos/1.14/cli/command-reference/dcos-package/) 命令参考文档。
