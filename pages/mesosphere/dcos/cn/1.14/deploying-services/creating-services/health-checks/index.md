...
- Marathon 通过 [REST API](/mesosphere/dcos/1.14/deploying-services/marathon-api/) 提供任务资源的 `health` 成员，您可以将其添加到服务定义中。
...
![GUI 运行状况检查](/mesosphere/dcos/1.14/img/health-check-gui.png)
