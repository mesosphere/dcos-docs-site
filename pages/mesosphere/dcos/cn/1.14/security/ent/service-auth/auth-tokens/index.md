...
您可能需要使用服务帐户配置服务，具体取决于您的 [安全模式](/mesosphere/dcos/1.14/security/ent/#security-modes) 以及服务请求的来源。
...
# RS256 身份认证 JWT 带外验证
DC/OS 服务可使用公钥加密技术代表 [DC/OS Identity and Access Manager (Bouncer)](/mesosphere/dcos/1.14/overview/architecture/components/#dcos-iam) 组件对传入请求进行身份认证。如果客户端显示的认证令牌已由 Bouncer 使用 Bouncer 的私钥和 RS256 算法签名，则此方法有效。
