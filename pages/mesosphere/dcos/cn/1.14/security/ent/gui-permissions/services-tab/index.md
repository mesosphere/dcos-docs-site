...
<p class="message--note"><strong>注意：</strong>此过程可授予访问<strong>服务</strong>选项卡的全部用户权限。如果您希望配置更加细分的用户访问权限，请参阅 <a href="/mesosphere/dcos/1.14/security/ent/secrets/use-secrets/">文档</a>。</p>
