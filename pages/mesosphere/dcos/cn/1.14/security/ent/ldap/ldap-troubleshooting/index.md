...
![无法连接到目录](/mesosphere/dcos/1.14/img/ldap-cannot-open-connection-error.png)
...
![SSL 连接错误](/mesosphere/dcos/1.14/img/ldap-tsl-ssl-socket-error.png)
...
1. 在 **选择 SSL/TLS 设置**下，选择另一个选项。
    ...
    ![SSL/TLS 设置选项](/mesosphere/dcos/1.14/img/ldap-ssl-options.png)
...
![已中止 SSL/TLS 连接](/mesosphere/dcos/1.14/img/ldap-enforced-TLS-error.png)
...
![LDAP 身份认证错误](/mesosphere/dcos/1.14/img/ldap-lookup-DN-error.png)
...
1. 更正 **查找 DN** 和 **查找密码**。
    ...
    ![修改身份认证信息](/mesosphere/dcos/1.14/img/ldap-lookup-dn.png)
...
![未找到 LDAP 用户](/mesosphere/dcos/1.14/img/ldap-user-error.png)
...
1. 选择用户账户。
    ...
    ![在 Active Directory 用户和计算机中选择一个用户](/mesosphere/dcos/1.14/img/ldap-aduc.png)
...
1. 单击 **账户** 选项卡并勾选 **用户登录名称**。
    ...
    ![用户登录账户属性](/mesosphere/dcos/1.14/img/ldap-aduc-account-properties.png)
...
![无效用户凭据](/mesosphere/dcos/1.14/img/ldap-wrong-user-credentials.png)
