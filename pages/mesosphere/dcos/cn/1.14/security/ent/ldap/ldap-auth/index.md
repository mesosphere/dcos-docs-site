...
1. 完成输入后，对话框应如下所示。
    ...
    ![简单绑定参数](/mesosphere/dcos/1.14/img/GUI-LDAP-anonymous-simple-bind.png)

    图 1. “使用简单绑定的匿名绑定”参数 

1. 单击 **Add Directory**。

1. [验证您的连接](/mesosphere/dcos/1.14/security/ent/ldap/ldap-verify/)。
...
1. 完成输入后，对话框应如下所示：
    ...
    ![使用搜索绑定的匿名绑定](/mesosphere/dcos/1.14/img/GUI-LDAP-anonymous-search-bind.png)
...
1. 完成输入后，对话框应如下所示。
    ...
    ![简单绑定参数](/mesosphere/dcos/1.14/img/GUI-LDAP-credentials-simple.png)
...
1. 完成输入后，对话框应如下所示：
    ...
    ![使用搜索绑定的 LDAP 凭据](/mesosphere/dcos/1.14/img/GUI-LDAP-credentials-search.png)
