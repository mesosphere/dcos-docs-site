...
要使用 DC/OS [身份和访问管理 (IAM) API](/mesosphere/dcos/1.14/security/oss/iam-api/) 来添加本地用户账户，请用相应的值替换 `<uid>` 和 `<password>` 并执行以下命令：
...
要使用 [身份和访问管理 (IAM) API](/mesosphere/dcos/1.14/security/oss/iam-api/) 列出所有已配置用户账户，请执行以下命令：
...
要使用 DC/OS [身份和访问管理 (IAM) API](/mesosphere/dcos/1.14/security/oss/iam-api/) 来更改本地用户账户的密码，请用相应的值替换 `<uid>` 和 `<password>` 并执行以下命令：
...
要使用 DC/OS [身份和访问管理 (IAM) API](/mesosphere/dcos/1.14/security/oss/iam-api/) 来删除本地用户账户，请用相应的值替换 `<uid>` 并执行以下命令：
