...
![新 DC/OS 用户](/mesosphere/dcos/1.14/img/1-11-add-user-to-cluster.png)
...
1. [SSH](/mesosphere/dcos/1.14/administering-clusters/sshcluster/) 到主节点并运行此命令，其中 `<email>` 是用户的电子邮件：
