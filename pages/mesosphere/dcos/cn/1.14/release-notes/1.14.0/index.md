---
layout: layout.pug
navigationTitle: 1.14.0 的发行说明
title: 1.14.0 的发行说明
menuWeight: 5
渲染：胡须
型号：/mesosphere/dcos/1.14/data.yml
excerpt: DC/OS 1.14.0 版本注释，包括开源归属和版本策略。
---
DC/OS 1.14.0 于 // 发布。
...
[button color="purple" href="http://downloads.mesosphere.com/dcos-enterprise/stable/1.14.0/dcos_generate_config.ee.sh"]下载 DC/OS Enterprise* [/button]
