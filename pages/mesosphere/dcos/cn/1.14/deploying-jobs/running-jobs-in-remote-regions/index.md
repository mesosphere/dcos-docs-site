...
如 [故障域感知和服务容量扩展] (/mesosphere/dcos/1.14/deploying-services/fault-domain-awareness/)中所述，DC/OS 支持故障域感知。如果您的群集配置在多个区域或分区上，则可以安排 Metronome 作业在远程区域或特定分区中运行。
...
有关如何配置故障域感知群集的说明，请参见[服务的故障域感知和容量扩展] (/mesosphere/dcos/1.14/deploying-services/fault-domain-awareness/) 中的“安装”。
