...
在群集菜单中有以下链接：[群集概述](/mesosphere/dcos/1.14/gui/cluster/)、文档和 CLI 安装。

![DC/OS UI Cluster Menu](/mesosphere/dcos/1.14/img/header-bar-cluster-dropdown-1-12.png)

图 3 -“标题栏群集”菜单

DC/OS Enterprise 中还有用于管理 [链接群集] (/mesosphere/dcos/1.14/administering-clusters/multiple-clusters/cluster-links/)的链接。
...
1. 单击标题栏中的用户名。
    ...
    ![用户名菜单](/mesosphere/dcos/1.14/img/GUI-change-UI-settings-menu-3.png)

    图 5 -“用户名”菜单

1. 从下拉菜单中，选择“英语（更改）”。

    ![下拉菜单](/mesosphere/dcos/1.14/img/GUI-change-UI-language-selector.png)
...
1. 单击 **设置 > UI 设置**。
    ...
    ![UI 设置选项卡](/mesosphere/dcos/1.14/img/GUI-change-UI-settings-menu-1.png)
