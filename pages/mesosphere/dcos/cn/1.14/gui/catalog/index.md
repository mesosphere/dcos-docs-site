...
![认证包](/mesosphere/dcos/1.14/img/GUI-Catalog-Certified-Services-1_14.png)
...
![包](/mesosphere/dcos/1.14/img/GUI-Catalog-Community-Packages-1_14.png)
...
![搜索框](/mesosphere/dcos/1.14/img/GUI-Catalog-Search-1_14.png)

图 3 - 搜索框

# 从 {{ model.packageRepo }} 安装

您可以运行您创建的 DC/OS 服务，或从 {{ model.packageRepo }} 安装包。创建的服务和从 {{ model.packageRepo }} 安装的服务在运行时都会显示在 DC/OS UI 的 [服务](/mesosphere/dcos/1.14/gui/services/) 选项卡上。
...
1. 从 [服务] (/mesosphere/dcos/1.14/gui/services/) 选项卡查看部署的服务。

    ![服务部署](/mesosphere/dcos/1.14/img/GUI-Services-Running_Services_View-1_12.png)

    图 5 - 服务部署

有关安装、配置和部署 {{ model.packageRepo }}服务的更多信息，请参阅 [部署服务文档](/mesosphere/dcos/1.14/deploying-services/#dcos-services)。
