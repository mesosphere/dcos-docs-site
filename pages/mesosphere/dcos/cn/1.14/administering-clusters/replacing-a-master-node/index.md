...
1. 使用 Exhibitor、Guano 实用程序或自定义脚本备份 ZooKeeper 状态信息。
    ...
    有关使用 Guano 实用程序备份 ZooKeeper 的更多信息，请参阅 [如何使用 Guano 备份 ZooKeeper？](/mesosphere/dcos/1.14/installing/installation-faq/#zk-backup)
...
1. 通过在管理节点上运行类似于以下内容的命令，将 DC/OS 身份和访问管理 CockroachDB 数据库备份到文件：
    ...
    有关备份 DC/OS 身份和访问管理 CockroachDB 数据库的更多信息，请参阅 [如何备份 IAM 数据库？](/mesosphere/dcos/1.14/installing/installation-faq/#iam-backup)
...
1. 检查新管理节点是否正常。
    ...
    要验证管理节点替换是否已成功完成，请按照 [升级管理节点] 中所述的步骤来验证升级(/mesosphere/dcos/1.14/installing/production/upgrading/#dcos-masters)。
