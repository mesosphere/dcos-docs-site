...
- [已安装 DC/OS CLI](/mesosphere/dcos/1.14/cli/install/)。
...
1. 使用以下命令 [SSH](/mesosphere/dcos/1.14/administering-clusters/sshcluster/) 至管理节点。将 `<master-IP>` 替换为先前命令中使用的 IP 地址。
...
3. [SSH](/mesosphere/dcos/1.14/administering-clusters/sshcluster/) 至收到这些复制文件的管理节点中
...
1. [SSH 至您的代理节点之一。](/mesosphere/dcos/1.14/administering-clusters/sshcluster/)
