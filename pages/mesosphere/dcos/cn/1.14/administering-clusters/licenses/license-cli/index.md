...
`dcos license` 命令也记录在 [CLI 命令参考](/mesosphere/dcos/1.14/cli/command-reference/dcos-license/) 文档中。

# 先决条件
- 一个 DC/OS Enterprise 群集。
- [DC/OS CLI](/mesosphere/dcos/1.14/cli/install/) 已安装。
- [DC/OS Enterprise CLI](/mesosphere/dcos/1.14/cli/plugins/#enterprise-cli-plugin) 已安装。
