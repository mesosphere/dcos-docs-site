...
<p class="message--important"><strong></strong>重要信息：要查询领导管理节点，应始终查询"leader.mesos"，而不是"master.mesos"。如需更多信息，请参阅<a href="/mesosphere/dcos/1.14/networking/DNS/mesos-dns/troubleshooting/#leader">此 FAQ 条目</a>。</p>
...
**前提条件：** [DC/OS 和 DC/OS CLI](/mesosphere/dcos/1.14/installing/) 已安装。
...
1. SSH 到您的节点。例如，使用以下命令对管理节点执行 [SSH]：
    ...
    如需更多信息，请参阅 SSH [文档](/mesosphere/dcos/1.14/administering-clusters/sshcluster/)。
