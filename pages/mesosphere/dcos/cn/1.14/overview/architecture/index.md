...
![DC/OS 架构层](/mesosphere/dcos/1.14/img/architecture-layers-redesigned.png)
...
如需更多信息，请参阅 [任务类型](/mesosphere/dcos/1.14/overview/architecture/task-types/)。
...
- [组件](/mesosphere/dcos/1.14/overview/architecture/components/)
- [节点类型](/mesosphere/dcos/1.14/overview/architecture/node-types/)
- [主机操作系统](/mesosphere/dcos/1.14/overview/concepts/#host-operating-system)。

## 基础架构层

在基础架构层，您可以在公共云、私有云或本地硬件上安装 DC/OS。其中一些安装目标具有自动配置工具，但几乎所有基础架构都可以使用，只要它包含共享 IPv4 网络上的多个 x86 机器。

如需更多信息，请参阅 [安装](/mesosphere/dcos/1.14/installing/)。
...
- [包存储库](/mesosphere/dcos/1.14/administering-clusters/package-registry/)
- [容器注册表](/mesosphere/dcos/1.14/overview/concepts/#container-registry)
