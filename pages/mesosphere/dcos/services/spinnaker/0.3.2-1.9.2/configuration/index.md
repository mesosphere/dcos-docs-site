...
```bash
curl -O https://ecosystem-repo.s3.amazonaws.com/spinnaker/artifacts/0.3.2-1.9.2/config.tgz && tar -xzf config.tgz && cd config && chmod +x gen-optionsjson
```
...
[<img src="/mesosphere/dcos/services/spinnaker/0.3.2-1.9.2/img/inst05.png" alt="{{ model.techName }} Quick Start"/>](/mesosphere/dcos/services/spinnaker/0.3.2-1.9.2/img/inst05.png)
