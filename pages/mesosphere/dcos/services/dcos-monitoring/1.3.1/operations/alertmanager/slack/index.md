...
See the following example of a basic configuration file that's set up with a Slack receiver.
...
Save `config.yml` into a Git repository, in a folder called `slack`.
