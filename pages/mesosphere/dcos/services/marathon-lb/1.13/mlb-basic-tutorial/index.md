...
1. Identify the public-facing IP address for your public agent node. 
    ...
    For information about how to find your public agent IP address, see [Finding a public agent IP](/mesosphere/dcos/1.13/administering-clusters/locate-public-agent/).
