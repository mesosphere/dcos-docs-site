...
For more information about specifying a virtual host, see [Resolving virtual hosts](./#virtual-hosts). For information about other configuration templates and app labels, see [Marathon-LB reference](/mesosphere/dcos/services/marathon-lb/latest/mlb-reference/).
