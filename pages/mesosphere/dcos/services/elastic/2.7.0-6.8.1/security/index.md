...
For a step-by-step guide on deploying a secure Elastic service check out [Deploying a Secure Elastic Service](/mesosphere/dcos/services/elastic/2.7.0-6.8.1/how-to-guides/secure-elastic).
