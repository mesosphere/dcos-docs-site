...
Due to a currently known [limitation](/mesosphere/dcos/services/elastic/3.1.0-7.4.1/limitations#kibana-configured-with-x-pack-security-enabled), if you installed Kibana with X-Pack Security enabled, you will not be able to access it through the default DC/OS 1.11 UI Service link. In this case you must [expose Kibana using EdgeLB](/mesosphere/dcos/services/elastic/3.1.0-7.4.1/how-to-guides#expose-kibana-using-edgelb).
