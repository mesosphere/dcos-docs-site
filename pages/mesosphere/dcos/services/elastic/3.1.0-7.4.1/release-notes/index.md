...
-   Upgraded Elasticsearch and Kibana to [7.4.1](https://www.elastic.co/guide/en/elasticsearch/reference/7.4/release-notes-7.4.1.html). ([#45](https://github.com/mesosphere/dcos-elastic-service/pull/45) [#47](https://github.com/mesosphere/dcos-elastic-service/pull/47) [#64] (https://github.com/mesosphere/dcos-elastic-service/pull/64)
