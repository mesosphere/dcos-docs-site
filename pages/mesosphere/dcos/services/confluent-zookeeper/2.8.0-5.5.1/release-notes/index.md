...
layout: layout.pug
navigationTitle:
excerpt: Release notes for version 2.8.0-5.5.1
title: Release Notes
menuWeight: 10
...
## New Features
* External Volumes support with Portworx `pxd` and generic drivers like `NetApp`.
* Log-rotate options `stdout_max_size` &`stderr_max_size` are now configurable([#39](https://github.com/mesosphere/confluent-zookeeper/pull/39))

## Updates
- Upgrade the base tech version of Confluent Zookeeper to `5.5.1`. See Confluent Platform `5.5.1` release notes for more details [here](https://docs.confluent.io/5.5.1/release-notes/index.html)
- Updated the SDK to version `0.58.0`. For more information about SDK features, check out the release notes:
