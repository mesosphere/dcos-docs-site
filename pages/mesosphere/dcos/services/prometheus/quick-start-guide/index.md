...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/prom_install.png" alt="Prometheus Install"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/prom_install.png)
...
1. [Install EdgeLB](/mesosphere/dcos/services/edge-lb/latest/getting-started/installing/).
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/prom_dashboard.png" alt="Prometheus Dashboard"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/prom_dashboard.png)
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/prom_graphing.png" alt="Prometheus Graphing"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/prom_graphing.png)
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/grafana_login.png" alt="Grafana Logging"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/grafana_login.png)
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/grafana_datasource.png" alt="Grafana Data Source"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/grafana_datasource.png)
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/grafana_prom.png" alt="Grafana Prom Graph"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/grafana_prom.png)
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/am_dashboard.png" alt="AlertManager Dashboard"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/am_dashboard.png)
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/slack_alert.png" alt="Slack Alerts"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/slack_alert.png)
...
[<img src="/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/pushg.png" alt="PushGateway"/>](/mesosphere/dcos/services/prometheus/0.1.1-2.3.2/img/pushg.png)
