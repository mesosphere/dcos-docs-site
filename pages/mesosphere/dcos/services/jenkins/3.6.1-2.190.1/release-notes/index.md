...
## Improvements
- This is release allows for enforced [Jenkins agent ports](/mesosphere/dcos/services/jenkins/3.6.1-2.190.1/custom-install/index.md#Setting-Jenkins-Agent-Ports).
