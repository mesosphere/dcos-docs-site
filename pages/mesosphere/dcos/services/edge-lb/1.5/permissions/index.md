...
In order for Edge-LB to operate, it must be configured to use a [service account](/mesosphere/dcos/services/edge-lb/1.5/getting-started/installing/#create-a-service-account/).
