...
menuWeight: 50
excerpt: Revert a custom configuration template to defaults
enterprise: true
---

# Description
The `dcos edgelb template delete` command reverts a custom configuration template to the default value.
