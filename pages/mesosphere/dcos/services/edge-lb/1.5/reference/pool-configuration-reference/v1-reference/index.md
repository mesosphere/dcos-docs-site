...
| namespace                   | string   |  true       |                 | The DC/OS&trade; space (sometimes also referred to as a "group"). |
| packageName                 | string   |             |                 |                |
...
| linkBackend     | object  | <ul><li>defaultBackend</li><li>map</li></ul>  | This describes to which backends to send traffic. This can be expressed with a variety of filters such as matching on the hostname or the HTTP URL path.<br />Default: map: []   |   |   |
