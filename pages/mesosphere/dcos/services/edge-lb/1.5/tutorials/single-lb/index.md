...
* Edge-LB is installed following the [Edge-LB Installation](/mesosphere/dcos/services/edge-lb/1.5/getting-started/installing/) instructions.
...
1. Create a [pool configuration](/mesosphere/dcos/services/edge-lb/1.5/pool-configuration/) name `sample-minimal.json`.
