...
* Edge-LB is installed following the [Edge-LB Installation](/mesosphere/dcos/services/edge-lb/1.2/installing/) instructions.
...
1. Create a [pool configuration](/mesosphere/dcos/services/edge-lb/1.2/pool-configuration/) name `sample-minimal.json`.
