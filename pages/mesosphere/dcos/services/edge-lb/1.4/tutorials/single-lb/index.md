...
* Edge-LB is installed following the [Edge-LB Installation](/mesosphere/dcos/services/edge-lb/1.4/getting-started/installing/) instructions.
...
1. Create a [pool configuration](/mesosphere/dcos/services/edge-lb/1.4/pool-configuration/) name `sample-minimal.json`.
