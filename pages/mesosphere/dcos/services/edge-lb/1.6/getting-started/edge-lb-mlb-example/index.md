...
# Before you begin
You must have:
* The Edge-LB API server installed as described in the Edge-LB [installation instructions](/mesosphere/dcos/services/edge-lb/1.6/getting-started/installing).
...
1. Access the `nginx-mlb` service using the public IP address and port specified in the `nginx-mlb.json` file.
    ...
    <p>
    <img src="/mesosphere/dcos/services/edge-lb/1.6/img/Edge-MLB-nginx.png" alt="Welcome page for a service using Marathon-LB">
    </p>
...
1. View the load balancing statistics for the `nginx` service deployed using Marathon-LB using the default HAProxy `stats` port 9090:
    ...
    For example:
    <p>
    <img src="/mesosphere/dcos/services/edge-lb/1.6/img/Edge-HAProxy-stats.png" alt="Statistics for a service exposed using Marathon-LB">
    </p>
...
1. Access the `nginx` service that was exposed through Edge-LB using the public agent IP and the frontend port number.
    ...
    <p>
    <img src="/mesosphere/dcos/services/edge-lb/1.6/img/Edge-LB-welcome-nginx.png" alt="Welcome page for a service using Edge-LB">
    </p>
...
1. View the load balancing statistics for the `nginx` service deployed using Edge-LB using the predefined HAProxy `stats` port 1025:
    ...
    For example:
    <p>
    <img src="/mesosphere/dcos/services/edge-lb/1.6/img/Edge-HAProxy-stats-2.png" alt="Statistics for a service exposed using Edge-LB">
    </p>
