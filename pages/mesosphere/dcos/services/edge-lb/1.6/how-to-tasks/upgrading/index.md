...
For information about what's new or fixed in any release, see the Edge-LB [release notes](/mesosphere/dcos/services/edge-lb/1.6/related-documentation/release-notes/) and [related documentation](/mesosphere/dcos/services/edge-lb/1.6/related-documentation/).
...
1. Expose the packages that are already installed on the running DC/OS cluster:
    ...
    ```
    edgelb-pool-aws: https://downloads.mesosphere.com/edgelb-pool/v1.6.0/assets/stub-universe-edgelb-pool.json
    edgelb-aws: https://downloads.mesosphere.com/edgelb/v1.6.0/assets/stub-universe-edgelb.json
...
1. Install the new `apiserver`:
    ...
    Use the service account you created when you installed the previous version. For more information about creating and configuring permissions for the service account, see [Installing Edge-LB](/mesosphere/dcos/services/edge-lb/1.6/getting-started/installing) and [Service account permissions](/mesosphere/dcos/services/edge-lb/1.6/reference/permissions/#service-account-permission).
