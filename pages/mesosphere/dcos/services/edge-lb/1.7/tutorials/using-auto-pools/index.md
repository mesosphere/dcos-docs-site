...
You can specify the full set of Edge-LB [frontend "link"](/mesosphere/dcos/services/edge-lb/1.7/reference/pool-configuration-reference/v2-reference/#poolhaproxyfrontendlinkbackend) rules. To map only the VHost `example.com` to the application, follow this sample:
