...
For more specific information about the latest supported Edge-LB version and Edge-LB compatibility with the latest releases of DC/OS, see the Edge-LB [version policy](/mesosphere/dcos/services/edge-lb/1.7/related-documentation/version-support/) summary and the [version compatibility matrix](/mesosphere/dcos/version-policy/#dcos-platform-version-compatibility-matrix).
