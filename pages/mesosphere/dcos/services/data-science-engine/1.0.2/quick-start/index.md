...
- Depending on your security mode, {{ model.techName }} requires service authentication for access to DC/OS. See [Provisioning a service account](/mesosphere/dcos/services/data-science-engine/1.0.2/security/#provisioning-a-service-account) for more information.
...
<p class="message--note"><strong>NOTE: </strong> If you are planning to use <a href="/mesosphere/dcos/services/data-science-engine/1.0.2/integrations/hdfs/">HDFS</a> on {{ model.techName }}, you will need a minimum of five nodes.</p>
