...
In the [first part of the tutorial](/mesosphere/dcos/services/kubernetes/2.4.10-1.15.10/getting-started/setting-up/), you will set up your cluster for a successful installation of DC/OS Kubernetes.
