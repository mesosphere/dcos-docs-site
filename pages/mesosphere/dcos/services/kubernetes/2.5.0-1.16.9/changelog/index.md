...
* Calico 3.10.1
* CoreDNS v1.6.5
* Add option to enable AlwaysPullImages Kubernetes admission controller. See [Admission Controllers](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/admission-controllers/) for more details.
* Add option to enable Kubernetes secret encryption. See [Kubernetes secret encryption](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/encrypt-data) for more details.
...
* Add instructions to install [Gatekeeper](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/gatekeeper) and how to use it as a replacement for Kubernetes PodSecurity policies.
...
* dcos-commons 0.57.0
* Adds configuration options for DC/OS Quota support. See [Quota Support](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/quota-support/) for more details.
* Control Plane tasks are now launched with labels that support auto exposure of Kubernetes API via [EdgeLB](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/exposing-the-kubernetes-api-marathonlb-edgelb/)
...
* Fix a few items in the [limitations section](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/limitations/).
...
* Fix the [`etcd` snapshotting](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/troubleshooting/) instructions.
...
* Add a [Storage](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/storage/) page documenting Container Storage Interface (CSI).
...
* Documentation section on how to [upgrade](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/upgrade/#Mesosphere-Kubernetes-Engine) the `kubernetes` package.
...
* Add an [Overview](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/overview/) page explaining in detail what changed since the 1.x series of releases.
* Add a [CLI](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/cli/) page detailing the new Mesosphere Kubernetes Engine CLI.
* Merge `Advanced Installation` page merging its content into [Customizing your Installation](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/customizing-install/).
* Add a [Private Docker Registry](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/private-docker-registry/) page explaining how to configure it.
