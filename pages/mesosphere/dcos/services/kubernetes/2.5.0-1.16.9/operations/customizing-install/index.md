...
See the [Cluster Sizing](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/cluster-sizing/) page for a more detailed explanation.
...
It is possible that the region may not have the resources required, make sure to read and understand [Cluster Sizing](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/operations/cluster-sizing/) before attempting a deployment.
...
![alt text](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/img/tls.png "TLS design")
