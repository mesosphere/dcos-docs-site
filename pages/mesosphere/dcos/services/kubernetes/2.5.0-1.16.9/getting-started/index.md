...
In the [first part of the tutorial](/mesosphere/dcos/services/kubernetes/2.5.0-1.16.9/getting-started/setting-up/), you will set up your cluster for a successful installation of DC/OS Kubernetes.
