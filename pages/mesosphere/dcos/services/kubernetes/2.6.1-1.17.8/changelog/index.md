...
* Calico 3.10.1
* CoreDNS v1.6.5
* Add option to enable AlwaysPullImages Kubernetes admission controller. See [Admission Controllers](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/admission-controllers/) for more details.
* Add option to enable Kubernetes secret encryption. See [Kubernetes secret encryption](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/encrypt-data) for more details.
...
* Add instructions to install [Gatekeeper](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/gatekeeper) and how to use it as a replacement for Kubernetes PodSecurity policies.
...
* dcos-commons 0.57.0
* Adds configuration options for DC/OS Quota support. See [Quota Support](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/quota-support/) for more details.
* Control Plane tasks are now launched with labels that support auto exposure of Kubernetes API via [EdgeLB](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/exposing-the-kubernetes-api-marathonlb-edgelb/)
...
* Kubernetes 1.15.3
* dcos-commons 0.56.3
* Adds [configuration options to enable Kubernetes auditing](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/kubernetes-audit/). Kubernetes auditing provides a security-relevant chronological set of records. These document the sequence of activities that have affected the system by users, administrators or other components of the system.
...
* Fix a few items in the [limitations section](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/limitations/).
...
* Fix the [`etcd` snapshotting](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/troubleshooting/) instructions.
...
* Add a [Storage](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/storage/) page documenting Container Storage Interface (CSI).
...
* Documentation section on how to [upgrade](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/upgrade/#Mesosphere-Kubernetes-Engine) the `kubernetes` package.
...
* Add an [Overview](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/overview/) page explaining in detail what changed since the 1.x series of releases.
* Add a [CLI](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/cli/) page detailing the new Mesosphere Kubernetes Engine CLI.
* Merge `Advanced Installation` page merging its content into [Customizing your Installation](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/customizing-install/).
* Add a [Private Docker Registry](/mesosphere/dcos/services/kubernetes/2.6.1-1.17.8/operations/private-docker-registry/) page explaining how to configure it.
