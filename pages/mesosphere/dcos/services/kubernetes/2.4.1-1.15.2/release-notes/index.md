...
* Before installing `kubernetes-cluster` package `2.4.1-1.15.2`, the `kubernetes` package must be [installed and running](/mesosphere/dcos/services/kubernetes/2.4.1-1.15.2/getting-started/installing-mke/).
...
Known issues and limitations are listed in the [Limitations](/mesosphere/dcos/services/kubernetes/2.4.1-1.15.2/limitations/) page.

## Changelog

See [Changelog](/mesosphere/dcos/services/kubernetes/2.4.1-1.15.2/changelog) for a list of all changes.
