...
When compared with previous versions, DC/OS Kubernetes 2.3.3-1.14.3 brings in a number of important improvements to how Kubernetes clusters are managed, as well as to how they operate.
...
See the [CLI](/mesosphere/dcos/services/kubernetes/2.3.3-1.14.3/cli/) section for documentation on the new CLI.
