...
title: Overview
menuWeight: 20
excerpt: What's new in DC/OS Kubernetes 2.4.9-1.15.10
---

<!-- This source repo for this topic is https://github.com/mesosphere/dcos-kubernetes-cluster -->

When compared with previous versions, DC/OS Kubernetes 2.4.9-1.15.10 brings in a number of important improvements to how Kubernetes clusters are managed, as well as to how they operate.
...
See the [CLI](/mesosphere/dcos/services/kubernetes/2.4.9-1.15.10/cli/) section for documentation on the new CLI.
