...
In the [first part of the tutorial](/mesosphere/dcos/services/kubernetes/2.1.0-1.12.3/getting-started/setting-up/), you will set up your cluster for a successful installation of DC/OS Kubernetes.
