...
title: Overview
menuWeight: 20
excerpt: What's new in DC/OS Kubernetes 2.8.0-1.19.2
---

<!-- This source repo for this topic is https://github.com/mesosphere/dcos-kubernetes-cluster -->

When compared with previous versions, DC/OS Kubernetes 2.8.0-1.19.2 brings in a number of important improvements to how Kubernetes clusters are managed and operate.
...
Accompanying the change is a brand new command-line interface (CLI) that allows for easy management and inspection of Kubernetes clusters.
...
Listing existing Kubernetes clusters is also intuitive:
```bash
...
$ dcos kubernetes cluster list
  ...
  dev/kubernetes01  v1.19.2             stub-universe
  dev/kubernetes02  v1.19.2             stub-universe
```
...
See the [CLI](/mesosphere/dcos/services/kubernetes/2.8.0-1.19.2/cli/) section for documentation on the new CLI.
...
* The `kubernetes-cluster` package has been introduced to represent a single, atomic Kubernetes cluster. It roughly corresponds to the `kubernetes` package available in DC/OS 1.11, and can now be installed multiple times.
...
To make it possible to run multiple private Kubernetes nodes on the same private DC/OS agent, some changes to networking were required.
