...
See [Upgrade](/mesosphere/dcos/services/kubernetes/2.8.0-1.19.2/operations/upgrade/) section to upgrade your Kubernetes cluster to most recent version before continuing.
...
1. See [Upgrade](/mesosphere/dcos/services/kubernetes/2.8.0-1.19.2/operations/upgrade/) section to upgrade your Kubernetes cluster to most recent version before continuing.
...
* `role` specifies the quota enforced role we are migrating towards, which is `dev` in this example.
