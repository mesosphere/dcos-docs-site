...
3. **Moreover, if the [TLS certificate](/mesosphere/dcos/services/kubernetes/2.6.0-1.17.7/operations/connecting-clients/) used by DC/OS is not trusted in your case, you can run the following command to disable TLS verification for the purposes of completing this tutorial:**
...
Now that you have your DC/OS cluster all set up, you are ready to [install the Mesosphere Kubernetes Engine](/mesosphere/dcos/services/kubernetes/2.6.0-1.17.7/getting-started/installing-mke/).
