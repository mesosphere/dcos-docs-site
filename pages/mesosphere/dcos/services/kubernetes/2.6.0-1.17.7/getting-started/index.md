...
In the [first part of the tutorial](/mesosphere/dcos/services/kubernetes/2.6.0-1.17.7/getting-started/setting-up/), you will set up your cluster for a successful installation of DC/OS Kubernetes.
