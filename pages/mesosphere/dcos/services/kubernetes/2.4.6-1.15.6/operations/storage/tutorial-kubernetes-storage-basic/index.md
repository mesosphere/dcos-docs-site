...
The instructions in what follows assume you have `kubectl` access to your Kubernetes cluster being managed by [MKE](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/overview/).
...
![Screenshot of AWS EBS from above "in-use".](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/img/ebs-in-use.png)
...
![Screenshot of AWS EBS from above still "available".](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/img/ebs-available.png)
...
![Screenshot of AWS EBS volume absent from where it had been.](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/img/ebs-missing.png)
...
![Screenshot of AWS EBS volume "available" for newly created volume.](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/img/ebs-pre-provisioned-created.png)
...
![Screenshot of AWS EBS from above "in-use".](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/img/ebs-pre-provisioned-in-use.png)
...
![Screenshot of AWS EBS volume "available" with Retain reclaim policy.](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/img/ebs-pre-provisioned-available-retain.png)
