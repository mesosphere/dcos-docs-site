...
In the [first part of the tutorial](/mesosphere/dcos/services/kubernetes/2.4.6-1.15.6/getting-started/setting-up/), you will set up your cluster for a successful installation of DC/OS Kubernetes.
