...
This section continues on from the instructions given in the [Basic Installation](/mesosphere/dcos/services/kubernetes/2.4.5-1.15.5/getting-started/creating-clusters/) section.
...
See the [Cluster Sizing](/mesosphere/dcos/services/kubernetes/2.4.5-1.15.5/operations/cluster-sizing/) page for a more detailed explanation.
...
It is possible that the region may not have the resources required, make sure to read and understand [Cluster Sizing](/mesosphere/dcos/services/kubernetes/2.4.5-1.15.5/operations/cluster-sizing/) before attempting a deployment.
...
![alt text](/mesosphere/dcos/services/kubernetes/2.4.5-1.15.5/img/tls.png "TLS design")
