...
This section continues on from the instructions given in the [Basic Installation](/mesosphere/dcos/services/kubernetes/2.7.0-1.18.6/getting-started/creating-clusters/) section.
...
See the [Cluster Sizing](/mesosphere/dcos/services/kubernetes/2.7.0-1.18.6/operations/cluster-sizing/) page for a more detailed explanation.
...
It is possible that the region may not have the resources required, make sure to read and understand [Cluster Sizing](/mesosphere/dcos/services/kubernetes/2.7.0-1.18.6/operations/cluster-sizing/) before attempting a deployment.
...
**NOTE:** Multi-Region deployment is not supported, see [Limitations](/mesosphere/dcos/services/kubernetes/2.7.0-1.18.6/limitations/).
...
![alt text](/mesosphere/dcos/services/kubernetes/2.7.0-1.18.6/img/tls.png "TLS design")
