...
The default DC/OS {{ model.techName }} distribution is compiled against Hadoop 2.9 libraries.  However, you can choose a different version by following the instructions in [Customize {{ model.techShortName }} distribution](/mesosphere/dcos/services/spark/2.10.0-2.4.5/install/#custom-dist/).
