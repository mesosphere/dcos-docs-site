...
For more information, see the [Storage](/mesosphere/dcos/2.2/storage/) documents.
...
Detailed instructions for adding, viewing, modifying or removing jobs can be found in the section on [Deploying Jobs](/mesosphere/dcos/2.2/deploying-jobs/quickstart/#managing-jobs-with-the-dcos-ui).
