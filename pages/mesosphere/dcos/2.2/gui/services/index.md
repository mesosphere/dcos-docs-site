...
![Services](/mesosphere/dcos/2.2/img/GUI-Services-Enterprise.png)
...
![Sort menu](/mesosphere/dcos/2.2/img/GUI-Services-Sort-List.png)
...
![Instances](/mesosphere/dcos/2.2/img/services-instances-panel.png)
...
For services with a UI, hover over the service name and click ![open service](/mesosphere/dcos/2.2/img/open-service.png) to view it. You can access the Mesos UI at `<hostname>/mesos`.
...
For more information about deploying services, see the [Deploying Services and Pods](/mesosphere/dcos/2.2/deploying-services/) documentation.