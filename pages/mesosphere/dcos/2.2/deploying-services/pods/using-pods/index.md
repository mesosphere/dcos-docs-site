...
You can create and manage your pods via the DC/OS CLI or via the `/v2/pods/` endpoint of the [Marathon API](/mesosphere/dcos/2.2/deploying-services/marathon-api/).
