...
1. View the available configuration options for the service with the [`dcos package describe --config <package-name>`](/mesosphere/dcos/2.2/cli/command-reference/dcos-package/dcos-package-describe/) command.
...
For more information, see the [dcos package](/mesosphere/dcos/2.2/cli/command-reference/dcos-package/) command reference documentation.
