...
DC/OS agent nodes can be designated as [public](/mesosphere/dcos/2.1/overview/concepts/#public-agent-node) or [private](/mesosphere/dcos/2.1/overview/concepts/#private-agent-node) during [installation](/mesosphere/dcos/2.1/installing/). Public agent nodes provide access from outside of the cluster via infrastructure networking to your DC/OS services. By default, services are launched on private agent nodes and are not accessible from outside the cluster.
...
* DC/OS is [installed](/mesosphere/dcos/2.1/installing/)
* DC/OS CLI is [installed](/mesosphere/dcos/2.1/cli/install/)
...
1.  Create a Marathon app definition with the required `"acceptedResourceRoles":["slave_public"]` parameter specified. For example:
    ...
    For more information about the `acceptedResourceRoles` parameter, see the Marathon API [documentation](/mesosphere/dcos/2.1/deploying-services/marathon-api/).
...
1.  Add your app to Marathon by using this command, where `myApp.json` is the file containing your Marathon app definition.
    ...
    If this is added successfully, there is no output. You can also add your app by using the **Services** tab of the DC/OS [UI](/mesosphere/dcos/2.1/gui/services/).
...
1.  Verify that the app is added with this command:
    ...
    You can also view deployed apps by using the **Services** tab of the DC/OS [UI](/mesosphere/dcos/2.1/gui/services/).
...
1.  Go to your public agent to see the site running. For information about how to find your public agent IP, see the [documentation](/mesosphere/dcos/2.1/administering-clusters/locate-public-agent/).

    You should see the following message in your browser:

    ![Hello Brave World](/mesosphere/dcos/2.1/img/helloworld.png)
