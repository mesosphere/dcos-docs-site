...
- Marathon provides a `health` member of the task resource via the [REST API](/mesosphere/dcos/2.1/deploying-services/marathon-api/) that you can add to your service definition.
...
![GUI health check](/mesosphere/dcos/2.1/img/health-check-gui.png)
