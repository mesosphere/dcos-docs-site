...
See the [system requirements](/mesosphere/dcos/2.2/installing/production/system-requirements/) documentation.
...
To back up ZooKeeper, follow the guide to back up and restore the [DC/OS ZooKeeper State](/mesosphere/dcos/2.2/administering-clusters/backup-and-restore/backup-restore-cli/#zookeeper).
