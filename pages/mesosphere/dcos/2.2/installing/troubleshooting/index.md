...
For example, here is a snippet of the Exhibitor log as it converges to a successful state:
 ...
 [1]: /mesosphere/dcos/{{ model.folder_version }}/installing/production/advanced-configuration/configuration-reference/#exhibitor-storage-backend
 [2]: https://open.mesosphere.com/reference/mesos-master/
 [3]: /mesosphere/dcos/{{ model.folder_version }}/installing/production/advanced-configuration/configuration-reference/
 [4]: /mesosphere/dcos/{{ model.folder_version }}/overview/architecture/boot-sequence/
 [5]: /mesosphere/dcos/{{ model.folder_version }}/installing/production/advanced-configuration/configuration-reference/
 [6]: /mesosphere/dcos/{{ model.folder_version }}/administering-clusters/sshcluster/
