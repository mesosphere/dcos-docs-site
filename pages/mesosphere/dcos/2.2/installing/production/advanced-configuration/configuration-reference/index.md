...
### calico_enabled
Indicates whether to enable the Calico networking support.   See the [Calico](/mesosphere/dcos/{{ model.folder_version }}/networking/SDN/calico) documentation for more details.
The default is `true`.
