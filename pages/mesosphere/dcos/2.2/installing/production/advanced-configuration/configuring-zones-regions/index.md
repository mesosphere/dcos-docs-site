...
For more information, see the [multi-zone](/mesosphere/dcos/2.2/installing/production/advanced-configuration/configuring-zones-regions/multi-zone/) and [multi-region](/mesosphere/dcos/2.2/installing/production/advanced-configuration/configuring-zones-regions/multi-region/) documentation.
 ...
 * Using an HA load balancer like [Marathon-LB](/mesosphere/dcos/services/marathon-lb/latest/), or the internal [Layer 4 load balancer](/mesosphere/dcos/2.2/networking/load-balancing-vips/).
