...
As we learned [earlier](/mesosphere/dcos/2.2/tutorials/dcos-debug/gen-strat/), with application failures the [first step](/mesosphere/dcos/2.2/tutorials/dcos-debug/gen-strat/#task-strat) is to check the [task logs](/mesosphere/dcos/2.2/tutorials/dcos-debug/tools/#task-logs).
...
However, this does not shed much light on why the task failed. So then to [Step 3](/mesosphere/dcos/2.2/tutorials/dcos-debug/gen-strat/#agent-strat) of our [strategy](/mesosphere/dcos/2.2/tutorials/dcos-debug/gen-strat/): check the [Mesos agent logs](/mesosphere/dcos/2.2/tutorials/dcos-debug/tools/#agent-logs) using:
