...
- Running [DC/OS cluster](/mesosphere/dcos/2.2/installing/)
    - 4 private agent nodes
    - 1 public agent node
- Configured [DC/OS CLI](/mesosphere/dcos/2.2/cli/install/)

Note that these exercises require a running [DC/OS cluster](/mesosphere/dcos/2.2/installing/) and a configured [DC/OS CLI](/mesosphere/dcos/2.2/cli/install/). We are also using a cluster with 4 private agents and 1 public agent **that has not been running any prior workloads**. Of course then, your results may vary if using an alternative cluster setup.
