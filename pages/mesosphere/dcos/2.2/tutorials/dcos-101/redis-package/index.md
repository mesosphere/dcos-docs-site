...
# Prerequisites
By now, you should have a running DC/OS cluster and the DC/OS CLI installed and configured. If that isn't the case, please follow the [first](/mesosphere/dcos/2.2/tutorials/dcos-101/cli/) part of this tutorial.
...
# Steps
  ...
  * Let's use Redis by storing a key manually via the redis-cli command
      * [SSH](/mesosphere/dcos/2.2/administering-clusters/sshcluster/) into the node where Redis is running:
...
# Deep Dive
  ...
  You can also add your own repo that includes your custom packages. See the [documentation](/mesosphere/dcos/2.2/administering-clusters/package-registry/) for details.
