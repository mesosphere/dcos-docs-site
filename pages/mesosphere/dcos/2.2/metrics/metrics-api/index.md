...
The Metrics API is backed by [Telegraf](/mesosphere/dcos/2.2/overview/architecture/components/#telegraf), which runs on all nodes in the cluster.

To get started with the DC/OS metrics component and how to use the Metrics API, see the [Metrics Quick Start Guide](/mesosphere/dcos/2.2/metrics/quickstart/).
...
To determine the URL of your cluster, see [Cluster Access](/mesosphere/dcos/2.2/api/access/). The agent ID of a node is its Mesos ID.
...
To authenticate API requests, see [Obtaining an authentication token](/mesosphere/dcos/2.2/security/ent/iam-api/#obtaining-an-authentication-token) and [Passing an authentication token](/mesosphere/dcos/2.2/security/ent/iam-api/#passing-an-authentication-token) documentation. 
...
To assign permissions to your account, see the [permissions reference](/mesosphere/dcos/2.2/security/ent/perms-reference/) documentation.
...
[swagger api='/mesosphere/dcos/2.2/api/metrics.yaml']
