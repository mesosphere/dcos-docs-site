...
To authenticate API requests, see [Obtaining an authentication token](/mesosphere/dcos/2.2/security/ent/iam-api/#obtaining-an-authentication-token) and [Passing an authentication token](/mesosphere/dcos/2.2/security/ent/iam-api/#passing-an-authentication-token).
...
To assign permissions to your account, see the [permissions reference](/mesosphere/dcos/2.2/security/ent/perms-reference/).

# Resources
Mesos-DNS implements a simple REST API for service discovery over HTTP. These examples assume you have an [SSH connection to the node](/mesosphere/dcos/2.2/administering-clusters/sshcluster/).
