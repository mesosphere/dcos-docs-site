...
<p class="message--important"><strong>IMPORTANT: </strong> To query the leading master node, always query "leader.mesos", not "master.mesos". See <a href="/mesosphere/dcos/2.1/networking/DNS/mesos-dns/troubleshooting/#leader">this FAQ entry</a> for more information.</p> 
...
**Prerequisites:** [DC/OS and DC/OS CLI](/mesosphere/dcos/2.1/installing/) are installed.
...
1.  SSH into your node. For example, use this CLI command to SSH to your master:
    ...
    For more information, see the SSH [documentation](/mesosphere/dcos/2.1/administering-clusters/sshcluster/).
