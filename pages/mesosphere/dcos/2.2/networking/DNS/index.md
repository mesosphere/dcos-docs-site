...
See [SRV Records](/mesosphere/dcos/2.2/networking/DNS/mesos-dns/service-naming/#srv-records) for a full description of Mesos DNS SRV records.
...
- For more information on naming tasks and services in Mesos-DNS, see [Task and Service Naming Conventions](/mesosphere/dcos/2.2/networking/DNS/mesos-dns/service-naming/#task-and-service-naming-conventions).
