...
1. To add a service account using the DC/OS [Identity and Access Management (IAM) API](/mesosphere/dcos/2.2/security/oss/iam-api/), generate a RSA private key first using OpenSSL.
...
To list all configured service accounts using the DC/OS [Identity and Access Management (IAM) API](/mesosphere/dcos/2.2/security/oss/iam-api/) execute the following command:
...
To remove a local user account using the DC/OS [Identity and Access Management (IAM) API](/mesosphere/dcos/2.2/security/oss/iam-api/), replace `<uid>` with the corresponding value and execute the following command:
