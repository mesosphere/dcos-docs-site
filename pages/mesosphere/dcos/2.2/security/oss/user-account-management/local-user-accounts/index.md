...
To add a local user account using the DC/OS [Identity and Access Management (IAM) API](/mesosphere/dcos/2.2/security/oss/iam-api/), replace `<uid>` and `<password>` with the corresponding values and execute the following command:
...
To list all configured user accounts using the DC/OS [Identity and Access Management (IAM) API](/mesosphere/dcos/2.2/security/oss/iam-api/), execute the following command:
...
To change a local user account's password using the DC/OS [Identity and Access Management (IAM) API](/mesosphere/dcos/2.2/security/oss/iam-api/) replace `<uid>` and `<password>` with the corresponding values and execute the following command:
...
To delete a local user account using the DC/OS [Identity and Access Management (IAM) API](/mesosphere/dcos/2.2/security/oss/iam-api/), replace `<uid>` with the corresponding value and execute the following command:
