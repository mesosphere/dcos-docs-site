...
The [User account management](/mesosphere/dcos/2.2/security/oss/user-account-management/) documentation covers invocation of available operations in detail.
...
See [Out-of-band token verification](/mesosphere/dcos/2.2/security/oss/authentication/out-of-band-verification/) on how to implement authentication token verification on behalf of the IAM.

# API reference

[swagger api='/mesosphere/dcos/2.2/api/oss-iam.yaml']
