...
See [Configuring services and pods to use secrets](/mesosphere/dcos/2.2/security/ent/secrets/use-secrets/) for information on how to reference these secrets in your app or pod definition.
...
Secrets should include paths, unless you want to allow all services to access its value. See [Spaces](/mesosphere/dcos/2.2/security/ent/#spaces) for more information about secret paths.
...
1. Click the **+** icon in the top right.
    ...
    ![New Secret](/mesosphere/dcos/2.2/img/new-secret.png)
    ...
    ![Create Secret](/mesosphere/dcos/2.2/img/GUI-Secrets-Create-Secret.png)
...
1. In the **ID** box of the **Create New Secret** screen, type the name of your secret and its path, if any.
    ...
    ![Secret ID Keypair](/mesosphere/dcos/2.2/img/GUI-Secrets-Create-New-Keypair.png)
...
1. Type or paste the secret into the **Value** box.
    ![Secret ID/Value Fields](/mesosphere/dcos/2.2/img/GUI-Secrets-Create-New-Keypair.png)
...
Returning to the Secrets screen, you can see that your secret has been deployed.
   ...
   ![Secret deployed](/mesosphere/dcos/2.2/img/GUI-Secrets-Secrets-Keypair-Deployed.png)
...
<p class="message--note"><strong>NOTE: </strong>You must follow the steps in <a href="/mesosphere/dcos/2.2/security/ent/tls-ssl/get-cert/">Obtaining the DC/OS CA bundle</a> before issuing the curl commands in this section.</p>
...
1. Use `dcos auth login` to log into the CLI. You can find more information about this command in the [CLI Reference](/mesosphere/dcos/2.2/cli/command-reference/dcos-auth/dcos-auth-login/).
...
1. In the **ID** box, provide the name of your secret and its path, if any.
    ...
    ![Create New Secret](/mesosphere/dcos/2.2/img/GUI-Secrets-Create-New-Secret.png)
...
Returning to the Secrets screen, you can see that your secret has been deployed.
   ...
   ![Secret deployed](/mesosphere/dcos/2.2/img/GUI-Secrets-Deployed.jpeg)
