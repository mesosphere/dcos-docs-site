...
<p class="message--note"><strong>NOTE: </strong>Read how to <a href="/mesosphere/dcos/2.2/security/ent/tls-ssl/ca-trust-curl/">establish trust in curl commands</a> with DC/OS.</p>
...
When you log in to the [DC/OS CLI](/mesosphere/dcos/2.2/cli/) using `dcos auth login`, it stores the authentication token value locally. You can reference this value as a variable in `curl` commands (discussed in the next section).
...
[swagger api='/mesosphere/dcos/2.2/api/ent-iam.yaml']
