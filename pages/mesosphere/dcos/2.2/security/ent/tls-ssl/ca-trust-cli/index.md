...
<p class="message--note"><strong>NOTE: </strong>This procedure should be unnecessary if you have <a href="/mesosphere/dcos/2.2/security/ent/tls-ssl/haproxy-adminrouter/">set up a proxy</a>.</p>
