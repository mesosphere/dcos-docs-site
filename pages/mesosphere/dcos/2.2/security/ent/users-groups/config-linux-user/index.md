...
The default Linux user of a service or job can vary according to the security mode and the container type. See [Linux users](/mesosphere/dcos/2.1/security/ent/#linux-users) for more information.
...
- You have installed and are logged into the [DC/OS CLI](/mesosphere/dcos/2.1/cli/).
...
1. Deploy the service using the [Marathon API](/mesosphere/dcos/2.1/deploying-services/marathon-api/).
...
<p class="message--note"><strong>NOTE: </strong>Refer to the <a href="/mesosphere/dcos/2.1/deploying-jobs/quickstart/">Jobs documentation</a> for more information about creating and deploying jobs.</p>
