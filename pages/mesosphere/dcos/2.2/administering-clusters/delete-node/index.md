...
If your node has gone down in an unplanned way, you only have to [Decommission the node](/mesosphere/dcos/2.2/administering-clusters/delete-node/#decommission-the-node/).
...
1. [SSH to the agent node](/mesosphere/dcos/2.2/administering-clusters/sshcluster/) you wish to shut down.
