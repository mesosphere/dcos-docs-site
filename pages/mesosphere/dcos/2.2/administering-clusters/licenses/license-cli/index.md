...
The `dcos license` commands are also documented in the [CLI Command Reference](/mesosphere/dcos/2.1/cli/command-reference/dcos-license/) documentation.

# Prerequisites
- A DC/OS Enterprise cluster.
- The [DC/OS CLI](/mesosphere/dcos/2.1/cli/install/) installed.
- The [DC/OS Enterprise CLI](/mesosphere/dcos/2.1/cli/plugins/#enterprise-cli-plugin) installed.
