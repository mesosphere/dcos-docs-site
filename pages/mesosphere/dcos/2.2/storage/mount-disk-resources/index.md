...
1.  Stop the agent.
    - On a [private](/mesosphere/dcos/2.2/overview/concepts/#private-agent-node) agent:

      ```bash
      sudo systemctl stop dcos-mesos-slave.service
      ```

    - On a [public](/mesosphere/dcos/2.2/overview/concepts/#public-agent-node) agent:
...
![Mount disk](/mesosphere/dcos/2.2/img/mount-disk.png)
