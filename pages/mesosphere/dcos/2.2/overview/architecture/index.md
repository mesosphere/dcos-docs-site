...
![DC/OS Architecture Layers](/mesosphere/dcos/2.2/img/architecture-layers-redesigned.png)
...
For more information, see [Task Types](/mesosphere/dcos/2.2/overview/architecture/task-types/).
...
- [Node Types](/mesosphere/dcos/2.2/overview/architecture/node-types/)
- [Host Operating System](/mesosphere/dcos/2.2/overview/concepts/#host-operating-system).
...
For more information, see [Installing](/mesosphere/dcos/2.2/installing/).

## External components

In addition to the software that runs in the datacenter, DC/OS includes and integrates with several external components:

- [GUI](/mesosphere/dcos/2.2/gui/)
- [CLI](/mesosphere/dcos/2.2/cli/)
- [package repository](/mesosphere/dcos/2.2/administering-clusters/package-registry/)
- [container registry](/mesosphere/dcos/2.2/overview/concepts/#container-registry)
