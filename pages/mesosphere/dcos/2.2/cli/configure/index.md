...
You can access DC/OS CLI configuration with the [dcos cluster](/mesosphere/dcos/2.2/cli/command-reference/dcos-cluster/) and [dcos config](/mesosphere/dcos/2.2/cli/command-reference/dcos-config/) command groups.
...
To set the [attached cluster](/mesosphere/dcos/2.2/cli/command-reference/dcos-cluster/dcos-cluster-attach/), set the variable with the command:
