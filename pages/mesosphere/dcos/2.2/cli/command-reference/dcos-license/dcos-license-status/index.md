...
0
```
For more examples, see [Licenses](/mesosphere/dcos/2.2/administering-clusters/licenses/).
...
| Command | Description |
|---------|-------------|
| [dcos license](/mesosphere/dcos/2.2/cli/command-reference/dcos-license/) | Manage DC/OS cluster licenses. |
