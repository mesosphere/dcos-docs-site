...
For job examples, see the [Create a Job](/mesosphere/dcos/2.2/deploying-jobs/examples/#create-job).

For information on how to create a job using this command, see [Add a job](/mesosphere/dcos/2.2/deploying-jobs/quickstart/#add-a-job-2).
