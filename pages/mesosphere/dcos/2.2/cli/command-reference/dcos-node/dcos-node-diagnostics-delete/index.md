...
<p class="message--warning"><strong>WARNING: </strong>This command is deprecated since DC/OS 2.0; please use <a href="/mesosphere/dcos/2.2/cli/command-reference/dcos-diagnostics/dcos-diagnostics-delete/"><tt>dcos diagnostics delete</tt></a> instead.</p>
