...
See the documentation for [`dcos backup list`](/mesosphere/dcos/2.2/cli/command-reference//dcos-backup/dcos-backup-list/) to get the backup ID.
...
| Command | Description |
|---------|-------------|
| [dcos backup](/mesosphere/dcos/2.2/cli/command-reference/dcos-backup/) |  Create, delete, list, restore and show backup commands. |
