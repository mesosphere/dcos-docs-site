...
<tr> 
  <td align=justify style=color:white><strong>Important:</strong> To query the leading master node, always query "leader.mesos", not "master.mesos". See <a href="/mesosphere/dcos/1.11/networking/DNS/mesos-dns/troubleshooting/#leader">this FAQ entry</a> for more information.</td> 
</tr> 
</table>
...
**Prerequisites:** [DC/OS and DC/OS CLI](/mesosphere/dcos/1.11/installing/) are installed.
...
1.  SSH into your node. For example, use this CLI command to SSH to your master:
    ...
    For more information, see the SSH [documentation](/mesosphere/dcos/1.11/administering-clusters/sshcluster/).
...
2.  Run this command from your master node to view the node details:
 ...
 [1]: /mesosphere/dcos/1.11/overview/concepts/
