...
More information about this command can be found in the [Monitoring section](/mesosphere/dcos/1.11/monitoring/debugging/cli-debugging/#dcos-marathon-debug-list).
