...
# Description
The `dcos config show` command allows you to display the DC/OS configuration file contents of the currently [attached cluster](/mesosphere/dcos/1.11/cli/command-reference/dcos-cluster/dcos-cluster-attach/).
