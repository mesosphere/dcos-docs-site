...
This is not currently supported. For more information, see [this document](/mesosphere/dcos/1.11/installing/production/advanced-configuration/configuring-zones-regions/).
...
For more information, see the installation [documentation](/mesosphere/dcos/1.11/installing/).
...
[1]: /mesosphere/dcos/1.11/networking/load-balancing-vips/
[2]: /mesosphere/dcos/1.11/networking/
...
[5]: /mesosphere/dcos/1.11/administering-clusters/convert-agent-type/
