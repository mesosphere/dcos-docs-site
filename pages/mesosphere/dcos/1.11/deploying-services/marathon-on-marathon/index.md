...
# Isolating Resources
DC/OS Enterprise [security features](/mesosphere/dcos/1.11/security/ent/) provide robust fine-grained access control. However, there are situations when you might want a partitioned environment, for example:
