...
1.  If you used the [AWS CloudFormation templates](/mesosphere/dcos/1.11/installing/evaluation/community-supported-methods/aws/) to expose the app to the port specified in your app definition (e.g. port 80), you must reconfigure the health check on the public ELB.
...
1.  Go to your public agent to see the site running. To find your public agent IP address, see [Finding a Public Agent IP](/mesosphere/dcos/1.11/administering-clusters/locate-public-agent/).
...
Learn how to load balance your app on a public node using [Marathon-LB](/mesosphere/dcos/services/marathon-lb/1.12/mlb-basic-tutorial/).
 ...
 [3]: /mesosphere/dcos/1.11/installing/
 [4]: /mesosphere/dcos/1.11/cli/install/
