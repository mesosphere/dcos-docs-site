...
# Networking
Marathon pods only support the [DC/OS Universal container runtime](/mesosphere/dcos/1.11/deploying-services/containerizers/), which supports multiple image formats, including Docker.
...
Below are example environment variables reflecting the [multi-pod JSON pod definition example](/mesosphere/dcos/1.11/deploying-services/pods/examples/#multi-pod).
...
Marathon pods support the [DC/OS Universal container runtime](/mesosphere/dcos/1.11/deploying-services/containerizers/). The Universal container runtime [supports multiple images, such as Docker](http://mesos.apache.org/documentation/latest/container-image/).
