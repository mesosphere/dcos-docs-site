...
This topic provides field definitions and usage examples for pods. For more details on field definitions, see [Marathon Configuration Reference](/mesosphere/dcos/1.11/deploying-services/marathon-parameters/).
...
For an example of a pod that uses a persistent volume, see [Create a pod with a local persistent volume](/mesosphere/dcos/1.11/storage/persistent-volume/#create-a-pod-with-a-local-persistent-volume).
