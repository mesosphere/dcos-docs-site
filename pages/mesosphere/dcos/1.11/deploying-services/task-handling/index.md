...
You can also  [configure Marathon's behavior when a task is unreachable](/mesosphere/dcos/1.11/deploying-services/task-handling/configure-task-handling/).

![Task Handling Flow](/mesosphere/dcos/1.11/img/task-handling-corrected.png)
