...
**Note:**
- New Docker version is supported on CoreOS 1688.5.3. See [compatibility matrix](/mesosphere/dcos/version-policy/) for further information.
- The Kubernetes package dependencies are documented [here](/mesosphere/dcos/services/kubernetes/1.2.0-1.10.5/install).
...
- UCR
  ...
  -  Support for Docker image pull secrets. [View the documentation](/mesosphere/dcos/1.11/deploying-services/containerizers/). An example for Docker credentials is [here](/mesosphere/dcos/1.11/installing/production/deploying-dcos/configuration/examples/#docker-credentials). [enterprise type="inline" size="small" /]
