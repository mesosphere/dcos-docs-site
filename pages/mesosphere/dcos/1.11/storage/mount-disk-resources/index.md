...
3.  Stop the agent.
    - On a [private](/mesosphere/dcos/1.11/overview/concepts/#private-agent-node) agent:

      ```bash
      sudo systemctl stop dcos-mesos-slave.service
      ```

    - On a [public](/mesosphere/dcos/1.11/overview/concepts/#public-agent-node) agent:
...
![Mount disk](/mesosphere/dcos/1.11/img/mount-disk.png)
