...
Please see the [minimum system requirements](/mesosphere/dcos/1.11/installing/production/system-requirements/) and supported CentOS and Redhat Enterprise Linux (RHEL) [versions for your nodes](/mesosphere/dcos/version-policy/#dcos-platform-version-compatibility-matrix/), especially when planning for production environments.
...
![enterprise-Login-Page](/mesosphere/dcos/1.11/img/dcos-ee-login.png)



If you installed DC/OS Open Source, select the OAuth provider of your choice. [oss type="inline" size="small" /]

![oss-login-page](/mesosphere/dcos/1.11/img/dcos-oe-login.png)
