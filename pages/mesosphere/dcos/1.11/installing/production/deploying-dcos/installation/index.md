...
The DC/OS installation process requires a bootstrap node, master node, public agent node, and a private agent node. You can view the [nodes](/mesosphere/dcos/1.11/overview/concepts/#node) documentation for more information.
...
![Production Installation Process](/mesosphere/dcos/1.11/img/advanced-installer.png)
...
| `/var/lib/dcos/exhibitor/zookeeper`     | Contains the [ZooKeeper](/mesosphere/dcos/1.11/overview/concepts/#exhibitor-zookeeper) data.                                                                   |
...
## Prerequisites
Before installing DC/OS, your cluster must meet the software and hardware [requirements](/mesosphere/dcos/1.11/installing/production/system-requirements/).
...
Create a [license file](/mesosphere/dcos/1.11/administering-clusters/licenses/) containing the license text received in email sent by your Authorized Support Contact and save as `genconf/license.txt`.
...
If your servers are installed with a domain name in your `/etc/resolv.conf`, add the `dns_search` parameter. For parameter descriptions and configuration examples, see the [documentation](/mesosphere/dcos/1.11/installing/production/advanced-configuration/configuration-reference/).
...
<p class="message--important"><strong>IMPORTANT: </strong>Do not install DC/OS until you have these items working: <code>ip-detect script</code>, <code>DNS</code>, and <code>NTP</code> on all DC/OS nodes with time synchronized. See <a href="/mesosphere/dcos/1.11/installing/troubleshooting/">troubleshooting</a> for more information.</p>
<p class="message--note"><strong>NOTE: </strong>If something goes wrong and you want to rerun your setup, use the cluster <a href="/mesosphere/dcos/1.11/installing/production/uninstalling/">uninstall</a> instructions.</p>
...
![Exhibitor for ZooKeeper](/mesosphere/dcos/1.11/img/chef-zk-status.png)
...
![Login screen](/mesosphere/dcos/1.11/img/ui-installer-auth2.png)
...
![UI dashboard](/mesosphere/dcos/1.11/img/dashboard-ee.png)
...
- [Assign user roles][7].
- [System Requirements](/mesosphere/dcos/1.11/installing/production/system-requirements/)
...
[1]: /mesosphere/dcos/1.11/installing/production/system-requirements/
[2]: /mesosphere/dcos/1.11/overview/concepts/#public
[3]: /mesosphere/dcos/1.11/overview/concepts/#private
[5]: /mesosphere/dcos/1.11/img/ui-installer-auth2.png
[6]: /mesosphere/dcos/1.11/img/dashboard-ee.png
[7]: /mesosphere/dcos/1.11/security/ent/users-groups/
[8]: /mesosphere/dcos/1.11/security/ent/users-groups/
[9]: /mesosphere/dcos/1.11/cli/install/
[12]: /mesosphere/dcos/1.11/installing/production/deploying-dcos/node-cluster-health-check/
[10]: /mesosphere/dcos/1.11/installing/troubleshooting/
[11]: /mesosphere/dcos/1.11/installing/production/uninstalling/
