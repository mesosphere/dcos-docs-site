...
<p class="message--warning"><strong>DISCLAIMER: </strong>This is a community driven project and not officially supported by D2IQ. This installation method is used for fast demos and proofs of concept. This page explains how to install DC/OS cluster on DigitalOcean. It is intended for reference only and is not recommended for production use. Upgrades are not supported with the following installation methods.</p>
