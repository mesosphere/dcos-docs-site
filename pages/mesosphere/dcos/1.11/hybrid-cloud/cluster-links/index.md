...
You must be a superuser or have the appropriate cluster link [permission](/mesosphere/dcos/1.11/security/ent/perms-reference/#cluster-linker) to view, add, and remove links and grant permissions to view linked clusters.
