 ...
 * Using an HA load balancer like [Marathon-LB](/mesosphere/dcos/services/marathon-lb/1.12/), or the internal [Layer 4 load balancer](/mesosphere/dcos/1.11/networking/load-balancing-vips/).
