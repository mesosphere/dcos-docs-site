...
![new DC/OS user](/mesosphere/dcos/1.11/img/1-11-add-user-to-cluster.png)
...
1.  [SSH](/mesosphere/dcos/1.11/administering-clusters/sshcluster/) to a master node and run this command, where `<email>` is the user's email:
...
1.   To log out of the DC/OS web interface, click on your username in the upper-left side and select **Sign Out**.
        ...
        ![log out](/mesosphere/dcos/1.11/img/1-11-user-drop-down-menu.png)
...
For more information on security, check out [Security and Authentication](/mesosphere/dcos/1.11/security/oss/)
