...
The intended status of the seal is persisted, so after sealing the store the restart of `dcos-secrets` will not unseal it - only the steps depicted in [unsealing the store](/mesosphere/dcos/1.11/security/ent/secrets/unseal-store/) will.
