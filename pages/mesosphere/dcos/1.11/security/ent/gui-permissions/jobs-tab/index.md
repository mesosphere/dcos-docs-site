...
You can grant users access to the [**Jobs** screen](/mesosphere/dcos/1.11/gui/jobs/). By default, new users have no permissions.

**Note:** This procedure grants full user access to the **Jobs** screen and all the jobs inside of it. If you are running in `strict` or `permissive` [security mode](/mesosphere/dcos/1.11/security/ent/#security-modes) and want to configure fine-grained user access, see the [documentation](/mesosphere/dcos/1.11/deploying-services/service-groups/).
