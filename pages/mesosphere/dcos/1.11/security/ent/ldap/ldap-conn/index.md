...
1.  Click **Add Directory**.
   ...
   ![Add Directory dialog](/mesosphere/dcos/1.11/img/ldap-add-dir-conn.png)
...
1.  Specify your authentication method and parameters, as discussed in the [authentication section](/mesosphere/dcos/1.11/security/ent/ldap/ldap-auth/).
