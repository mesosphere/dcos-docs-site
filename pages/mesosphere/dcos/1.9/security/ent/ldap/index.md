...
**Important:** Review the DC/OS user ID requirements in [Managing users and groups](/mesosphere/dcos/1.9/security/ent/users-groups/).

**Requirement** The directory server must support [LDAP 3](https://tools.ietf.org/html/rfc4511).

To set up an LDAP connection:

1. [Configure your connection](/mesosphere/dcos/1.9/security/ent/ldap/ldap-conn/).

2. [Configure your authentication](/mesosphere/dcos/1.9/security/ent/ldap/ldap-auth/).

3. [Verify the connection](/mesosphere/dcos/1.9/security/ent/ldap/ldap-verify/).
