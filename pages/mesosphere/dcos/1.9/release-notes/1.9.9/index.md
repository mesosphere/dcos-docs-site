...
- Introduce various secrets improvements. For more information, see the [secrets documentation](/mesosphere/dcos/1.9/security/ent/secrets/). [enterprise type="inline" size="small" /]
...
- DCOS-14021 - [Task logging to `journald`](/mesosphere/dcos/1.9/monitoring/logging/) is disabled by default. Task logs will continue to be written to their sandboxes, and logrotated out. The `dcos task log` command is an active command.
- DCOS-16737 - You cannot [generate and publish AWS Advanced Templates](/mesosphere/dcos/1.9/installing/ent/cloud/aws/advanced/#create-your-templates) to AWS GovCloud regions. [enterprise type="inline" size="small" /]
