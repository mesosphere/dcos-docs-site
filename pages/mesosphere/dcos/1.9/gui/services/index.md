...
![Services](/mesosphere/dcos/1.9/img/services-ee.gif)
...
*   **STATUS** The [Marathon health check](/mesosphere/dcos/1.9/deploying-services/creating-services/health-checks/) status for the service.
...
For services with a web interface, hover over the service name and click ![open service](/mesosphere/dcos/1.9/img/open-service.png) to view it.
