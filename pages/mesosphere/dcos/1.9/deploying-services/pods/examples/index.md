...
This topic provides field definitions and usage examples for pods. For more details on field definitions, see [Marathon Configuration Reference](/mesosphere/dcos/1.9/deploying-services/marathon-parameters/).
