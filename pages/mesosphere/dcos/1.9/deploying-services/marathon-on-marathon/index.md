---
layout: layout.pug
navigationTitle:  Using a Custom Marathon
...
# Isolating Resources
DC/OS Enterprise [security features](/mesosphere/dcos/1.9/security/ent/) provide robust fine-grained access control. However, there are situations when you might want a partitioned environment, for example: 
