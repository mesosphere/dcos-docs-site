...
The [DC/OS graphical user interface (GUI)](/mesosphere/dcos/1.9/gui/) is an interface for remotely controlling and managing a DC/OS cluster from a web browser. The GUI is also sometimes called the DC/OS UI or DC/OS web interface.

# <a name="dcos-cli"></a>DC/OS CLI

The [DC/OS command line interface (CLI)](/mesosphere/dcos/1.9/cli/) is an interface for remotely controlling and managing a DC/OS cluster from a terminal.
...
For more information, see [Network Security](/mesosphere/dcos/1.9/administering-clusters/) and [Adding Agent Nodes](/mesosphere/dcos/1.9/administering-clusters/add-a-node/).
...
For more information, see [Converting Agent Node Types](/mesosphere/dcos/1.9/administering-clusters/convert-agent-type/).
...
- If a bootstrap machine is not required for managing master node IP changes or as an SSH jumpbox, it can be shut down after bootstrapping and spun up on demand to [add new nodes](/mesosphere/dcos/1.9/administering-clusters/add-a-node/) to the cluster.

For more information, see the [system requirements](/mesosphere/dcos/1.9/installing/oss/custom/system-requirements/#bootstrap-node).
...
For more information, see [Cloud Installation Options](/mesosphere/dcos/1.9/installing/oss/cloud/).
