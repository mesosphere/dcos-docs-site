...
You can grant users access to the [**{{ model.packageRepo }}** ](/mesosphere/dcos/2.0/gui/catalog/) tag. By default, new users have no permissions.

<p class="message--note"><strong>NOTE: </strong>This procedure grants full user access to the <strong>Catalog</strong> screen. If you want to configure fine-grained user access, see the <a href="/mesosphere/dcos/2.0/deploying-services/service-groups/">documentation</a>.</p>
