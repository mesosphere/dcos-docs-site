...
- An external [LDAP directory](/mesosphere/dcos/2.0/security/ent/ldap/).
- An [OpenID Connect or SAML provider](/mesosphere/dcos/2.0/security/ent/sso/).
...
6. When completed, the LDAP group import configuration dialog appears as shown in Figure 1.
   ...
   ![LDAP Group Import Configuration](/mesosphere/dcos/2.0/img/ldap-group-import.png)
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/mesosphere/dcos/2.0/security/ent/iam-api/) endpoint.
...
- You must follow the steps in [Obtaining the root certificate of your DC/OS CA](/mesosphere/dcos/2.0/security/ent/tls-ssl/get-cert/) before issuing the curl commands in this section.
