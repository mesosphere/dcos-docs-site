...
A DC/OS Authentication token is also used internally by the [DC/OS CLI](/mesosphere/dcos/2.0/cli/) for authenticating subsequent CLI commands. Authentication is only supported for DC/OS CLI version 0.4.3 and later.
