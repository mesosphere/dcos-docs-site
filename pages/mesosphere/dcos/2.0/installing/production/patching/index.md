...
- To update to a newer major or minor version (e.g. 1.11 to 1.12), refer to the instructions for [upgrading](/mesosphere/dcos/2.0/installing/production/upgrading/).
...
This procedure patches a DC/OS 1.12 cluster without changing the cluster's [security mode](/mesosphere/dcos/2.0/installing/production/advanced-configuration/configuration-reference/#security-enterprise).
...
This procedure patches to DC/OS 1.12 in strict [security mode](/mesosphere/dcos/2.0/installing/production/advanced-configuration/configuration-reference/#security-enterprise).
