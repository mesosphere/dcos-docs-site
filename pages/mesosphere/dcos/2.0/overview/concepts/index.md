...
The [DC/OS graphical user interface (GUI)](/mesosphere/dcos/2.0/gui/) is an interface for remotely controlling and managing a DC/OS cluster from a web browser. The GUI is also sometimes called the DC/OS UI or DC/OS web interface.

<a name="dcos-cli"></a>

## DC/OS CLI

The [DC/OS command line interface (CLI)](/mesosphere/dcos/2.0/cli/) is an interface for remotely controlling and managing a DC/OS cluster from a terminal.
...
For more information, see [Network Security](/mesosphere/dcos/2.0/administering-clusters/) and [Adding Agent Nodes](/mesosphere/dcos/2.0/administering-clusters/add-a-node/).
...
For more information, see [Converting Agent Node Types](/mesosphere/dcos/2.0/administering-clusters/convert-agent-type/).
...
A Marathon service consists of zero or more containerized service instances. Each service instance consists of one or more containerized Apache Mesos tasks.
...
For more information about deploying using a cloud template, see [Mesosphere installation methods](/mesosphere/dcos/2.0/installing/evaluation/).

<a name="mesos-concepts"></a>

# Mesos concepts

The following terms are contextually correct when discussing Apache Mesos, but may be hidden by other abstraction within DC/OS.
...
For more information, see the [Mesos-DNS documentation](/mesosphere/dcos/2.0/networking/DNS/mesos-dns/).
