...
![Mesosphere DC/OS Enterprise Components](/mesosphere/dcos/2.0/img/dcos-components-1-13.png)
...
Mesos manages resources and tasks as a distributed systems kernel. Mesos Master exposes scheduler, executor, and operator interfaces to facilitate cluster management. Mesos Agent manages individual executors, tasks, and resources on each [DC/OS agent node](/mesosphere/dcos/2.0/overview/concepts/#dcos-agent-node). Mesos Agent Public is a Mesos Agent configured to run on [DC/OS public agent nodes](/mesosphere/dcos/2.0/overview/concepts/#public-agent-node).
...
- [Documentation](/mesosphere/dcos/2.0/installing/)
...
- [Documentation](/mesosphere/dcos/2.0/administering-clusters/backup-and-restore/)
- [API Reference](/mesosphere/dcos/2.0/administering-clusters/backup-and-restore/backup-restore-api/)
...
- [Documentation](/mesosphere/dcos/2.0/gui/)
...
- [Documentation](/mesosphere/dcos/2.0/cli/)
...
- [Documentation](/mesosphere/dcos/2.0/deploying-services/)
- [Source](https://github.com/mesosphere/marathon)
- [API Reference](/mesosphere/dcos/2.0/deploying-services/marathon-api/)
...
- [Documentation](/mesosphere/dcos/2.0/deploying-jobs/)
...
- [API Reference](/mesosphere/dcos/2.0/monitoring/#system-health-http-api-endpoint)
...
- [API Reference](/mesosphere/dcos/2.0/monitoring/logging/logging-reference/)
...
- [API Reference](/mesosphere/dcos/2.0/metrics/metrics-api/)

<a name="dcos-signal"></a>

## DC/OS signal

The DC/OS signal service reports cluster telemetry and analytics to help improve DC/OS. Administrators can [opt out of telemetry](/mesosphere/dcos/2.0/installing/production/deploying-dcos/opt-out/#telemetry) at installation time.
...
- [Documentation](/mesosphere/dcos/2.0/networking/DNS/mesos-dns)
- [Source](https://github.com/mesosphere/mesos-dns)
- [API Reference](/mesosphere/dcos/2.0/networking/DNS/mesos-dns/mesos-dns-api/)
...
The DC/OS package manager (Cosmos) installs and manages DC/OS packages from [DC/OS package repositories](/mesosphere/dcos/2.0/administering-clusters/package-registry/), such as the [Mesosphere {{ model.packageRepo }}](https://github.com/mesosphere/universe).
...
- [API Reference](/mesosphere/dcos/2.0/deploying-services/package-api/)
...
- [API Reference](/mesosphere/dcos/2.0/administering-clusters/component-management/)
...
- [Documentation](/mesosphere/dcos/2.0/security/)
- [API Reference](/mesosphere/dcos/2.0/security/ent/iam-api/)
...
- [Documentation](/mesosphere/dcos/2.0/security/ent/tls-ssl/)
- [API Reference](/mesosphere/dcos/2.0/security/ent/tls-ssl/ca-api/)
...
- [Documentation](/mesosphere/dcos/2.0/security/ent/secrets/)
- [API Reference](/mesosphere/dcos/2.0/security/ent/secrets/secrets-api/)
...
Most DC/OS components run as [systemd services](/mesosphere/dcos/2.0/overview/concepts/#systemd-service) on the DC/OS nodes.
