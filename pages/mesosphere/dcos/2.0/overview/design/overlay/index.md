...
![Agent configuration for containers running on `MesosContainerizer` and Docker once the VxLAN has been configured.](/mesosphere/dcos/2.0/img/overlay-in-action-redesigned.png)
