...
* **Container:** Metrics about `cgroup` allocations from tasks running in the DC/OS [Universal Container Runtime](/mesosphere/dcos/2.0/deploying-services/containerizers/ucr/) or [Docker Engine](/mesosphere/dcos/2.0/deploying-services/containerizers/docker-containerizer/) runtime.
