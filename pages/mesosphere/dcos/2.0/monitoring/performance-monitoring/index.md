...
Here are some recommendations for monitoring a DC/OS&reg; cluster. You can use any monitoring tools. The endpoints listed below will help you troubleshoot when issues occur.
