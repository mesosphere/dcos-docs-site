...
- Fixed an issue with external persistent volumes in Marathon when a container stops/starts on another node than the original one, the task failed. (COPS-5920) 
