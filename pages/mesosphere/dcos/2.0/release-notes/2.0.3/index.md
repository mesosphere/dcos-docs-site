...
<p class="message--warning"><strong>WARNING: </strong>The DC/OS 2.0.3 release has a critical error in Metronome where existing jobs are lost after upgrade. We recommend that you do NOT download or upgrade to it. Instead, download and upgrade to the 2.0.2 release <a href="https://docs.d2iq.com/mesosphere/dcos/2.0/release-notes/2.0.2/">here</a>.</p>
