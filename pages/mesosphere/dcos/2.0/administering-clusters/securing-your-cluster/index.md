...
- from external machines to public agent nodes: block connection requests on all ports except [advertised port ranges](/mesosphere/dcos/1.14/installing/production/system-requirements/ports/#agent).
...
If you run HAProxy in front of Admin Router, you should secure the communication between them. For information about securing your communication, see the [documentation](/mesosphere/dcos/1.14/security/ent/tls-ssl/haproxy-adminrouter/).
...
![Security Zones](/mesosphere/dcos/1.14/img/security-zones.jpg)
