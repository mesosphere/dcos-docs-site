...
You connect to multiple DC/OS clusters using [dcos cluster](/mesosphere/dcos/2.0/cli/command-reference/dcos-cluster/) commands.
...
- UNCONFIGURED : the cluster was not set up locally (i.e., the cluster is [linked](/mesosphere/dcos/2.0/administering-clusters/multiple-clusters/cluster-links/) to the currently attached cluster).
