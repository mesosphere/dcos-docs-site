...
Services you create yourself are administered by Marathon and can be configured and run [from the DC/OS CLI](/mesosphere/dcos/2.0/cli/command-reference/) with `dcos marathon` subcommands (for example, `dcos marathon app add <myapp>.json`) or through the DC/OS web interface.
