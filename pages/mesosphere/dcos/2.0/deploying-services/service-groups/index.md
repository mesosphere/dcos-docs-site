...
[Marathon permissions](/mesosphere/dcos/2.0/security/ent/perms-reference/#marathon-metronome) and [Mesos permissions](/mesosphere/dcos/2.0/security/ent/perms-reference/#mesos) do not distinguish between service names, job names, service groups, or job groups. Therefore your naming must be unique.
