...
**Note:** DC/OS 1.10.6 release supports new CoreOS and Docker versions on RHEL listed in the [compatibility matrix](/mesosphere/dcos/version-policy/#compatibility-matrix).
