...
*   [SSH installed and configured](/mesosphere/dcos/1.10/administering-clusters/sshcluster/). This is required when removing nodes by manually killing agents.
*   Access to the [Admin Router permissions](/mesosphere/dcos/1.10/overview/architecture/components/#admin-router).
...
1.  [SSH to the agent nodes](/mesosphere/dcos/1.10/administering-clusters/sshcluster/).
1.  Stop the agents.
