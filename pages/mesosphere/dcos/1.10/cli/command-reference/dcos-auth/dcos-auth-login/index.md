...
# Description
Authenticate to DC/OS. The [dcos cluster setup](/mesosphere/dcos/1.10/cli/command-reference/dcos-cluster/dcos-cluster-setup/) command also runs `dcos auth login`.
