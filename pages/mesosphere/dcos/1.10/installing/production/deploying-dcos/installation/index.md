...
<p class="message--note"><strong>NOTE: </strong>You can also use <a href="/mesosphere/dcos/1.10/installing/evaluation/">Universal Installer</a> to deploy DC/OS on AWS, Azure, or GCP in production.</p>
