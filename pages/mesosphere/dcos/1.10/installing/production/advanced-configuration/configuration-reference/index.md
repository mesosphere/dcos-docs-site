...
|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| [agent_list](#agent-list)                                              | A YAML nested list (`-`) of IPv4 addresses to your [private agent](/mesosphere/dcos/1.10/overview/concepts/#private-agent-node) host names. |
...
| [aws_template_storage_bucket](#aws-template-storage-bucket)                | The name of an S3 bucket to contain [customized advanced AWS templates](/mesosphere/dcos/1.10/installing/evaluation/community-supported-methods/aws/advanced/#create-your-templates). |
...
| [public_agent_list](#public-agent-list)                               | A YAML nested list (`-`) of IPv4 addresses to your [public agent](/mesosphere/dcos/1.10/overview/concepts/#public-agent-node) host names.  |
...
### agent_list
A YAML nested list (`-`) of IPv4 addresses to your [private agent](/mesosphere/dcos/1.10/overview/concepts/#private-agent-node) host names.
...
The name of an S3 bucket to contain [customized advanced AWS templates](/mesosphere/dcos/1.10/installing/evaluation/community-supported-methods/aws/advanced/#create-your-templates).
...
For more information, see the [security](/mesosphere/dcos/1.10/security/ent/) documentation.

### ca_certificate_path   [enterprise type="inline" size="small" /]              

Use this to set up a custom CA certificate. See [using a Custom CA Certificate](/mesosphere/dcos/1.10/security/ent/tls-ssl/ca-custom#configuration-parameter-reference) page for a detailed configuration parameter reference. 
...
For more information, see the [examples](/mesosphere/dcos/1.10/installing/production/deploying-dcos/configuration/examples/#docker-credentials).
...
For more information on how these custom checks are used, see the [examples](/mesosphere/dcos/1.10/installing/production/deploying-dcos/configuration/examples/#custom-checks) and [Node and Cluster Health Check](/mesosphere/dcos/1.10/installing/production/deploying-dcos/node-cluster-health-check/) documentation.
...
For more information, see the [security documentation](/mesosphere/dcos/1.10/security/ent/).
...
**Note:** Virtual networks require Docker version 1.12 or later but, if you are using Docker 1.12 or earlier then you must specify `dcos_overlay_enable: 'false'`. For more information, see the [system requirements](/mesosphere/dcos/1.10/installing/production/system-requirements/).
...
*  `dcos_overlay_enable: 'true'` Enable the DC/OS virtual network. This is the default value. After the virtual network is enabled, you can also specify the following parameters:
    ...
    *  `dcos_overlay_network` This group of parameters defines a virtual network for DC/OS.  The default configuration of DC/OS provides a virtual network named `dcos` with this YAML configuration:
        ...
        *  `overlays`
            *  `name` The canonical name (see [limitations](/mesosphere/dcos/1.10/networking/virtual-networks/) for constraints on naming virtual networks).
 ...
 For more information, see the [example](/mesosphere/dcos/1.10/installing/production/deploying-dcos/configuration/examples/#overlay) and [documentation](/mesosphere/dcos/1.10/networking/virtual-networks/).
...
*  `enable_docker_gc: 'true'` Run the docker-gc scripts once every hour. This is the default value for [cloud](/mesosphere/dcos/1.10/installing/evaluation/) template installations.
*  `enable_docker_gc: 'false'` Do not run the docker-gc scripts once every hour. This is the default value for [custom](/mesosphere/dcos/1.10/installing/production/) installations.
...
For more information, see the [GPU documentation](/mesosphere/dcos/1.10/deploying-services/gpu/).
...
### gpus_are_scarce
Indicates whether to treat [GPUs](/mesosphere/dcos/1.10/deploying-services/gpu/) as a scarce resource in the cluster.
...
The DNS name or IP address for the load balancer. If specified, this is included as subject alternative name in the [DC/OS certificate](/mesosphere/dcos/1.10/security/ent/tls-ssl/) of the Admin Router on the master nodes.
...
### public_agent_list
A YAML nested list (`-`) of IPv4 addresses to your [public agent](/mesosphere/dcos/1.10/overview/concepts/#public-agent-node) host names.
...
-  If you do not have internal hostnames to resolve, you can set this to a public nameserver like Google or AWS. For example, you can specify the [Google Public DNS IP addresses (IPv4)](https://developers.google.com/speed/public-dns/docs/using):
    ...
    - 8.8.8.8
    ```
-  If you do not have a DNS infrastructure and do not have access to internet DNS servers, you can specify `resolvers: []`. By specifying this setting, all requests to non-`.mesos` will return an error. For more information, see the Mesos-DNS [documentation](/mesosphere/dcos/1.10/networking/DNS/mesos-dns/).
...
See the external persistent volumes [documentation](/mesosphere/dcos/1.10/storage/external-storage/) for information on how to create your configuration.
...
Refer to the [security modes](/mesosphere/dcos/1.10/security/ent/#security-modes) section for a detailed discussion of each parameter.
...
(Required) The user name of the superuser. This account uses the `superuser_password_hash`. For more information, see the [security documentation](/mesosphere/dcos/1.10/security/ent/).
...
If you have already installed your cluster and would like to disable this in place, you can go through an [upgrade](/mesosphere/dcos/1.10/installing/production/upgrading/) with the same parameter set.

### use_proxy
Indicates whether to enable the DC/OS proxy.

*  `use_proxy: 'false'` Do not configure DC/OS [components](/mesosphere/dcos/1.10/overview/architecture/components/) to use a custom proxy. This is the default value.
*  `use_proxy: 'true'` Configure DC/OS [components](/mesosphere/dcos/1.10/overview/architecture/components/) to use a custom proxy. If you specify `use_proxy: 'true'`, you can also specify these parameters:
...
For more information, see the [examples](/mesosphere/dcos/1.10/installing/production/deploying-dcos/configuration/examples/#http-proxy).
