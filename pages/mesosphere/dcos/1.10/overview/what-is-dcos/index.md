...
Unlike Linux, DC/OS is not a [host operating system](/mesosphere/dcos/1.10/overview/concepts/#host-operating-system). DC/OS spans multiple machines, but relies on each machine to have its own host operating system and host kernel.
