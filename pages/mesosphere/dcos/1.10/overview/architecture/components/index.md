...
![Mesosphere DC/OS Enterprise Components](/mesosphere/dcos/1.10/img/dcos-enterprise-components-1.10-portrait.png)
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/installing/">Documentation</a></li>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/administering-clusters/backup-and-restore/">Documentation</a></li>
    <li><a href="/mesosphere/dcos/1.10/administering-clusters/backup-and-restore/backup-restore-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/gui/">Documentation</a></li>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/cli/">Documentation</a></li>
...
<p>
  ...
  <ul>
    ...
    <li><a href="/mesosphere/dcos/1.10/deploying-services/">Documentation</a></li>
    <li><a href="https://github.com/mesosphere/marathon">Source</a></li>
    <li><a href="/mesosphere/dcos/1.10/deploying-services/marathon-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/deploying-jobs/">Documentation</a></li>
...
<p>
  ...
  <ul>
    ...
    <li><a href="/mesosphere/dcos/1.10/monitoring/#system-health-http-api-endpoint">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  ...
  <ul>
    ...
    <li><a href="/mesosphere/dcos/1.10/monitoring/logging/logging-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  ...
  <ul>
    ...
    <li><a href="/mesosphere/dcos/1.10/metrics/metrics-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<div>
<p><strong>Description:</strong> The DC/OS Signal service reports cluster telemetry and analytics to help improve DC/OS. Administrators can <a href="/mesosphere/dcos/1.10/installing/production/deploying-dcos/opt-out/#telemetry">opt-out of telemetry</a> at install time.</p>
<p>
  <strong>System Service(s):</strong>
  <ul>
...
<p>
  ...
  <ul>
    ...
    <li><a href="/mesosphere/dcos/1.10/networking/DNS/mesos-dns/mesos-dns-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/networking/load-balancing-vips/">Documentation</a></li>
...
<div>
<p><strong>Description:</strong> DC/OS Package Manager (Cosmos) installs and manages DC/OS packages from <a href="/mesosphere/dcos/1.10/administering-clusters/repo/">DC/OS package repositories</a>, such as the <a href="https://github.com/mesosphere/universe">Mesosphere Universe</a>.</p>
<p>
  <strong>System Service(s):</strong>
  <ul>
...
<p>
  ...
  <ul>
    ...
    <li><a href="/mesosphere/dcos/1.10/deploying-services/package-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  ...
  <ul>
    ...
    <li><a href="/mesosphere/dcos/1.10/administering-clusters/component-management/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/security/ent/">Documentation</a></li>
    <li><a href="/mesosphere/dcos/1.10/security/ent/iam-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/security/ent/tls-ssl/">Documentation</a></li>
    <li><a href="/mesosphere/dcos/1.10/security/ent/tls-ssl/ca-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
<p>
  <strong>See Also:</strong>
  <ul>
    <li><a href="/mesosphere/dcos/1.10/security/ent/secrets/">Documentation</a></li>
    <li><a href="/mesosphere/dcos/1.10/security/ent/secrets/secrets-api/">API Reference</a></li>
  </ul>
</p>
</div>
</div>
...
Most DC/OS components run as [systemd services](/mesosphere/dcos/1.10/overview/concepts/#systemd-service) on the DC/OS nodes.
