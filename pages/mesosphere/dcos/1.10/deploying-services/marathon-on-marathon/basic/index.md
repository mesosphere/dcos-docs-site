...
The basic procedure does not support [secrets](/mesosphere/dcos/1.10/security/ent/secrets/) or fine-grained ACLs. If you require these features, you must use the custom non-native Marathon [procedure](/mesosphere/dcos/1.10/deploying-services/marathon-on-marathon/advanced/).
