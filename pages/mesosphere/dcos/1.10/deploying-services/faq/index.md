...
This is not currently supported. For more information, see [this document](/mesosphere/dcos/1.10/installing/production/advanced-configuration/configuring-zones-regions/).
...
For more information, see the installation [documentation](/mesosphere/dcos/1.10/installing/).
...
[1]: /mesosphere/dcos/1.10/networking/load-balancing-vips/
[2]: /mesosphere/dcos/1.10/networking/
...
[5]: /mesosphere/dcos/1.10/administering-clusters/convert-agent-type/
