...
**Note:** The DC/OS web interface provides a subset of the CLI and API functionality. For advanced job configurations, use the [dcos job](/mesosphere/dcos/1.10/cli/command-reference/dcos-job/) commands or the Jobs [API](#jobs-api).
...
![Create JOB UI](/mesosphere/dcos/1.10/img/create-job.png)
