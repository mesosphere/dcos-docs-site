...
Launch the [DC/OS UI](/mesosphere/dcos/1.10/gui/) and navigate to the **System -> Components** page. You can sort components by health.

![system health](/mesosphere/dcos/1.10/img/component-system-view.png)

You can click on a DC/OS component to view the details, including role, node, and health.

![node detail](/mesosphere/dcos/1.10/img/component-node-detail.png)

You can debug further by clicking the node to view the component journald (log) output.

![log](/mesosphere/dcos/1.10/img/component-node-output.png)
...
If you have any problems, you can check if the diagnostics service is running by SSHing to the Mesos leading master and checking the `systemd` status of the diagnostics component (`dcos-diagnostics.service`).
 ...
 [6]: /mesosphere/dcos/1.10/security/ent/
 [7]: /mesosphere/dcos/1.10/networking/load-balancing-vips/
 [8]: /mesosphere/dcos/1.10/overview/concepts/#private-agent-node
 [9]: /mesosphere/dcos/1.10/overview/concepts/#public-agent-node
