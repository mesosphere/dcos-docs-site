...
1. Obtain the [DC/OS CA bundle](/mesosphere/dcos/1.13/security/ent/tls-ssl/get-cert/).

1. Perform one of the following:

     - Manually add your DC/OS CA as a trusted authority in [browser](/mesosphere/dcos/1.13/security/ent/tls-ssl/ca-trust-browser/), [DC/OS CLI](/mesosphere/dcos/1.13/security/ent/tls-ssl/ca-trust-cli/), [curl commands](/mesosphere/dcos/1.13/security/ent/tls-ssl/ca-trust-curl/), and other clients.

     - [Set up a proxy](/mesosphere/dcos/1.13/security/ent/tls-ssl/haproxy-adminrouter/) between Admin Router and user agent requests coming in from outside of the cluster.
