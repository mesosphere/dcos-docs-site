...
![Cannot connect to the directory](/mesosphere/dcos/1.13/img/ldap-cannot-open-connection-error.png)
...
![SSL connection error](/mesosphere/dcos/1.13/img/ldap-tsl-ssl-socket-error.png)
...
1. Under **Select SSL/TLS setting**, select another option.
    ...
    ![SSL/TLS setting option](/mesosphere/dcos/1.13/img/ldap-ssl-options.png)
...
![Aborted SSL/TLS connections](/mesosphere/dcos/1.13/img/ldap-enforced-TLS-error.png)
...
![LDAP authentication error](/mesosphere/dcos/1.13/img/ldap-lookup-DN-error.png)
...
1. Correct the **Lookup DN** and the **Lookup Password**.
    ...
    ![Modify authentication information](/mesosphere/dcos/1.13/img/ldap-lookup-dn.png)
...
![LDAP user not found](/mesosphere/dcos/1.13/img/ldap-user-error.png)
...
1. Select the user account.
    ...
    ![Selecting a user in Active Directory Users and Computers](/mesosphere/dcos/1.13/img/ldap-aduc.png)
...
1. Click the **Account** tab and check the **User login name**.
    ...
    ![User login account property](/mesosphere/dcos/1.13/img/ldap-aduc-account-properties.png)
...
![Invalid user credentials](/mesosphere/dcos/1.13/img/ldap-wrong-user-credentials.png)
