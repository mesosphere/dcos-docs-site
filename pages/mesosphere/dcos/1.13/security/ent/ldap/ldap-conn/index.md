...
1.  Click **Add Directory**.
   ...
   ![Add Directory dialog](/mesosphere/dcos/1.13/img/ldap-add-dir-conn.png)
...
1. Select your preferred encryption option from the **Select SSL/TLS setting** list box.
   ...
   <p class="message--note"><strong>NOTE: </strong>We recommend choosing either <strong>Use SSL/TLS for all connections</strong> or <strong>Attempt StartTLS, abort if it fails</strong> to ensure either SSL/TLS or StartTLS encryption; otherwise the password is sent in the clear.</p>
...
1.  Specify your authentication method and parameters, as discussed in the [authentication section](/mesosphere/dcos/1.13/security/ent/ldap/ldap-auth/).
