...
1. Paste the client secret value from Google into the **Client Secret** field.
    ...
    ![Google IdP Configuration](/mesosphere/dcos/1.13/img/GUI-LDAP-Add-Oidc.png)
...
1. Assign this user the appropriate [permissions](/mesosphere/dcos/1.13/security/ent/perms-reference/).

### <a name="using-cli"></a>Using the DC/OS CLI

**Prerequisite:** [DC/OS CLI installed](/mesosphere/dcos/1.13/cli/install/).
...
1. You should see a message similar to the following.
    ...
    ![CLI IdP Auth Token](/mesosphere/dcos/1.13/img/cli-auth-token.png)
