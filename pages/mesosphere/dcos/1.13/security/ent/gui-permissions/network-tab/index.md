...
<p class="message--note"><strong>NOTE: </strong>This procedure grants full user access to the <strong>Networking</strong> tab. If you want to configure fine-grained user access, see the <a href="/mesosphere/dcos/1.13/deploying-services/service-groups/">documentation</a>.</p>
