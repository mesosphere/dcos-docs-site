...
<p class="message--note"><strong>NOTE: </strong>This procedure grants full user access to the <strong>Services</strong> tab. If you want to configure fine-grained user access, see the <a href="/mesosphere/dcos/1.13/security/ent/secrets/use-secrets/">documentation</a>.</p>
