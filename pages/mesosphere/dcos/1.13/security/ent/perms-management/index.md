...
There are [four commands](/mesosphere/dcos/1.13/cli/command-reference/dcos-security/dcos-security-org/) used for managing permissions from the DC/OS Enterprise CLI.
...
The [IAM HTTP API](/mesosphere/dcos/1.13/security/ent/iam-api/) provides operations to manage permissions for users and groups.
