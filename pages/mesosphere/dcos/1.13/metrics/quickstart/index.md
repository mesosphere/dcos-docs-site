...
- You must have the [DC/OS CLI installed](/mesosphere/dcos/1.13/cli/install/) and be logged in as a superuser via the `dcos auth login` command.
...
3.  View metrics.
    ...
    -   **<a name="container-metrics"></a>Container metrics for a specific task**
        ...
        The metrics summary command displays a summary of raw and percentage utilization of CPU, Memory and Disk resources using the metrics documented in the [metrics reference summary](/mesosphere/dcos/1.13/metrics/reference/).
