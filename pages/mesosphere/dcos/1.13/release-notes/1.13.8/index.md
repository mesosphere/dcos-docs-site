...
<p class="message--warning"><strong>WARNING: </strong>The DC/OS 1.13.8 release has a critical error in its networking stack and we recommend that you do NOT download or install it. Instead, download and install the 1.13.9 release [here](/mesosphere/dcos/1.13/release-notes/1.13.9/)</p>
