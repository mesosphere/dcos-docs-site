...
<p class="message--warning"><strong>WARNING: </strong>The DC/OS 1.13.8 release has a critical error in its networking stack. We recommend that you do NOT download or upgrade to it. Instead, download and upgrade to the 1.13.9 release <a href="/mesosphere/dcos/1.13/release-notes/1.13.9/">here</a>.</p>
