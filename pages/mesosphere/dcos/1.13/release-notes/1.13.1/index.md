...
- The DC/OS monitoring service (`dcos-monitoring`) can be configured to use DC/OS storage service (DSS) volumes to store time-series data. <!--(DCOS-47725)-->
    ...
    For more information about working with the DC/OS monitoring service, see [DC/OS Monitoring Service](/mesosphere/dcos/services/beta-dcos-monitoring/). For more information about using the DC/OS storage service, see [DC/OS Storage Service](/mesosphere/dcos/services/storage/latest/).
...
- [Release version 1.13.0](/mesosphere/dcos/1.13/release-notes/1.13.0/) - 8 May 2019.
