...
1.  [SSH](/mesosphere/dcos/1.13/administering-clusters/sshcluster/) into the master using the following command. Replace `<master-IP>` with the IP address used in the previous commands.
...
3.  [SSH](/mesosphere/dcos/1.13/administering-clusters/sshcluster/) into the master that you just copied these files to.
...
1.  [SSH into one of your agent nodes.](/mesosphere/dcos/1.13/administering-clusters/sshcluster/)
