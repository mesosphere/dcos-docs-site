...
# Before you begin
- You must have DC/OS installed with at least one master node and at least one [public agent](/mesosphere/dcos/1.13/overview/concepts/#public-agent-node) node.
- You must have the most recent version of the DC/OS [CLI](/mesosphere/dcos/1.13/cli/) installed.
- You must have [secure shell (SSH)](/mesosphere/dcos/1.13/administering-clusters/sshcluster/) installed and configured to allow remote session access to cluster nodes.
