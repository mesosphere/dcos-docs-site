...
To confirm that the dcos-enterprise-cli is installed, run `dcos plugin list`. You can see the enterprise CLI there as it is now a standard plugin. To manage, read [our documentation about CLI plugins](/mesosphere/dcos/1.13/cli/plugins/).
...
The DC/OS CLI must already be [installed](/mesosphere/dcos/1.13/cli/install/).
