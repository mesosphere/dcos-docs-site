...
ZooKeeper should be backed up by following the guide [Backup and Restore DC/OS ZooKeeper State](/mesosphere/dcos/1.13/administering-clusters/backup-and-restore/zookeeper/).
