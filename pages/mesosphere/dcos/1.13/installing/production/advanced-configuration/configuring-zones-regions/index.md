...
For more information, see the [multi-zone](/mesosphere/dcos/1.13/installing/production/advanced-configuration/configuring-zones-regions/multi-zone/) and [multi-region](/mesosphere/dcos/1.13/installing/production/advanced-configuration/configuring-zones-regions/multi-region/) documentation.
