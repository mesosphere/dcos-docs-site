...
![Five Maturity States](/mesosphere/dcos/1.13/img/five_maturity_states.png)
...
6. GA feature modifications or maturity lifecycle changes can be found in the [Release Notes](/mesosphere/dcos/1.13/release-notes/).
