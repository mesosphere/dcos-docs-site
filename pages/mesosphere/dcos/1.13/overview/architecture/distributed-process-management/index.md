...
![Concept of distributed process management in DC/OS](/mesosphere/dcos/1.13/img/dcos-architecture-distributed-process-management-concept.png)
...
![Example of distributed process management in DC/OS](/mesosphere/dcos/1.13/img/dcos-architecture-distributed-process-management-example.png)
...
![Sequence diagram for distributed process management in DC/OS](/mesosphere/dcos/1.13/img/dcos-architecture-distributed-process-management-seq-diagram.png)
...
1. Client initiates process launch. For example, this could be a user creating a Marathon app using the DC/OS [Services](/mesosphere/dcos/1.13/gui/services/) tab or via the HTTP endpoint `/v2/app`.
...
[auth]: /mesosphere/dcos/1.13/security/
