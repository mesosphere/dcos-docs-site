...
You can download all the log files for your service from the **Services > Services** tab in the [DC/OS web interface](/mesosphere/dcos/1.13/gui/). You can also monitor `stdout`/`stderr`.

For more information, see the Service and Task Logs [quick start guide](/mesosphere/dcos/1.13/monitoring/logging/quickstart/).
...
You can view the logs for specific [components](/mesosphere/dcos/1.13/overview/architecture/components/) by entering the component name. For example, to access Admin Router logs, run this command:
...
![system health](/mesosphere/dcos/1.13/img/GUI-Nodes-Main_View_Agents-1_12.png)
...
- [Log Management with ELK](/mesosphere/dcos/1.13/monitoring/logging/aggregating/elk/)
- [Log Management with Splunk](/mesosphere/dcos/1.13/monitoring/logging/aggregating/splunk/)
