...
1. From the **Services** tab, click the menu dots to the right side of your service to access **More Actions**. 
    ...
    ![Menu](/mesosphere/dcos/1.13/img/GUI-Services-More-Actions_Callout.png)
   
    Figure 1. More Actions menu

2. From the drop-down menu, select **Scale**.

   ![more actions menu](/mesosphere/dcos/1.13/img/GUI-Services-More-Actions-Menu.png)
...
4. From the Services tab, you can see your service scaling.
    ...
    ![service deploying](/mesosphere/dcos/1.13/img/GUI-Services-Scale-Confirmation.png)
