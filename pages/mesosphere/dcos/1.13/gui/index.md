...
In the cluster menu, there are links for: [Cluster Overview](/mesosphere/dcos/1.13/gui/cluster/), Documentation and CLI Installation.

![DC/OS UI Cluster Menu](/mesosphere/dcos/1.13/img/header-bar-cluster-dropdown-1-12.png)

Figure 3 - Header Bar Cluster Menu

For DC/OS Enterprise, there is also a link for administering [linked clusters](/mesosphere/dcos/1.13/administering-clusters/multiple-clusters/cluster-links/).
...
1. Click on your username in the header bar.
    ...
    ![Username Menu](/mesosphere/dcos/1.13/img/GUI-change-UI-settings-menu-3.png)

    Figure 5 - User name menu

1. From the drop-down menu, select "English (change)".

    ![Drop Down menu](/mesosphere/dcos/1.13/img/GUI-change-UI-language-selector.png)

    Figure 6 - Username menu

1. From the Language Preferences window, select your language.

    ![Language Preferences](/mesosphere/dcos/1.13/img/GUI-change-UI-settings-menu-2.png)
...
1. Click on **Settings > UI Settings**.
    ...
    ![UI settings tab](/mesosphere/dcos/1.13/img/GUI-change-UI-settings-menu-1.png)
