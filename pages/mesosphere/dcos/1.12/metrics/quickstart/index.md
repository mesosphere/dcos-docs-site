...
3.  View metrics.
    ...
    -   **<a name="container-metrics"></a>Container metrics for a specific task**
        ...
        The metrics summary command displays a summary of raw and percentage utilization of CPU, Memory and Disk resources using the metrics documented in the metrics reference summary(https://docs.d2iq.com/mesosphere/dcos/1.12/metrics/reference/)
