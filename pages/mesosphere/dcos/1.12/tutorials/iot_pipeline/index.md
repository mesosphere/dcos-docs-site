...
In this step you install Cassandra, Kafka, Marathon-LB, and Zeppelin from the DC/OS GUI [**Catalog**](/mesosphere/dcos/1.12/gui/catalog/) tab. You can also install DC/OS packages from the DC/OS CLI with the [`dcos package install`][11] command.
...
If you are having trouble getting Marathon-LB up and running on an Enterprise cluster, try installing it following [these instructions](/mesosphere/dcos/services/marathon-lb/1.12/mlb-install/). Depending on your [security mode](/mesosphere/dcos/security/ent/#security-modes), Marathon-LB may require service authentication for access to DC/OS.
...
5.  Click the **Services** tab to watch as your microservices are deployed on DC/OS. You will see the Health status go from Idle to Unhealthy, and finally to Healthy as the nodes come online. This may take several minutes.
    ...
    ![Services tab with all services shown.](/mesosphere/dcos/1.12/img/tweeter-services6-ee.png)
...
4.  Go to the **Services** tab to verify your app is up and healthy.
    ...
    ![Tweeter deployed](/mesosphere/dcos/1.12/img/tweeter-services7.png)
...
3.  After the `post-tweets.json` is running, refresh your browser to see the incoming Shakespeare tweets.
    ...
    ![Shakespeare tweets](/mesosphere/dcos/1.12/img/tweeter-shakespeare.png)
...
![Tweeter scaled](/mesosphere/dcos/1.12/img/tweeter-services8-ee.png)
...
Figure 6. Top Tweeters
 ...
 [6]: /mesosphere/dcos/1.12/overview/concepts/
 [9]: /mesosphere/dcos/1.12/administering-clusters/locate-public-agent/
 [11]: /mesosphere/dcos/1.12/cli/command-reference/
