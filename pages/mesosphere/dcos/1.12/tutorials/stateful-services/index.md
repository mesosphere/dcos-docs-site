...
For further information on stateful services in DC/OS, visit the [Storage section of the documentation](/mesosphere/dcos/1.12/storage/).


[1]: /mesosphere/dcos/1.12/installing/
[2]: /mesosphere/dcos/1.12/cli/install/
