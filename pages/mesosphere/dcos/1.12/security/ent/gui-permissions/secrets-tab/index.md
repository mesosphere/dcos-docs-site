...
**Tip:** This procedure grants full user access to the **Secrets** tab. If you want to configure fine-grained user access, see the [documentation](/mesosphere/dcos/1.12/security/ent/secrets/use-secrets/).
...
1.  Select the name of the user or group to grant the permission to.
    ...
    ![Add permission to a user or group](/mesosphere/dcos/1.12/img/GUI-Organization-Users-List_VIew-1_12.png)
