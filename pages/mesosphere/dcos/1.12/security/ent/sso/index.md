...
- Adding a [SAML Identity Provider](/mesosphere/dcos/1.12/security/ent/sso/setup-saml/)
- Adding an [OpenID Identity Provider](/mesosphere/dcos/1.12/security/ent/sso/setup-openid/):
