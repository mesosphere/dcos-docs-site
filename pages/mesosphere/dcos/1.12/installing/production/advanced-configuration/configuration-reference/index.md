...
|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| [agent_list](#agent-list)                                              | A YAML nested list (`-`) of IPv4 addresses to your [private agent](/mesosphere/dcos/1.12/overview/concepts/#private-agent-node) host names. |
...
| [aws_template_storage_bucket](#aws-template-storage-bucket)                | The name of an S3 bucket to contain [customized advanced AWS templates](/mesosphere/dcos/1.12/installing/evaluation/community-supported-methods/aws/advanced/#create-your-templates). |
...
| [public_agent_list](#public-agent-list)                               | A YAML nested list (`-`) of IPv4 addresses to your [public agent](/mesosphere/dcos/1.12/overview/concepts/#public-agent-node) host names.  |
...
If you have already installed your cluster and would like to change this in place, you can go through an [upgrade](/mesosphere/dcos/1.12/installing/production/upgrading/) with the `adminrouter_tls_1_0_enabled` parameter set to the desired value.
...
If you have already installed your cluster and would like to change this in-place, you can go through an [upgrade](/mesosphere/dcos/1.12/installing/production/upgrading/) with the `adminrouter_tls_1_1_enabled` parameter set to the desired value.
...
If you have already installed your cluster and would like to change this in place, you can go through an [upgrade](/mesosphere/dcos/1.12/installing/production/upgrading/) with the `adminrouter_tls_1_2_enabled` parameter set to the desired value.
...
### agent_list
A YAML nested list (`-`) of IPv4 addresses to your [private agent](/mesosphere/dcos/1.12/overview/concepts/#private-agent-node) host names.
...
The name of an S3 bucket to contain [customized advanced AWS templates](/mesosphere/dcos/1.12/installing/evaluation/community-supported-methods/aws/advanced/#create-your-templates).
...
For more information, see the [security](/mesosphere/dcos/1.12/security/ent/) documentation.

### ca_certificate_path   [enterprise type="inline" size="small" /]              

Use this to set up a custom CA certificate. See [using a Custom CA Certificate](/mesosphere/dcos/1.12/security/ent/tls-ssl/ca-custom#configuration-parameter-reference) page for a detailed configuration parameter reference. 
...
For more information on how these custom checks are used, see the [examples](/mesosphere/dcos/1.12/installing/production/deploying-dcos/configuration/examples/#custom-checks) and [Node and Cluster Health Check](/mesosphere/dcos/1.12/installing/production/deploying-dcos/node-cluster-health-check/) documentation.
...
For more information, see the [security documentation](/mesosphere/dcos/1.12/security/ent/).

### dcos_l4lb_enable_ipv6
Indicates whether layer-4 load-balancing is available for IPv6 containers.
*  `dcos_l4lb_enable_ipv6: 'false'` Disables [layer-4 load balancing](/mesosphere/dcos/1.12/networking/load-balancing-vips/) for IPv6 containers. This is the default value.
...
For more information, see the [system requirements](/mesosphere/dcos/1.12/installing/production/system-requirements/).
...
*  `enable_docker_gc: 'true'` Run the docker-gc scripts once every hour. This is the default value for [cloud](/mesosphere/dcos/1.12/installing/evaluation/) template installations.
*  `enable_docker_gc: 'false'` Do not run the docker-gc scripts once every hour. This is the default value for [on-prem](/mesosphere/dcos/1.12/installing/production/) installations.

### enable_mesos_input_plugin

Indicates whether to enable Telegraf's Mesos input plugin to collect Mesos metrics from Mesos masters and agents. Options: `true` or `false`. Default value in DC/OS 1.12 is `false`. For more information, see the [documentation](/mesosphere/dcos/1.12/metrics/mesos/).
...
For more information, see the [GPU documentation](/mesosphere/dcos/1.12/deploying-services/gpu/).
...
### gpus_are_scarce
Indicates whether to treat [GPUs](/mesosphere/dcos/1.12/deploying-services/gpu/) as a scarce resource in the cluster.
...
The DNS name or IP address for the load balancer. If specified, this is included as subject alternative name in the [DC/OS certificate](/mesosphere/dcos/1.12/security/ent/tls-ssl/) of the Admin Router on the master nodes.
...
The default is `logrotate`. Due to performance issues, `journald` is not recommended. For details, see [Logging Reference](/mesosphere/dcos/1.12/monitoring/logging/logging-api/#compatibility).
...
### public_agent_list
A YAML nested list (`-`) of IPv4 addresses to your [public agent](/mesosphere/dcos/1.12/overview/concepts/#public-agent-node) host names.
...
See the external persistent volumes [documentation](/mesosphere/dcos/1.12/storage/external-storage/) for information on how to create your configuration.
...
Refer to the [security modes](/mesosphere/dcos/1.12/security/ent/#security-modes) section for a detailed discussion of each parameter.
...
(Required) The user name of the superuser. This account uses the `superuser_password_hash`. For more information, see the [security documentation](/mesosphere/dcos/1.12/security/ent/).
...
If you have already installed your cluster and would like to disable this in place, you can go through an [upgrade](/mesosphere/dcos/1.12/installing/production/upgrading/) with the same parameter set.

### use_proxy
Indicates whether to enable the DC/OS proxy.

*  `use_proxy: 'false'` Do not configure DC/OS [components](/mesosphere/dcos/1.12/overview/architecture/components/) to use a custom proxy. This is the default value.
*  `use_proxy: 'true'` Configure DC/OS [components](/mesosphere/dcos/1.12/overview/architecture/components/) to use a custom proxy. If you specify `use_proxy: 'true'`, you can also specify these parameters:
