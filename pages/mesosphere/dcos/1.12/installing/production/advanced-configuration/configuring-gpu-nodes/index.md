...
1.  Install DC/OS using the [custom advanced installation instructions](/mesosphere/dcos/1.12/installing/production/deploying-dcos/installation/). Here are the GPU-specific configuration parameters:
...
###  Prerequisites
- The AWS DC/OS advanced template [system requirements](/mesosphere/dcos/1.12/installing/evaluation/community-supported-methods/aws/).
- The `zen.sh` script copied to your local machine. The script and instructions are [here](/mesosphere/dcos/1.12/installing/evaluation/community-supported-methods/aws/).
...
2. Follow the instructions [here](/mesosphere/dcos/1.12/installing/evaluation/community-supported-methods/aws/) to create a cluster with advanced AWS templates, using the following GPU-specific configuration.
