...
This procedure patches a DC/OS 1.12 cluster without changing the cluster's [security mode](/mesosphere/dcos/1.12/installing/production/advanced-configuration/configuration-reference/#security-enterprise).
