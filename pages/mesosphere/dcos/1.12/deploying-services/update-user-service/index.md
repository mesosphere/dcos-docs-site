...
The process for updating packages from the [DC/OS Catalog](/mesosphere/dcos/1.12/gui/catalog/) is different. For more information, see the [documentation](/mesosphere/dcos/1.12/deploying-services/config-universe-service/).
