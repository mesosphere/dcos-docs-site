...
2. Add this script to the `genconf` folder of your bootstrap node. [More information](/mesosphere/dcos/1.12/installing/production/deploying-dcos/installation/#create-a-fault-domain-detection-script).

1. [Install DC/OS](/mesosphere/dcos/1.12/installing/production/deploying-dcos/installation/).
