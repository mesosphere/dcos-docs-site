...
You can also [configure Marathon's behavior when a task is unreachable](/mesosphere/dcos/1.12/deploying-services/task-handling/configure-task-handling/).

![Task Handling Flow](/mesosphere/dcos/1.12/img/task-handling-corrected.png)
