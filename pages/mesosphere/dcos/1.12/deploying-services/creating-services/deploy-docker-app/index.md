...
1.  If you used the [AWS CloudFormation templates](/mesosphere/dcos/1.12/installing/evaluation/community-supported-methods/aws/) to expose the app to the port specified in your app definition (e.g. port 80), you must reconfigure the health check on the public ELB.
