...
Follow these steps to add your Docker registry credentials to the [DC/OS Enterprise secrets store](/mesosphere/dcos/security/ent/secrets/), and then reference that secret in your service definition.
