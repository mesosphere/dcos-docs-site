...
1.  Navigate to the [**Services**](/mesosphere/dcos/1.12/gui/services/) tab in the DC/OS web interface.
...
For more information, see the [command reference](/mesosphere/dcos/1.12/cli/command-reference/#dcos-marathon).
...
From the DC/OS [**Services**](/mesosphere/dcos/1.12/gui/) tab, use the JSON editor to add the following as a Marathon task. Replace the values passed to `-r`/`-z` according to what needs to be cleaned up.
