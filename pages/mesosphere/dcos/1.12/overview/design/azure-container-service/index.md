...
For a more comprehensive architectural description of DC/OS, see [DC/OS Architecture](/mesosphere/dcos/1.12/overview/architecture/).

For a more complete discussion of components, see [DC/OS Components](/mesosphere/dcos/1.12/overview/architecture/components/).
...
![Azure Container Service architecture using DC/OS.](/mesosphere/dcos/1.12/img/dcos-acs.png)
