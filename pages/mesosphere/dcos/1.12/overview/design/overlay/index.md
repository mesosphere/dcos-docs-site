...
![Agent configuration for containers running on `MesosContainerizer` and Docker once the VxLAN has been configured.](/mesosphere/dcos/1.12/img/overlay-in-action-redesigned.png)
...
![Software architecture for DC/OS overlay control plane.](/mesosphere/dcos/1.12/img/overlay-control-plane-redesigned.png)
