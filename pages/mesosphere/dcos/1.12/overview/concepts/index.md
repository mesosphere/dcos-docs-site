...
The [DC/OS graphical user interface (GUI)](/mesosphere/dcos/1.12/gui/) is an interface for remotely controlling and managing a DC/OS cluster from a web browser. The GUI is also sometimes called the DC/OS UI or DC/OS web interface.

<a name="dcos-cli"></a>

## DC/OS CLI

The [DC/OS command line interface (CLI)](/mesosphere/dcos/1.12/cli/) is an interface for remotely controlling and managing a DC/OS cluster from a terminal.
...
For more information, see [Network Security](/mesosphere/dcos/1.12/administering-clusters/) and [Adding Agent Nodes](/mesosphere/dcos/1.12/administering-clusters/add-a-node/).
...
- If a bootstrap machine is not required for managing master node IP changes or as an SSH jumpbox, it can be shut down after bootstrapping and spun up on demand to [add new nodes](/mesosphere/dcos/1.12/administering-clusters/add-a-node/) to the cluster.
...
For more information about deploying using a cloud template, see [Mesosphere installation methods](/mesosphere/dcos/1.12/installing/evaluation/).
...
For more information, see the [Mesos-DNS documentation](/mesosphere/dcos/1.12/networking/DNS/mesos-dns/).
