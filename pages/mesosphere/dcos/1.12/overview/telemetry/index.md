...
This information is collected from the [DC/OS Diagnostics](/mesosphere/dcos/1.12/overview/architecture/components/#dcos-diagnostics) component. For every `systemd` unit, the following information is collected, where `<UNIT_NAME>` is component name:
...
## Mesos
This information is collected from the [Apache Mesos](/mesosphere/dcos/1.12/overview/architecture/components/#apache-mesos) component.
...
## Package Manager
This information is collected from the [DC/OS Package Manager (Cosmos)](/mesosphere/dcos/1.12/overview/architecture/components/#dcos-package-manager) component.
...
You can also choose to opt out of the telemetry features. For more information, see  [Opt-Out](/mesosphere/dcos/1.12/installing/production/deploying-dcos/opt-out/).
