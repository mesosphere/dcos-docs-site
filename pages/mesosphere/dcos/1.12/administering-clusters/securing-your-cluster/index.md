...
- from external machines to public agent nodes: block connection requests on all ports except [advertised port ranges](/mesosphere/dcos/1.12/installing/production/system-requirements/ports/#agent).
...
![Security Zones](/mesosphere/dcos/1.12/img/security-zones.jpg)
