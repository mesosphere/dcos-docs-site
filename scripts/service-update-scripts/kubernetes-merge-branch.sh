...
sed -i -e "s/^navigationTitle: .*$/navigationTitle: Beta Kubernetes $directory/g" ./pages/services/kubernetes/$directory/index.md
sed -i -e "s/^title: .*$/title: Beta Kubernetes $directory/g" ./pages/services/kubernetes/$directory/index.md
