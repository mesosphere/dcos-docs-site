...
# checkout each file in the merge list from dcos-dse-service
while read p;
do
  echo $p
  # checkout
...
cp -r frameworks/dse/docs/* ./pages/services/dse/$directory

done <scripts/service-update-scripts/merge-lists/dcos-dse-service-merge-list.txt
