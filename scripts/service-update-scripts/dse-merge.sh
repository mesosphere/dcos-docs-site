...
for i in $( ls ./services/dse/*/index.md );
do
...
mkdir service-docs/dse/$directory
mkdir service-docs/dse/$directory/img
echo "New directories created: service-docs/dse/$directory and service-docs/dse/$directory/img"
...
cp -r docs/* service-docs/dse/$directory
...
sed -i '' -e "2s/.*/post_title: DSE $directory/g" ./services/dse/$directory/index.md
