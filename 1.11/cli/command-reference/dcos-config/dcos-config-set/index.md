...
Change the `dcos_url` in the configuration of the currently attached cluster. This command removes the `core.dcos_acs_token` setting. You must then run [`dcos auth login`](/1.11/cli/command-reference/dcos-auth/dcos-auth-login) to authenticate.
