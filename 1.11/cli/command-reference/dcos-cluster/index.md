...
| [dcos cluster link](/1.11/cli/command-reference/dcos-cluster/dcos-cluster-link/)       |  [enterprise type="inline" size="small" /] Link a cluster to another cluster.  |
...
| [dcos cluster unlink](/1.11/cli/command-reference/dcos-cluster/dcos-cluster-unlink/)   |  [enterprise type="inline" size="small" /] Unlink a cluster from another cluster. |
