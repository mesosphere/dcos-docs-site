...
You must be a superuser or have the appropriate cluster link [permission](/1.11/security/perms-reference/#cluster-linker) to view, add, and remove links and grant permissions to view linked clusters.
