...
The installation procedure varies according to your [security mode](/1.11/installing/ent/custom/configuration/configuration-parameters/#security-enterprise). Refer to the section that corresponds to your security mode for step-by-step instructions.
