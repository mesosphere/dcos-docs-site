...
const shortcodes = {
    ...
    community: (buf, opts) => {
        ...
        if (buf) {
            return sanitize(`${buf} <span class="badge badge--shortcode badge--${size} badge--${type} badge--community">Community</span>`);
        }
        return sanitize(`<span class="badge__container badge__container--${type}"><span class="badge badge--shortcode badge--${size} badge--${type} badge--community">Community</span></span>`);
    },
