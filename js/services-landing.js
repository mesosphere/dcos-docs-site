document.addEventListener("DOMContentLoaded", () => {
  ...
  const categorySelection = gridFilters.querySelector(
  ...
  const enterpriseCheckbox = gridFilters.querySelector(
    ".grid-filters__enterprise"
  );
  enterpriseCheckbox.checked = true;
  const betaCheckbox = gridFilters.querySelector(".grid-filters__beta");
  betaCheckbox.checked = true;
  const communityCheckbox = gridFilters.querySelector(
    ".grid-filters__community"
  );
  ...
  function checkSectionsEmpty() {
    ...
    Array.prototype.forEach.call(categorySections, (section) => {
      ...
      Array.prototype.forEach.call(
        section.querySelectorAll(".grid-toc__service-item"),
        (el) => {
